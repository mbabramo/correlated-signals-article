...
The analysis produces a counterintuitive result. Even when risk-neutral parties have strong (though imperfect) signals of litigation quality, strategic behavior can be sufficiently high as to make settlement low or nonexistent. Equilibrium settlement offers revealed by a computational model appear strikingly aggressive and discontinuous. It is not the case that each party simply calculates what it thinks the case is worth and then decides to move slightly off this value, trading off the benefit of getting more of the settlement surplus and the risk of settlement failure. Rather, parties may in equilibrium make offers or demands consistent with holding out for highly favorable outcomes, far from expected value.

The 

Fourth, these papers assume risk neutrality. Fifth, they consider bargaining only under the American rule in which each party bears its own costs and ignore the British rule in which the loser bears the other party's fees. 

Many cases, of course, do settle, though as Chang and Klerman (2023) \cite{changklerman} demonstrate, settlement rates vary highly around the world. Relatively high rates of settlement relative to the model thus must be explained by a factor such as nonequilibrium play or by factors such as high litigation costs or risk aversion. These factors are directly modeled, providing a sense of how high costs or risk aversion must be to explain various settlement levels.
