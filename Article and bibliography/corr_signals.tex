...
REMAINING ISSUES: (1) Supplemental Information must contain the detailed analyis of American vs British; must check the description here. (2) Same mini axes on Errors and expenditures. (3) Note insert cite in introduction. (4) Insertion in conclusion (5) Fix description of disposition varying noise multiplier. Get rid of Figure 21 (Errors and expenditures based on player noise levels) or rerun it. Update up to Costs Structure (which has up-to-date data).
