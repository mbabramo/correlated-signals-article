...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,2.3219);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.3219) rectangle (1.75,5.825);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.825) rectangle (2.186,9.6634);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.6634) rectangle (1.75,10.274);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.274) rectangle (2.9853,11.595);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.595) rectangle (1.75,13.038);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.038) rectangle (3.6393,13.191);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.191) rectangle (1.75,13.885);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.885) rectangle (2.186,14.362);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.362) rectangle (1.75,14.472);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.472) rectangle (5.8193,14.473);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (2.622,14.492);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.825) rectangle (7.0867,6.4358);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.4358) rectangle (5.6333,10.274);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.274) rectangle (6.7233,11.717);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.717) rectangle (5.6333,13.038);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.038) rectangle (6.0693,13.732);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.732) rectangle (5.6333,13.885);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.885) rectangle (7.5227,13.996);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.996) rectangle (6.0693,14.472);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.486) rectangle (9.7027,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.486) rectangle (8.2493,14.489);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.825) rectangle (10.062,6.4358);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.4358) rectangle (10.062,10.274);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.274) rectangle (10.607,11.717);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.717) rectangle (10.607,13.038);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.038) rectangle (10.607,13.732);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.732) rectangle (10.607,13.885);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.885) rectangle (10.607,13.996);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.996) rectangle (10.607,14.472);
...
\node[text=black, centered, rotate=90] at (13.72, 3.7875) {P Doesn't File};
\node[text=black, centered, rotate=90] at (13.72, 8.0496) {D Doesn't Answer};
\node[text=black, centered, rotate=90] at (13.72, 11.656) {Settles};
