...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (3.8573,9.2814);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.83) rectangle (7.7407,11.951);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.951) rectangle (7.3047,12.605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.605) rectangle (6.2873,13.273);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.062,10.388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.388) rectangle (10.062,11.041);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.041) rectangle (10.062,11.709);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.709) rectangle (10.062,11.83);
