...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.1307,2.0407);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0407) rectangle (2.4767,2.0485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0485) rectangle (1.8227,3.524);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.524) rectangle (1.75,6.093);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.093) rectangle (3.2033,6.8164);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.145) rectangle (4.2933,12.52);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.014,1.8954);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.8954) rectangle (6.36,1.9016);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9016) rectangle (5.706,4.319);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0469) rectangle (7.0867,9.5705);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.197) rectangle (8.1767,13.572);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.572) rectangle (6.7233,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.145) rectangle (10.607,12.822);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.822) rectangle (10.607,13.197);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.197) rectangle (10.607,13.572);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.572) rectangle (10.607,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 3.9215) {Settles};
\node[text=black, centered, rotate=90] at (13.72, 7.57) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.596) {D Defaults};
