...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (3.4213,9.9865);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.9865) rectangle (1.75,11.853);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.853) rectangle (1.968,13.2);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.2) rectangle (1.75,13.649);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.649) rectangle (5.8193,13.792);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (5.8513,11.027);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.027) rectangle (5.6333,11.853);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.853) rectangle (7.3047,12.303);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.303) rectangle (5.8513,13.649);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.003) rectangle (9.7027,14.146);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.146) rectangle (8.2493,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.062,11.027);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.027) rectangle (10.062,11.853);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.853) rectangle (10.062,12.303);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.303) rectangle (10.062,13.649);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.649) rectangle (11.697,13.86);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.86) rectangle (11.697,14.003);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.003) rectangle (11.697,14.146);
...
\node[text=black, centered, rotate=90] at (13.72, 10.507) {P Abandons};
