...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4097) rectangle (2.622,13.318);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.318) rectangle (1.75,13.896);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.896) rectangle (3.5667,14.174);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.174) rectangle (1.75,14.376);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.376) rectangle (4.0753,14.412);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4097) rectangle (7.0867,9.9877);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.9877) rectangle (5.6333,13.896);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.896) rectangle (7.014,14.098);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.098) rectangle (5.6333,14.376);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.376) rectangle (6.5053,14.447);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4097) rectangle (10.607,9.9877);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.9877) rectangle (10.607,13.896);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.896) rectangle (11.697,14.098);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.098) rectangle (11.697,14.376);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.376) rectangle (11.697,14.447);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.447) rectangle (11.697,14.484);
...
\node[text=black, centered, rotate=90] at (13.72, 11.653) {D Doesn't Answer};
