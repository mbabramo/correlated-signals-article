...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5119) rectangle (2.077,9.6455);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.6455) rectangle (1.75,10.359);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.359) rectangle (2.8763,11.228);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.228) rectangle (1.75,12.303);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.303) rectangle (3.5303,12.556);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.556) rectangle (1.75,13.632);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.632) rectangle (2.077,14.211);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.359) rectangle (6.6143,11.434);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.434) rectangle (5.6333,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.303) rectangle (5.9603,13.38);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.38) rectangle (5.6333,13.632);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.632) rectangle (7.4137,13.808);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.808) rectangle (5.9603,14.387);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.443) rectangle (8.3947,14.464);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5119) rectangle (9.9254,6.2249);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.2249) rectangle (9.9254,10.359);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.359) rectangle (10.334,11.434);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.434) rectangle (10.334,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.303) rectangle (10.334,13.38);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.38) rectangle (10.334,13.632);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.632) rectangle (10.334,13.808);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.808) rectangle (10.334,14.387);
...
\node[text=black, centered, rotate=90] at (13.72, 11.331) {Settles};
