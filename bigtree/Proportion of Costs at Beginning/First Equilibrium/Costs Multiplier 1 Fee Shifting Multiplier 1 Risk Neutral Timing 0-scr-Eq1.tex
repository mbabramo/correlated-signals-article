...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.1307,2.0926);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0926) rectangle (2.4767,2.1223);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.1223) rectangle (1.8227,4.8545);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,4.8545) rectangle (1.75,7.9593);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.9593) rectangle (3.2033,8.3253);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.492) rectangle (4.0753,11.966);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.014,2.0926);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.0926) rectangle (6.36,2.1222);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.1222) rectangle (5.706,4.8548);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.7255) rectangle (7.0867,10.092);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.996) rectangle (7.9587,13.47);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.47) rectangle (6.5053,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.492) rectangle (10.607,12.522);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.522) rectangle (10.607,12.996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.996) rectangle (10.607,13.47);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.47) rectangle (10.607,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 4.8547) {Settles};


\node[text=black, centered, rotate=90] at (13.72, 12.244) {P Loses};
\node[text=black, centered, rotate=90] at (13.72, 13.748) {P Wins};
