...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5119) rectangle (10.062,5.9398);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.9398) rectangle (10.062,9.1605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.607,11.016);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.016) rectangle (10.607,12.872);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.872) rectangle (10.607,13.549);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.549) rectangle (10.607,13.677);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.677) rectangle (10.607,13.806);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.806) rectangle (10.607,14.483);
...
\node[text=black, centered, rotate=90] at (13.72, 11.016) {Settles};
