...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,4.1708) -- (3.26,3.1554) -- (4.9,3.2261) -- (6.54,3.352) -- (8.18,3.4304);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,1.2479) -- (3.26,1.2343) -- (4.9,1.2734) -- (6.54,1.2821) -- (8.18,1.2988);
\draw[green, opacity=0.70, line width=1mm, solid] (1.62,3.3625) -- (3.26,2.3361) -- (4.9,2.3885) -- (6.54,2.3996) -- (8.18,2.447);
