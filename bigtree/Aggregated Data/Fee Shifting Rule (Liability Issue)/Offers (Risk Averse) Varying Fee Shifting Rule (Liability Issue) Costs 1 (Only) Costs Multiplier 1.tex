...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,2.8) -- (3.26,2.6218) -- (4.9,2.7703) -- (6.54,2.7735) -- (8.18,3.3062);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,2.8) -- (3.26,1.27) -- (4.9,1.8757) -- (6.54,1.9087) -- (8.18,2.1797);
