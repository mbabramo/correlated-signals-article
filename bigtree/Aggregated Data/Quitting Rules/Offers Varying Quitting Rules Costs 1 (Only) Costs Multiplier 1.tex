...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,3.0398) -- (3.26,2.9694) -- (4.9,2.7708) -- (6.54,2.7708) -- (8.18,2.6653);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,2.5602) -- (3.26,1.27) -- (4.9,1.27) -- (6.54,1.27) -- (8.18,1.3998);
