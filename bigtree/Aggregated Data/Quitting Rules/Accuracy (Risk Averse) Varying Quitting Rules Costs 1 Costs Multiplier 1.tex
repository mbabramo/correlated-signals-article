...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,1.9921) -- (3.26,1.9954) -- (4.9,1.9353) -- (6.54,2.0258) -- (8.18,2.028);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,1.9797) -- (3.26,1.9768) -- (4.9,1.9336) -- (6.54,2.0185) -- (8.18,2.0193);
