...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.391) rectangle (2.7673,13.612);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.612) rectangle (1.75,13.943);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.943) rectangle (3.4213,14.024);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.024) rectangle (1.75,14.212);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.212) rectangle (1.968,14.344);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.344) rectangle (1.75,14.471);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.471) rectangle (4.2933,14.48);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.391) rectangle (6.5053,13.721);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.721) rectangle (5.6333,13.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.943) rectangle (5.8513,14.131);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.131) rectangle (5.6333,14.212);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.212) rectangle (7.3047,14.338);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.338) rectangle (5.8513,14.471);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.391) rectangle (10.062,13.721);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.721) rectangle (10.062,13.943);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.943) rectangle (10.062,14.131);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.131) rectangle (10.062,14.212);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.212) rectangle (10.062,14.338);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.338) rectangle (10.062,14.471);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.471) rectangle (10.607,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.485) rectangle (10.607,14.495);
