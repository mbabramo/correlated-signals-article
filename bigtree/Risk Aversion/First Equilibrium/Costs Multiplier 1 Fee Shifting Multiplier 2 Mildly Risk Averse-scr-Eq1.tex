...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (2.7673,9.8713);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.8713) rectangle (1.75,10.582);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.582) rectangle (3.4213,10.948);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.948) rectangle (1.75,12.303);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.303) rectangle (1.968,13.659);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.659) rectangle (1.75,14.025);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.025) rectangle (4.5113,14.108);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (6.5053,9.8713);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8713) rectangle (5.6333,10.582);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.582) rectangle (5.8513,11.937);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.937) rectangle (5.6333,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.303) rectangle (7.3047,12.67);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.67) rectangle (5.8513,14.025);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.262) rectangle (8.3947,14.346);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.346) rectangle (6.9413,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.062,9.8713);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8713) rectangle (10.062,10.582);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.582) rectangle (10.062,11.937);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.937) rectangle (10.062,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.303) rectangle (10.062,12.67);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.67) rectangle (10.062,14.025);
...
\node[text=black, centered, rotate=90] at (13.72, 9.8713) {Settles};
