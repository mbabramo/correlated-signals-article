...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (3.3123,9.6735);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.6735) rectangle (1.75,11.135);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.135) rectangle (1.859,12.597);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (5.7423,10.622);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.622) rectangle (5.6333,11.135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.135) rectangle (7.1957,11.648);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.648) rectangle (5.7423,13.11);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (9.7892,10.622);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.622) rectangle (9.7892,11.135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.135) rectangle (9.7892,11.648);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.648) rectangle (9.7892,13.11);
...
\node[text=black, centered, rotate=90] at (13.72, 12.122) {D Defaults};
