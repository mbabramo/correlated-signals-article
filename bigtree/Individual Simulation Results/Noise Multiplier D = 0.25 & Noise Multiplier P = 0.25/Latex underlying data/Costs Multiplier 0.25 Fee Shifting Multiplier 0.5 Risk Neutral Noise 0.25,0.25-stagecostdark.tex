...
\draw[white, very thin, fill=blue] (1.75,11.509) rectangle (5.0069,11.904);
\draw[white, very thin, fill=red] (1.75,11.904) rectangle (1.75,12.505);
\draw[white, very thin, fill=blue] (1.75,12.505) rectangle (1.8598,13.105);
...
\draw[white, very thin, fill=red] (9.3189,11.509) rectangle (9.4287,12.109);
\draw[white, very thin, fill=blue] (9.3189,12.109) rectangle (9.3189,12.505);
\draw[white, very thin, fill=red] (9.3189,12.505) rectangle (12.576,12.9);
\draw[white, very thin, fill=blue] (9.3189,12.9) rectangle (9.6482,13.5);
