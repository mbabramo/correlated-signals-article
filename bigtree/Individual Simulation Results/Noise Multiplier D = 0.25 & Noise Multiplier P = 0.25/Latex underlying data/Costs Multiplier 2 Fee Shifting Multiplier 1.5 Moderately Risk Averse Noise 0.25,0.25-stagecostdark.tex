...
\draw[white, very thin, fill=blue] (1.75,6.6298) rectangle (2.6283,11);
\draw[white, very thin, fill=red] (1.75,11) rectangle (1.75,11.509);
\draw[white, very thin, fill=blue] (1.75,11.509) rectangle (4.2384,12.229);
\draw[white, very thin, fill=red] (1.75,12.229) rectangle (1.75,12.95);
\draw[white, very thin, fill=blue] (1.75,12.95) rectangle (5.5558,13.035);
\draw[white, very thin, fill=red] (1.75,13.035) rectangle (1.75,13.225);
\draw[white, very thin, fill=blue] (1.75,13.225) rectangle (2.6283,13.414);
...
\draw[white, very thin, fill=red] (9.3189,11.509) rectangle (11.515,12.229);
\draw[white, very thin, fill=blue] (9.3189,12.229) rectangle (9.3189,12.95);
\draw[white, very thin, fill=red] (9.3189,12.95) rectangle (10.197,13.139);
\draw[white, very thin, fill=blue] (9.3189,13.139) rectangle (9.3189,13.225);
\draw[white, very thin, fill=red] (9.3189,13.225) rectangle (13.125,13.31);
\draw[white, very thin, fill=blue] (9.3189,13.31) rectangle (10.197,13.5);
...
\draw[white, very thin, fill=red] (16.888,6.6298) rectangle (17.986,7.1392);
\draw[white, very thin, fill=blue] (16.888,7.1392) rectangle (17.986,11.509);
\draw[white, very thin, fill=red] (16.888,11.509) rectangle (19.083,12.229);
\draw[white, very thin, fill=blue] (16.888,12.229) rectangle (19.083,12.95);
\draw[white, very thin, fill=red] (16.888,12.95) rectangle (19.083,13.139);
\draw[white, very thin, fill=blue] (16.888,13.139) rectangle (19.083,13.225);
\draw[white, very thin, fill=red] (16.888,13.225) rectangle (19.083,13.31);
...
\node[text=yellow, centered, rotate=90] at (24.777, 12.229) {Settles};
