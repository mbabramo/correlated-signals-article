...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0451) rectangle (10.062,7.5979);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.5979) rectangle (10.062,12.34);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.34) rectangle (10.607,13.121);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.121) rectangle (10.607,13.903);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.903) rectangle (10.607,14.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.108) rectangle (10.607,14.201);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.201) rectangle (10.607,14.294);
...
\node[text=black, centered, rotate=90] at (13.72, 13.121) {Settles};
