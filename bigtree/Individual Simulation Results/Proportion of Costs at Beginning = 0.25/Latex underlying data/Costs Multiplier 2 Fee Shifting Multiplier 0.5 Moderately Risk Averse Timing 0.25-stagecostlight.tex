...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5342) rectangle (2.7673,8.3899);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.3899) rectangle (1.75,10.245);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.245) rectangle (3.4213,10.57);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5342) rectangle (6.5053,8.3899);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3899) rectangle (5.6333,10.245);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.245) rectangle (5.8513,11.992);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.5342) rectangle (10.062,8.3899);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3899) rectangle (10.062,10.245);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.245) rectangle (10.062,11.992);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.992) rectangle (10.062,12.316);
...
\node[text=black, centered, rotate=90] at (13.72, 8.3899) {Settles};
\node[text=black, centered, rotate=90] at (13.72, 11.281) {P Abandons};
