...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.9131) rectangle (3.3123,10.634);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.634) rectangle (1.75,12.207);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.207) rectangle (1.859,13.779);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.9131) rectangle (5.7423,11.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.486) rectangle (5.6333,12.207);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.207) rectangle (7.1957,12.928);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.928) rectangle (5.7423,14.5);
