...
\draw[white, very thin, fill=blue] (1.75,7.625) rectangle (3.5065,12.377);
\draw[white, very thin, fill=red] (1.75,12.377) rectangle (1.75,13.193);
\draw[white, very thin, fill=blue] (1.75,13.193) rectangle (6.2877,13.249);
\draw[white, very thin, fill=blue] (1.75,13.249) rectangle (5.8486,13.28);
\draw[white, very thin, fill=blue] (1.75,13.28) rectangle (5.4094,13.301);
\draw[white, very thin, fill=red] (1.75,13.301) rectangle (1.75,13.44);
\draw[white, very thin, fill=blue] (1.75,13.44) rectangle (6.4341,13.461);
\draw[white, very thin, fill=red] (1.75,13.461) rectangle (1.75,13.483);
...
\draw[white, very thin, fill=red] (9.3189,7.625) rectangle (12.246,8.441);
\draw[white, very thin, fill=blue] (9.3189,8.441) rectangle (9.3189,13.193);
\draw[white, very thin, fill=red] (9.3189,13.193) rectangle (12.1,13.206);
\draw[white, very thin, fill=red] (9.3189,13.206) rectangle (11.661,13.237);
\draw[white, very thin, fill=red] (9.3189,13.237) rectangle (11.222,13.332);
\draw[white, very thin, fill=blue] (9.3189,13.332) rectangle (9.3189,13.44);
\draw[white, very thin, fill=red] (9.3189,13.44) rectangle (11.075,13.462);
...
\draw[white, very thin, fill=red] (16.888,7.625) rectangle (19.083,8.441);
\draw[white, very thin, fill=blue] (16.888,8.441) rectangle (19.083,13.193);
\draw[white, very thin, fill=red] (16.888,13.193) rectangle (21.279,13.332);
\draw[white, very thin, fill=blue] (16.888,13.332) rectangle (21.279,13.44);
\draw[white, very thin, fill=red] (16.888,13.44) rectangle (21.279,13.462);
...
\node[text=yellow, centered, rotate=90] at (24.777, 10.409) {D Doesn't Answer};
