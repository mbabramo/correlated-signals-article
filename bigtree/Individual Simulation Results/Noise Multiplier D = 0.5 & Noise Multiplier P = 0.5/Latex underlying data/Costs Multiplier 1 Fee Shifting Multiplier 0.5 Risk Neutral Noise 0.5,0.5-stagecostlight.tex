...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0161) rectangle (1.968,11.93);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.93) rectangle (1.75,12.687);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.687) rectangle (3.3487,12.815);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.815) rectangle (1.75,13.049);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.049) rectangle (3.8573,13.324);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.324) rectangle (1.75,13.785);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.785) rectangle (1.968,14.229);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0161) rectangle (7.0867,7.7738);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.7738) rectangle (5.6333,12.687);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.687) rectangle (5.924,12.922);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.922) rectangle (5.6333,13.049);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.049) rectangle (5.8513,13.51);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.51) rectangle (5.6333,13.785);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.785) rectangle (7.7407,14.055);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.055) rectangle (6.2873,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0161) rectangle (9.7892,7.7738);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.7738) rectangle (9.7892,12.687);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.687) rectangle (10.062,12.922);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.922) rectangle (10.062,13.049);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.049) rectangle (10.607,13.51);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.51) rectangle (10.607,13.785);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.785) rectangle (10.607,14.055);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.055) rectangle (10.607,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 9.8518) {D Doesn't Answer};
