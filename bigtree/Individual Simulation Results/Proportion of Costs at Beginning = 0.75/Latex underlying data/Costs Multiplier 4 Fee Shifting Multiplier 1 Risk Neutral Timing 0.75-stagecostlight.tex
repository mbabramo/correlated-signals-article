...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.1251) rectangle (3.058,13.064);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.064) rectangle (1.75,14.339);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.339) rectangle (4.4387,14.376);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.376) rectangle (1.75,14.493);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.493) rectangle (6.6913,14.494);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.1251) rectangle (7.0867,9.4);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4) rectangle (5.6333,14.339);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.339) rectangle (7.014,14.455);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.496) rectangle (10.575,14.498);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.498) rectangle (9.1213,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.1251) rectangle (11.152,9.4);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4) rectangle (11.152,14.339);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.339) rectangle (12.787,14.455);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.455) rectangle (12.787,14.493);
...
\node[text=black, centered, rotate=90] at (13.72, 11.232) {D Doesn't Answer};
