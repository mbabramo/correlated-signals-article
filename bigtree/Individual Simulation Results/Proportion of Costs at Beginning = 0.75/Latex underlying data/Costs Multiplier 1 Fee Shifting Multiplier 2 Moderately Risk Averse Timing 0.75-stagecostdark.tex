...
\draw[white, very thin, fill=blue] (1.75,5.2168) rectangle (2.4087,9.0262);
\draw[white, very thin, fill=red] (1.75,9.0262) rectangle (1.75,9.6834);
\draw[white, very thin, fill=blue] (1.75,9.6834) rectangle (4.0188,10.485);
\draw[white, very thin, fill=red] (1.75,10.485) rectangle (1.75,11.476);
\draw[white, very thin, fill=blue] (1.75,11.476) rectangle (5.3362,11.708);
\draw[white, very thin, fill=red] (1.75,11.708) rectangle (1.75,12.7);
\draw[white, very thin, fill=blue] (1.75,12.7) rectangle (2.4087,13.233);
\draw[white, very thin, fill=red] (1.75,13.233) rectangle (1.75,13.396);
...
\draw[white, very thin, fill=red] (9.3189,9.6834) rectangle (11.295,10.674);
\draw[white, very thin, fill=blue] (9.3189,10.674) rectangle (9.3189,11.476);
\draw[white, very thin, fill=red] (9.3189,11.476) rectangle (9.9776,12.468);
\draw[white, very thin, fill=blue] (9.3189,12.468) rectangle (9.3189,12.7);
\draw[white, very thin, fill=red] (9.3189,12.7) rectangle (12.905,12.863);
\draw[white, very thin, fill=blue] (9.3189,12.863) rectangle (9.9776,13.396);
...
\draw[white, very thin, fill=red] (16.888,5.2168) rectangle (17.711,5.8739);
\draw[white, very thin, fill=blue] (16.888,5.8739) rectangle (17.711,9.6834);
\draw[white, very thin, fill=red] (16.888,9.6834) rectangle (18.534,10.674);
\draw[white, very thin, fill=blue] (16.888,10.674) rectangle (18.534,11.476);
\draw[white, very thin, fill=red] (16.888,11.476) rectangle (18.534,12.468);
\draw[white, very thin, fill=blue] (16.888,12.468) rectangle (18.534,12.7);
\draw[white, very thin, fill=red] (16.888,12.7) rectangle (18.534,12.863);
\draw[white, very thin, fill=blue] (16.888,12.863) rectangle (18.534,13.396);
...
\node[text=yellow, centered, rotate=90] at (24.777, 10.579) {Settles};
