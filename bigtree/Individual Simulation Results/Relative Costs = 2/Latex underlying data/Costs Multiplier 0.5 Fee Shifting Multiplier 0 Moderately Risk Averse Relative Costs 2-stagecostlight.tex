...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.365) rectangle (3.4213,12.563);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8406) rectangle (6.9777,7.7388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.7388) rectangle (5.6333,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.365) rectangle (5.7423,12.911);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8406) rectangle (9.9254,7.7388);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.7388) rectangle (9.9254,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.365) rectangle (9.9254,12.911);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.911) rectangle (9.9254,13.11);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.11) rectangle (10.334,13.572);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.572) rectangle (10.334,13.805);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.805) rectangle (10.334,14.038);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.038) rectangle (10.334,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 9.6027) {Settles};
