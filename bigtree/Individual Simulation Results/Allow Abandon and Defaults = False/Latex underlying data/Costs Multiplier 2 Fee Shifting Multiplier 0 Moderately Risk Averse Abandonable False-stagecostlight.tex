...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.1307,2.463);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.463) rectangle (2.9127,4.8477);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.8477) rectangle (2.6947,7.9825);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.014,2.1332);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.1332) rectangle (6.796,3.89);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.89) rectangle (6.578,8.0238);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (10.607,3.5068);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.5068) rectangle (10.607,5.8915);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.8915) rectangle (10.607,10.408);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.408) rectangle (10.607,14.256);
