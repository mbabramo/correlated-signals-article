...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.359) rectangle (3.3487,10.874);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.359) rectangle (5.924,11.85);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.259) rectangle (8.1767,13.6);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.6) rectangle (6.7233,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.359) rectangle (10.062,11.85);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.85) rectangle (10.062,12.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.365) rectangle (10.607,12.918);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.918) rectangle (10.607,13.259);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.259) rectangle (10.607,13.6);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.6) rectangle (10.607,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 11.362) {Settles};
