...
\draw[white, very thin, fill=blue] (1.75,10.65) rectangle (5.4094,10.991);
\draw[white, very thin, fill=red] (1.75,10.991) rectangle (1.75,12.196);
\draw[white, very thin, fill=blue] (1.75,12.196) rectangle (5.5558,12.201);
\draw[white, very thin, fill=red] (1.75,12.201) rectangle (1.75,12.217);
\draw[white, very thin, fill=blue] (1.75,12.217) rectangle (2.6283,12.349);
\draw[white, very thin, fill=red] (1.75,12.349) rectangle (1.75,12.426);
\draw[white, very thin, fill=blue] (1.75,12.426) rectangle (8.1906,12.454);
\draw[white, very thin, fill=blue] (1.75,12.454) rectangle (6.4341,12.606);
\draw[white, very thin, fill=red] (1.75,12.606) rectangle (1.75,12.991);
\draw[white, very thin, fill=blue] (1.75,12.991) rectangle (3.5065,13.225);
\draw[white, very thin, fill=red] (1.75,13.225) rectangle (1.75,13.405);
...
\draw[white, very thin, fill=red] (9.3189,10.65) rectangle (10.344,11.855);
\draw[white, very thin, fill=blue] (9.3189,11.855) rectangle (9.3189,12.196);
\draw[white, very thin, fill=red] (9.3189,12.196) rectangle (10.197,12.212);
\draw[white, very thin, fill=blue] (9.3189,12.212) rectangle (9.3189,12.217);
\draw[white, very thin, fill=red] (9.3189,12.217) rectangle (13.125,12.294);
\draw[white, very thin, fill=blue] (9.3189,12.294) rectangle (10.197,12.426);
\draw[white, very thin, fill=red] (9.3189,12.426) rectangle (11.075,12.692);
\draw[white, very thin, fill=red] (9.3189,12.692) rectangle (9.3189,12.811);
\draw[white, very thin, fill=blue] (9.3189,12.811) rectangle (9.3189,12.991);
\draw[white, very thin, fill=red] (9.3189,12.991) rectangle (15.759,13.016);
\draw[white, very thin, fill=red] (9.3189,13.016) rectangle (14.003,13.171);
\draw[white, very thin, fill=blue] (9.3189,13.171) rectangle (12.832,13.266);
...
\draw[white, very thin, fill=red] (16.888,10.65) rectangle (19.083,11.855);
\draw[white, very thin, fill=blue] (16.888,11.855) rectangle (19.083,12.196);
\draw[white, very thin, fill=red] (16.888,12.196) rectangle (19.083,12.212);
\draw[white, very thin, fill=blue] (16.888,12.212) rectangle (19.083,12.217);
\draw[white, very thin, fill=red] (16.888,12.217) rectangle (19.083,12.294);
