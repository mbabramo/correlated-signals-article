...
\draw[white, very thin, fill=blue] (1.75,7.6251) rectangle (3.5065,11.826);
\draw[white, very thin, fill=red] (1.75,11.826) rectangle (1.75,12.617);
\draw[white, very thin, fill=blue] (1.75,12.617) rectangle (5.4094,12.975);
\draw[white, very thin, fill=red] (1.75,12.975) rectangle (1.75,13.402);
\draw[white, very thin, fill=blue] (1.75,13.402) rectangle (6.4341,13.419);
\draw[white, very thin, fill=red] (1.75,13.419) rectangle (1.75,13.482);
...
\draw[white, very thin, fill=red] (9.3189,7.6251) rectangle (12.246,8.4165);
\draw[white, very thin, fill=blue] (9.3189,8.4165) rectangle (9.3189,12.617);
\draw[white, very thin, fill=red] (9.3189,12.617) rectangle (12.1,13.045);
\draw[white, very thin, fill=blue] (9.3189,13.045) rectangle (9.3189,13.402);
\draw[white, very thin, fill=red] (9.3189,13.402) rectangle (11.075,13.465);
\draw[white, very thin, fill=blue] (9.3189,13.465) rectangle (9.3189,13.482);
...
\draw[white, very thin, fill=red] (16.888,7.6251) rectangle (19.083,8.4165);
\draw[white, very thin, fill=blue] (16.888,8.4165) rectangle (19.083,12.617);
\draw[white, very thin, fill=red] (16.888,12.617) rectangle (21.279,13.045);
\draw[white, very thin, fill=blue] (16.888,13.045) rectangle (21.279,13.402);
\draw[white, very thin, fill=red] (16.888,13.402) rectangle (21.279,13.465);
\draw[white, very thin, fill=blue] (16.888,13.465) rectangle (21.279,13.482);
...
\node[text=yellow, centered, rotate=90] at (24.777, 10.121) {D Doesn't Answer};
