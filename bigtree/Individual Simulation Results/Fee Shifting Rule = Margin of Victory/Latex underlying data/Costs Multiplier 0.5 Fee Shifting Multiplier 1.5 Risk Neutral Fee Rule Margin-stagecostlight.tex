...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.8663) rectangle (3.2397,8.0725);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0725) rectangle (1.75,9.1605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (3.7483,9.2814);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2814) rectangle (3.4213,9.9348);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.9348) rectangle (1.75,11.83);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.83) rectangle (1.968,13.057);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.8663) rectangle (5.815,8.9543);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.9543) rectangle (5.6333,9.1605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (5.8513,10.388);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.83) rectangle (7.6317,11.951);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.951) rectangle (7.3047,12.605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.605) rectangle (6.1783,13.273);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.273) rectangle (5.8513,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.8663) rectangle (9.7892,8.9543);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.9543) rectangle (9.7892,9.1605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.062,9.8288);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8288) rectangle (10.062,9.9497);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.9497) rectangle (10.062,11.177);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.177) rectangle (10.062,11.83);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.83) rectangle (10.062,11.951);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.951) rectangle (10.062,12.619);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.619) rectangle (10.062,13.273);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.273) rectangle (10.062,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 8.5134) {Settles};
\node[text=black, centered, rotate=90] at (13.72, 10.495) {P Loses};
\node[text=black, centered, rotate=90] at (13.72, 13.165) {P Wins};
