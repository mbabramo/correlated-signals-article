...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.359) rectangle (3.3487,10.462);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.462) rectangle (1.75,10.843);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.843) rectangle (3.4213,11.21);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.21) rectangle (1.75,12.27);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.27) rectangle (1.968,12.744);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.744) rectangle (1.75,12.95);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.95) rectangle (4.5113,13.206);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.359) rectangle (5.924,10.74);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.74) rectangle (5.6333,10.843);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.843) rectangle (5.8513,11.903);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.903) rectangle (5.6333,12.27);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.27) rectangle (7.3047,12.476);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.476) rectangle (5.8513,12.95);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.688) rectangle (8.3947,13.944);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.944) rectangle (6.9413,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.359) rectangle (10.062,10.74);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.74) rectangle (10.062,10.843);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.843) rectangle (10.062,11.903);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.903) rectangle (10.062,12.27);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.27) rectangle (10.062,12.476);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.476) rectangle (10.062,12.95);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.95) rectangle (10.607,13.431);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.431) rectangle (10.607,13.688);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.688) rectangle (10.607,13.944);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.944) rectangle (10.607,14.5);
