...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.707) rectangle (3.3487,11.708);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.708) rectangle (3.058,11.716);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.716) rectangle (2.7673,12.063);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.063) rectangle (1.75,12.815);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.815) rectangle (3.4213,12.848);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.848) rectangle (1.75,13.873);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.873) rectangle (1.968,14.42);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.42) rectangle (1.75,14.446);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.446) rectangle (4.0753,14.45);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.707) rectangle (6.5053,12.223);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.223) rectangle (6.2147,12.294);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.294) rectangle (5.924,12.459);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.459) rectangle (5.6333,12.815);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.815) rectangle (5.8513,13.84);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.899) rectangle (5.8513,14.446);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.707) rectangle (10.062,11.777);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.777) rectangle (10.062,11.786);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.786) rectangle (10.062,11.95);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.95) rectangle (10.062,11.952);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.952) rectangle (10.062,12.468);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.468) rectangle (10.062,12.815);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.815) rectangle (10.062,13.84);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.84) rectangle (10.062,13.873);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.873) rectangle (10.062,13.899);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.899) rectangle (10.062,14.446);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.472) rectangle (10.607,14.476);
