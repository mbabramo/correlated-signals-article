...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.2907) rectangle (1.859,6.0941);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.0941) rectangle (1.75,6.1078);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.1078) rectangle (3.2397,6.1255);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.1255) rectangle (2.949,6.1667);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.1667) rectangle (2.6583,6.2869);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.2869) rectangle (2.5857,6.3547);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.3547) rectangle (2.295,6.6301);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.6301) rectangle (1.9317,8.8674);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.271) rectangle (3.7483,14.289);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.1078) rectangle (7.123,6.1279);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.1279) rectangle (6.7597,6.1618);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.1618) rectangle (6.469,6.2474);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.2474) rectangle (6.3963,6.378);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.378) rectangle (6.1057,6.8537);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8537) rectangle (5.815,10.134);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.134) rectangle (5.6697,12.372);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.386) rectangle (7.6317,14.403);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.403) rectangle (6.1783,14.5);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.3044) rectangle (9.6529,6.1078);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.1078) rectangle (9.7892,6.7141);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.7141) rectangle (9.7892,6.8754);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8754) rectangle (9.7892,10.156);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.156) rectangle (9.7892,10.174);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.174) rectangle (9.7892,10.259);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.259) rectangle (9.7892,10.327);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.327) rectangle (9.7892,10.381);
...
\node[text=black, centered, rotate=90] at (13.72, 4.6992) {No Answer};
\node[text=black, centered, rotate=90] at (13.72, 9.5009) {Settles};
