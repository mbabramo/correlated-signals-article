...
\draw[white, very thin, fill=blue] (1.75,8.5793) rectangle (3.7993,9.2343);
\draw[white, very thin, fill=red] (1.75,9.2343) rectangle (1.75,9.8894);
\draw[white, very thin, fill=blue] (1.75,9.8894) rectangle (5.1167,10.227);
\draw[white, very thin, fill=red] (1.75,10.227) rectangle (1.75,11.476);
\draw[white, very thin, fill=blue] (1.75,11.476) rectangle (2.1891,12.725);
\draw[white, very thin, fill=red] (1.75,12.725) rectangle (1.75,13.062);
\draw[white, very thin, fill=blue] (1.75,13.062) rectangle (7.3123,13.139);
...
\draw[white, very thin, fill=red] (9.3189,8.5793) rectangle (11.075,9.2343);
\draw[white, very thin, fill=blue] (9.3189,9.2343) rectangle (9.3189,9.8894);
\draw[white, very thin, fill=red] (9.3189,9.8894) rectangle (9.758,11.138);
\draw[white, very thin, fill=blue] (9.3189,11.138) rectangle (9.3189,11.476);
\draw[white, very thin, fill=red] (9.3189,11.476) rectangle (12.686,11.813);
\draw[white, very thin, fill=blue] (9.3189,11.813) rectangle (9.758,13.062);
...
\draw[white, very thin, fill=red] (9.3189,13.281) rectangle (14.881,13.358);
\draw[white, very thin, fill=blue] (9.3189,13.358) rectangle (11.954,13.5);
...
\draw[white, very thin, fill=red] (16.888,8.5793) rectangle (17.986,9.2343);
\draw[white, very thin, fill=blue] (16.888,9.2343) rectangle (17.986,9.8894);
\draw[white, very thin, fill=red] (16.888,9.8894) rectangle (17.986,11.138);
\draw[white, very thin, fill=blue] (16.888,11.138) rectangle (17.986,11.476);
\draw[white, very thin, fill=red] (16.888,11.476) rectangle (17.986,11.813);
\draw[white, very thin, fill=blue] (16.888,11.813) rectangle (17.986,13.062);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.2343) {Settles};
