...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.525) rectangle (2.186,14.374);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.55) rectangle (6.0693,13.399);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.55) rectangle (10.607,13.399);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.399) rectangle (10.607,13.525);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.525) rectangle (10.607,13.651);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.651) rectangle (10.607,14.5);
