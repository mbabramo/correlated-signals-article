...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.403) rectangle (1.968,14.13);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.13) rectangle (1.75,14.256);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.256) rectangle (4.5113,14.276);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.255) rectangle (5.9967,12.489);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.489) rectangle (5.6333,12.55);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.55) rectangle (5.8513,13.277);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.277) rectangle (5.6333,13.403);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.403) rectangle (7.3047,13.529);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.529) rectangle (5.8513,14.256);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.378) rectangle (8.3947,14.398);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.398) rectangle (6.9413,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.255) rectangle (10.062,12.489);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.489) rectangle (10.062,12.55);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.55) rectangle (10.062,13.277);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.277) rectangle (10.062,13.403);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.403) rectangle (10.062,13.529);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.529) rectangle (10.062,14.256);
...
\node[text=black, centered, rotate=90] at (13.72, 11.402) {Settles};
