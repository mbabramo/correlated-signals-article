...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.2719) rectangle (2.186,12.708);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.708) rectangle (1.75,12.837);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.837) rectangle (2.9127,13.321);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.321) rectangle (1.75,13.842);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.842) rectangle (3.6393,13.856);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.856) rectangle (1.75,14.239);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.239) rectangle (2.186,14.484);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.2719) rectangle (7.0867,7.4006);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.4006) rectangle (5.6333,12.837);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.837) rectangle (6.796,13.358);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.358) rectangle (5.6333,13.842);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.842) rectangle (6.0693,14.226);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.226) rectangle (5.6333,14.239);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.239) rectangle (7.5227,14.248);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.248) rectangle (6.0693,14.493);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.2719) rectangle (10.062,7.4006);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.4006) rectangle (10.062,12.837);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.837) rectangle (10.607,13.358);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.358) rectangle (10.607,13.842);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.842) rectangle (10.607,14.226);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.226) rectangle (10.607,14.239);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.239) rectangle (10.607,14.248);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.248) rectangle (10.607,14.493);
...
\node[text=black, centered, rotate=90] at (13.72, 10.054) {D Doesn't Answer};
