...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.2719) rectangle (10.062,7.4906);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.4906) rectangle (10.062,13.281);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.281) rectangle (10.607,13.714);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.714) rectangle (10.607,13.969);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.969) rectangle (10.607,14.353);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.353) rectangle (10.607,14.366);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.366) rectangle (10.607,14.373);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.373) rectangle (10.607,14.493);
...
\node[text=black, centered, rotate=90] at (13.72, 10.277) {D Doesn't Answer};
