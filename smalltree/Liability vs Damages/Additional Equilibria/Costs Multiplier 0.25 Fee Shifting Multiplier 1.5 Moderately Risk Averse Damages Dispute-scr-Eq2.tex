...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.1581) rectangle (3.1488,7.1581);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.1581) rectangle (2.7855,7.1583);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.1583) rectangle (2.4222,7.2125);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.2125) rectangle (2.0588,8.3295);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.1581) rectangle (7.3592,7.1581);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.1581) rectangle (7.3592,7.1581);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.1581) rectangle (6.9958,7.1581);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.1581) rectangle (6.9958,7.1606);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.1606) rectangle (6.6325,7.1606);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.1606) rectangle (6.6325,7.3359);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.3359) rectangle (6.2692,7.3359);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.3359) rectangle (6.2692,9.2347);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.2347) rectangle (5.9058,9.2347);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.2347) rectangle (5.9058,13.329);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.1581) rectangle (9.7892,14.356);
