...
\draw[black, very thin] (13.35,5.5996) -- (13.45,5.5996);
\node[anchor=west] at (13.35, 5.5996) {};
\draw[black, very thin] (13.35,9.4823) -- (13.45,9.4823);
\node[anchor=west] at (13.35, 9.4823) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.5985);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.5985) rectangle (1.75,5.5996);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5996) rectangle (3.4213,6.8031);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8031) rectangle (1.75,9.4823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4823) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5817) rectangle (6.578,5.5828);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5828) rectangle (5.6333,5.5996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5996) rectangle (5.8513,8.2788);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2788) rectangle (5.6333,9.4823);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4823) rectangle (7.3047,9.8617);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8617) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5817) rectangle (10.062,5.5828);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5828) rectangle (10.062,5.5996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5996) rectangle (10.062,8.2788);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2788) rectangle (10.062,9.4823);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4823) rectangle (10.062,9.8617);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8617) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.5996) -- (13.4,5.5996);
\draw[black, dotted] (1.5,9.4823) -- (13.4,9.4823);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5409) {P Abandons};
