...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.044) rectangle (3.93,13.356);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.356) rectangle (1.75,13.889);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.889) rectangle (4.0753,13.995);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.995) rectangle (1.75,14.128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.128) rectangle (2.622,14.186);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.186) rectangle (1.75,14.227);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.227) rectangle (7.5633,14.282);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.044) rectangle (6.6507,13.576);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.576) rectangle (5.6333,13.889);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.889) rectangle (6.5053,14.021);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.021) rectangle (5.6333,14.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.128) rectangle (7.9587,14.169);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.169) rectangle (6.5053,14.227);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.356) rectangle (11.447,14.403);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.403) rectangle (9.9933,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.044) rectangle (11.697,13.576);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.576) rectangle (11.697,13.889);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.889) rectangle (11.697,14.021);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.021) rectangle (11.697,14.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.128) rectangle (11.697,14.169);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.169) rectangle (11.697,14.227);
