...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.208);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.208) rectangle (1.75,10.233);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.233) rectangle (3.6393,11.162);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.162) rectangle (1.75,12.741);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.741) rectangle (2.186,13.593);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.593) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.119);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.119) rectangle (5.6333,10.233);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.233) rectangle (6.0693,11.812);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.812) rectangle (5.6333,12.741);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.741) rectangle (7.5227,12.913);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.913) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.119);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.119) rectangle (10.607,10.233);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.233) rectangle (10.607,11.812);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.812) rectangle (10.607,12.741);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.741) rectangle (10.607,12.913);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.913) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.487) {P Abandons};
