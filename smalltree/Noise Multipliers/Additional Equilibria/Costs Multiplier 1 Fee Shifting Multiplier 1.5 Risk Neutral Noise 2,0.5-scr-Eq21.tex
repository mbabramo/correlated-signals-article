...
\draw[black, very thin] (13.35,5.5995) -- (13.45,5.5995);
\node[anchor=west] at (13.35, 5.5995) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.5983);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.5983) rectangle (1.75,5.5995);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5995) rectangle (3.4213,6.803);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.803) rectangle (1.75,9.4822);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4822) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5828) rectangle (5.6333,5.5995);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5995) rectangle (5.8513,8.2787);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2787) rectangle (5.6333,9.4822);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4822) rectangle (7.3047,9.8616);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8616) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5828) rectangle (10.062,5.5995);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5995) rectangle (10.062,8.2787);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2787) rectangle (10.062,9.4822);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4822) rectangle (10.062,9.8616);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8616) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.5995) -- (13.4,5.5995);
