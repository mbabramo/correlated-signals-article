...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.294);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.294) rectangle (1.75,10.338);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.338) rectangle (3.6393,11.224);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.224) rectangle (1.75,12.793);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.793) rectangle (2.186,13.602);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.602) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.138);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.138) rectangle (5.6333,10.338);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.338) rectangle (6.0693,11.907);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.907) rectangle (5.6333,12.793);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.793) rectangle (7.5227,12.956);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.956) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.138);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.138) rectangle (10.607,10.338);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.338) rectangle (10.607,11.907);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.907) rectangle (10.607,12.793);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.793) rectangle (10.607,12.956);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.956) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.565) {P Abandons};
