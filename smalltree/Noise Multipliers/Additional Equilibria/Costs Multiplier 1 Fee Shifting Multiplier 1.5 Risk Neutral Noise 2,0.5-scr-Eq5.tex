...
\draw[black, very thin] (13.35,5.6221) -- (13.45,5.6221);
\node[anchor=west] at (13.35, 5.6221) {};
\draw[black, very thin] (13.35,9.4935) -- (13.45,9.4935);
\node[anchor=west] at (13.35, 9.4935) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.6195);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.6195) rectangle (1.75,5.6221);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6221) rectangle (3.4213,6.8151);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8151) rectangle (1.75,9.4935);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4935) rectangle (1.968,11.799);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.799) rectangle (1.75,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5817) rectangle (6.578,5.5843);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5843) rectangle (5.6333,5.6221);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6221) rectangle (5.8513,8.3006);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3006) rectangle (5.6333,9.4935);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4935) rectangle (7.3047,9.8722);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8722) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5817) rectangle (10.062,5.5843);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5843) rectangle (10.062,5.6221);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6221) rectangle (10.062,8.3006);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3006) rectangle (10.062,9.4935);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4935) rectangle (10.062,9.8722);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8722) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6221) -- (13.4,5.6221);
\draw[black, dotted] (1.5,9.4935) -- (13.4,9.4935);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5578) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.835) {D Defaults};
