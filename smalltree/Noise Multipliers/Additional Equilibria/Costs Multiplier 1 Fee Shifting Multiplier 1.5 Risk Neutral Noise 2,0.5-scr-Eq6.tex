...
\draw[black, very thin] (13.35,5.6154) -- (13.45,5.6154);
\node[anchor=west] at (13.35, 5.6154) {};
\draw[black, very thin] (13.35,9.4902) -- (13.45,9.4902);
\node[anchor=west] at (13.35, 9.4902) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.6132);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.6132) rectangle (1.75,5.6154);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6154) rectangle (3.4213,6.8115);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8115) rectangle (1.75,9.4902);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4902) rectangle (1.968,11.799);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5817) rectangle (6.578,5.5839);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5839) rectangle (5.6333,5.6154);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6154) rectangle (5.8513,8.2941);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2941) rectangle (5.6333,9.4902);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4902) rectangle (7.3047,9.869);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.869) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5817) rectangle (10.062,5.5839);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5839) rectangle (10.062,5.6154);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6154) rectangle (10.062,8.2941);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2941) rectangle (10.062,9.4902);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4902) rectangle (10.062,9.869);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.869) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6154) -- (13.4,5.6154);
\draw[black, dotted] (1.5,9.4902) -- (13.4,9.4902);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5528) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.834) {D Defaults};
