...
\draw[black, very thin] (13.35,10.17) -- (13.45,10.17);
\node[anchor=west] at (13.35, 10.17) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.157);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.157) rectangle (1.75,10.17);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.17) rectangle (3.6393,11.125);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.125) rectangle (1.75,12.71);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.71) rectangle (2.186,13.587);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.108) rectangle (5.6333,10.17);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.17) rectangle (6.0693,11.755);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.755) rectangle (5.6333,12.71);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.71) rectangle (7.5227,12.887);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.887) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.108);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.108) rectangle (10.607,10.17);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.17) rectangle (10.607,11.755);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.755) rectangle (10.607,12.71);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.71) rectangle (10.607,12.887);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.887) rectangle (10.607,13.765);
...
\draw[black, dotted] (1.5,10.17) -- (13.4,10.17);
...
\node[text=black, centered, rotate=90] at (13.72, 11.44) {P Abandons};
