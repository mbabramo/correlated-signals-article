...
\draw[black, very thin] (13.35,5.6059) -- (13.45,5.6059);
\node[anchor=west] at (13.35, 5.6059) {};
\draw[black, very thin] (13.35,9.4854) -- (13.45,9.4854);
\node[anchor=west] at (13.35, 9.4854) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.6043);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.6043) rectangle (1.75,5.6059);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6059) rectangle (3.4213,6.8064);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8064) rectangle (1.75,9.4854);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4854) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5817) rectangle (6.578,5.5832);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5832) rectangle (5.6333,5.6059);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6059) rectangle (5.8513,8.2849);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2849) rectangle (5.6333,9.4854);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4854) rectangle (7.3047,9.8646);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8646) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5817) rectangle (10.062,5.5832);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5832) rectangle (10.062,5.6059);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6059) rectangle (10.062,8.2849);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2849) rectangle (10.062,9.4854);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4854) rectangle (10.062,9.8646);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8646) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6059) -- (13.4,5.6059);
\draw[black, dotted] (1.5,9.4854) -- (13.4,9.4854);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5457) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.831) {D Defaults};
