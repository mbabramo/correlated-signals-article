...
\draw[black, very thin] (13.35,6.5587) -- (13.45,6.5587);
\node[anchor=west] at (13.35, 6.5587) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,2.3235);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.3235) rectangle (1.75,6.5587);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5587) rectangle (2.622,12.191);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.191) rectangle (1.75,13.95);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.95) rectangle (3.93,14.057);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.057) rectangle (3.6393,14.09);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.09) rectangle (1.75,14.435);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.463) rectangle (4.9473,14.471);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.9852) rectangle (5.6333,6.5587);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5587) rectangle (7.0867,8.3172);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3172) rectangle (5.6333,13.95);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.95) rectangle (6.9413,14.052);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.052) rectangle (6.6507,14.295);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.295) rectangle (5.6333,14.435);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.463) rectangle (7.3773,14.474);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.474) rectangle (5.924,14.483);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.9852) rectangle (9.5167,6.5587);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.5587) rectangle (10.607,8.3172);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3172) rectangle (10.607,13.95);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.95) rectangle (11.697,14.295);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.295) rectangle (11.697,14.435);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.474) rectangle (13.877,14.483);
...
\draw[black, dotted] (1.5,6.5587) -- (13.4,6.5587);
...
\node[text=black, centered, rotate=90] at (13.72, 4.1543) {P Doesn't File};
\node[text=black, centered, rotate=90] at (13.72, 10.254) {D Doesn't Answer};
