...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.148);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.148) rectangle (1.75,10.161);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.161) rectangle (3.6393,11.119);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.119) rectangle (1.75,12.705);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.705) rectangle (2.186,13.586);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.586) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.106);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.106) rectangle (5.6333,10.161);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.161) rectangle (6.0693,11.746);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.746) rectangle (5.6333,12.705);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.705) rectangle (7.5227,12.883);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.883) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.106);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.106) rectangle (10.607,10.161);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.161) rectangle (10.607,11.746);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.746) rectangle (10.607,12.705);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.705) rectangle (10.607,12.883);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.883) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.433) {P Abandons};
