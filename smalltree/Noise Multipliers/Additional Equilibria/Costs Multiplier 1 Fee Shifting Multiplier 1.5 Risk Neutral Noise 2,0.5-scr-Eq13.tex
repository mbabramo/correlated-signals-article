...
\draw[black, very thin] (13.35,5.6003) -- (13.45,5.6003);
\node[anchor=west] at (13.35, 5.6003) {};
\draw[black, very thin] (13.35,9.4826) -- (13.45,9.4826);
\node[anchor=west] at (13.35, 9.4826) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.5991);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.5991) rectangle (1.75,5.6003);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6003) rectangle (3.4213,6.8034);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8034) rectangle (1.75,9.4826);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4826) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5829) rectangle (5.6333,5.6003);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6003) rectangle (5.8513,8.2795);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2795) rectangle (5.6333,9.4826);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4826) rectangle (7.3047,9.862);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.862) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5829) rectangle (10.062,5.6003);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6003) rectangle (10.062,8.2795);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2795) rectangle (10.062,9.4826);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4826) rectangle (10.062,9.862);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.862) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6003) -- (13.4,5.6003);
\draw[black, dotted] (1.5,9.4826) -- (13.4,9.4826);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5415) {P Abandons};
