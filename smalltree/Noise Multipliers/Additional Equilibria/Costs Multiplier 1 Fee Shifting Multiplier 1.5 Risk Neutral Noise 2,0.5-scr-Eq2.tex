...
\draw[black, very thin] (13.35,5.6437) -- (13.45,5.6437);
\node[anchor=west] at (13.35, 5.6437) {};
\draw[black, very thin] (13.35,9.5043) -- (13.45,9.5043);
\node[anchor=west] at (13.35, 9.5043) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.6397);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.6397) rectangle (1.75,5.6437);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6437) rectangle (3.4213,6.8265);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8265) rectangle (1.75,9.5043);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.5043) rectangle (1.968,11.799);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5817) rectangle (6.578,5.5857);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5857) rectangle (5.6333,5.6437);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6437) rectangle (5.8513,8.3215);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3215) rectangle (5.6333,9.5043);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.5043) rectangle (7.3047,9.8823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8823) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5817) rectangle (10.062,5.5857);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5857) rectangle (10.062,5.6437);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6437) rectangle (10.062,8.3215);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3215) rectangle (10.062,9.5043);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.5043) rectangle (10.062,9.8823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8823) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6437) -- (13.4,5.6437);
\draw[black, dotted] (1.5,9.5043) -- (13.4,9.5043);
...
\node[text=black, centered, rotate=90] at (13.72, 7.574) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.841) {D Defaults};
