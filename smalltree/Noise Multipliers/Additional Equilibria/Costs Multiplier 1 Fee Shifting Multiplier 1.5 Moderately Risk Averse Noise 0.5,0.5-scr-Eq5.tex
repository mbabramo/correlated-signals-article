...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.211) rectangle (2.9853,12.322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.322) rectangle (2.6947,12.768);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.768) rectangle (1.75,13.326);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.326) rectangle (3.4213,13.496);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.496) rectangle (1.75,13.883);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.883) rectangle (1.968,14.27);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.211) rectangle (6.578,12.657);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.657) rectangle (6.2873,12.768);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.768) rectangle (5.6333,13.326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.326) rectangle (5.8513,13.713);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.713) rectangle (5.6333,13.883);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.883) rectangle (7.3047,14.054);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.054) rectangle (5.8513,14.441);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.211) rectangle (10.062,12.657);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.657) rectangle (10.062,13.103);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.103) rectangle (10.062,13.214);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.214) rectangle (10.062,13.326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.326) rectangle (10.062,13.713);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.713) rectangle (10.062,13.883);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.883) rectangle (10.062,14.054);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.054) rectangle (10.062,14.441);
