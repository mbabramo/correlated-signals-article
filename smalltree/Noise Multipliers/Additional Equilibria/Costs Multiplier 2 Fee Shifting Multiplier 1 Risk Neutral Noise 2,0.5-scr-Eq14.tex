...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.152);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.152) rectangle (1.75,10.165);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.165) rectangle (3.6393,11.122);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.122) rectangle (1.75,12.707);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.707) rectangle (2.186,13.587);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.587) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.107);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.107) rectangle (5.6333,10.165);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.165) rectangle (6.0693,11.75);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.75) rectangle (5.6333,12.707);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.707) rectangle (7.5227,12.885);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.885) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.107);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.107) rectangle (10.607,10.165);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.165) rectangle (10.607,11.75);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.75) rectangle (10.607,12.707);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.707) rectangle (10.607,12.885);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.885) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.436) {P Abandons};
