...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.194);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.194) rectangle (1.75,10.216);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.216) rectangle (3.6393,11.152);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.152) rectangle (1.75,12.732);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.732) rectangle (2.186,13.591);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.591) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.116);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.116) rectangle (5.6333,10.216);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.216) rectangle (6.0693,11.796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.796) rectangle (5.6333,12.732);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.732) rectangle (7.5227,12.906);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.906) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.116);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.116) rectangle (10.607,10.216);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.216) rectangle (10.607,11.796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.796) rectangle (10.607,12.732);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.732) rectangle (10.607,12.906);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.906) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.474) {P Abandons};
