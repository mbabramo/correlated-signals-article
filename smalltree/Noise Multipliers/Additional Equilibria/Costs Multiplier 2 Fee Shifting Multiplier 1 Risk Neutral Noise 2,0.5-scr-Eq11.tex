...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.168);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.168) rectangle (1.75,10.184);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.184) rectangle (3.6393,11.133);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.133) rectangle (1.75,12.717);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.717) rectangle (2.186,13.589);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.11);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.11) rectangle (5.6333,10.184);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.184) rectangle (6.0693,11.767);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.767) rectangle (5.6333,12.717);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.717) rectangle (7.5227,12.893);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.893) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.11);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.11) rectangle (10.607,10.184);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.184) rectangle (10.607,11.767);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.767) rectangle (10.607,12.717);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.717) rectangle (10.607,12.893);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.893) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.45) {P Abandons};
