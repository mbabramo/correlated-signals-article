...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (3.4213,6.7935);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.7935) rectangle (1.75,9.4733);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4733) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.5817) rectangle (5.8513,8.2615);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2615) rectangle (5.6333,9.4733);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4733) rectangle (7.3047,9.8533);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8533) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.5817) rectangle (10.062,8.2615);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2615) rectangle (10.062,9.4733);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4733) rectangle (10.062,9.8533);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8533) rectangle (10.062,12.177);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5275) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.825) {D Defaults};
