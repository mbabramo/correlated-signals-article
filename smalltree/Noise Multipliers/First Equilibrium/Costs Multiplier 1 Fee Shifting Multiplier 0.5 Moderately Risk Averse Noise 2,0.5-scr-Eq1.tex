...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.6857) rectangle (3.276,7.109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.109) rectangle (2.9853,8.125);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.125) rectangle (2.6947,9.4416);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.4416) rectangle (1.75,11.046);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.046) rectangle (3.4213,11.413);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.413) rectangle (1.75,12.271);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.271) rectangle (1.968,13.631);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.6857) rectangle (6.578,6.8509);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8509) rectangle (6.2873,7);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7) rectangle (5.9967,8.2903);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2903) rectangle (5.6333,11.046);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.046) rectangle (5.8513,11.904);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.904) rectangle (5.6333,12.271);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.271) rectangle (7.3047,12.418);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.418) rectangle (5.8513,13.778);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.6857) rectangle (10.062,6.8509);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.8509) rectangle (10.062,8.1676);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.1676) rectangle (10.062,9.4578);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4578) rectangle (10.062,9.8812);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.8812) rectangle (10.062,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.03) rectangle (10.062,11.046);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.046) rectangle (10.062,11.904);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.904) rectangle (10.062,12.271);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.271) rectangle (10.062,12.418);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.418) rectangle (10.062,13.778);
