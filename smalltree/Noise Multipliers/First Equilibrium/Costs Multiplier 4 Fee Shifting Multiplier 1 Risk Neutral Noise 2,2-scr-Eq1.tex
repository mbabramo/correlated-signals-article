...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.879) rectangle (3.93,12.482);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.482) rectangle (1.75,13.491);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.491) rectangle (4.0753,13.646);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.646) rectangle (1.75,13.84);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.84) rectangle (2.622,13.94);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.94) rectangle (1.75,14.009);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.009) rectangle (6.6913,14.108);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.879) rectangle (6.6507,12.888);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.888) rectangle (5.6333,13.491);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.491) rectangle (6.5053,13.684);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.684) rectangle (5.6333,13.84);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.84) rectangle (7.9587,13.91);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.91) rectangle (6.5053,14.009);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.24) rectangle (10.575,14.325);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.325) rectangle (9.1213,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.879) rectangle (11.697,12.888);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.888) rectangle (11.697,13.491);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.491) rectangle (11.697,13.684);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.684) rectangle (11.697,13.84);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.84) rectangle (11.697,13.91);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.91) rectangle (11.697,14.009);
...
\node[text=black, centered, rotate=90] at (13.72, 12.685) {Settles};
