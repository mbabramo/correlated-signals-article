...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,2.1915);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.1915) rectangle (1.75,4.954);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.954) rectangle (2.186,9.3676);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.3676) rectangle (1.75,10.347);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.347) rectangle (3.494,10.485);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.833) rectangle (3.6393,11.905);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.072) rectangle (4.7293,13.294);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.954) rectangle (7.0867,5.933);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.933) rectangle (5.6333,10.347);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.347) rectangle (7.1593,10.557);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.557) rectangle (6.578,10.61);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.61) rectangle (5.9967,11.34);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.833) rectangle (5.8513,12.248);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.016) rectangle (8.8307,14.236);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.236) rectangle (7.3773,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.954) rectangle (10.062,5.933);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.933) rectangle (10.062,10.347);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.347) rectangle (10.334,10.4);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.4) rectangle (10.334,10.424);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.424) rectangle (10.334,11.364);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.364) rectangle (10.334,11.833);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.833) rectangle (10.334,12.248);
...
\node[text=black, centered, rotate=90] at (13.72, 3.352) {P Doesn't File};
\node[text=black, centered, rotate=90] at (13.72, 7.6503) {D Doesn't Answer};
\node[text=black, centered, rotate=90] at (13.72, 11.09) {Settles};
