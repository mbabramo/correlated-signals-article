...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.8987);
\draw[white, very thin, fill=red] (1.75,6.8987) rectangle (1.75,12.598);
\draw[white, very thin, fill=blue] (1.75,12.598) rectangle (3.5065,13.221);
\draw[white, very thin, fill=red] (1.75,13.221) rectangle (1.75,13.315);
\draw[white, very thin, fill=blue] (1.75,13.315) rectangle (6.1413,13.333);
\draw[white, very thin, fill=blue] (1.75,13.333) rectangle (5.5558,13.351);
\draw[white, very thin, fill=blue] (1.75,13.351) rectangle (4.9703,13.375);
\draw[white, very thin, fill=red] (1.75,13.375) rectangle (1.75,13.438);
\draw[white, very thin, fill=blue] (1.75,13.438) rectangle (6.4341,13.443);
\draw[white, very thin, fill=red] (1.75,13.443) rectangle (1.75,13.448);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,7.4498);
\draw[white, very thin, fill=blue] (9.3189,7.4498) rectangle (9.3189,12.598);
\draw[white, very thin, fill=red] (9.3189,12.598) rectangle (12.246,12.692);
\draw[white, very thin, fill=blue] (9.3189,12.692) rectangle (9.3189,13.315);
\draw[white, very thin, fill=red] (9.3189,13.315) rectangle (11.661,13.346);
\draw[white, very thin, fill=red] (9.3189,13.346) rectangle (11.075,13.363);
\draw[white, very thin, fill=red] (9.3189,13.363) rectangle (10.49,13.378);
\draw[white, very thin, fill=blue] (9.3189,13.378) rectangle (9.3189,13.438);
\draw[white, very thin, fill=red] (9.3189,13.438) rectangle (10.197,13.443);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,7.4498);
\draw[white, very thin, fill=blue] (16.888,7.4498) rectangle (16.888,12.598);
\draw[white, very thin, fill=red] (16.888,12.598) rectangle (19.083,12.692);
\draw[white, very thin, fill=blue] (16.888,12.692) rectangle (19.083,13.315);
\draw[white, very thin, fill=red] (16.888,13.315) rectangle (20.181,13.361);
\draw[white, very thin, fill=blue] (16.888,13.361) rectangle (20.181,13.403);
\draw[white, very thin, fill=red] (16.888,13.403) rectangle (20.181,13.42);
\draw[white, very thin, fill=blue] (16.888,13.42) rectangle (20.181,13.438);
\draw[white, very thin, fill=red] (16.888,13.438) rectangle (20.181,13.443);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.1742) {P Doesn't File};
