...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0357) rectangle (2.9853,10.25);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.25) rectangle (2.6947,11.464);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.464) rectangle (2.404,11.768);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0357) rectangle (6.8687,9.3393);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.3393) rectangle (6.578,10.554);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.554) rectangle (6.2873,11.768);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.0357) rectangle (10.062,10.554);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.554) rectangle (10.062,12.071);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.071) rectangle (10.062,13.286);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.286) rectangle (10.062,14.5);
