...
\draw[white, very thin, fill=blue] (1.75,13.017) rectangle (6.1413,13.136);
\draw[white, very thin, fill=red] (1.75,13.136) rectangle (1.75,13.331);
\draw[white, very thin, fill=blue] (1.75,13.331) rectangle (6.4341,13.353);
\draw[white, very thin, fill=red] (1.75,13.353) rectangle (1.75,13.38);
\draw[white, very thin, fill=blue] (1.75,13.38) rectangle (3.5065,13.398);
\draw[white, very thin, fill=red] (1.75,13.398) rectangle (1.75,13.41);
\draw[white, very thin, fill=blue] (1.75,13.41) rectangle (9.9471,13.428);
\draw[white, very thin, fill=red] (1.75,13.428) rectangle (1.75,13.452);
\draw[white, very thin, fill=blue] (1.75,13.452) rectangle (3.5065,13.484);
...
\draw[white, very thin, fill=red] (9.3189,13.017) rectangle (11.368,13.212);
\draw[white, very thin, fill=blue] (9.3189,13.212) rectangle (9.3189,13.331);
\draw[white, very thin, fill=red] (9.3189,13.331) rectangle (11.075,13.358);
\draw[white, very thin, fill=blue] (9.3189,13.358) rectangle (9.3189,13.38);
\draw[white, very thin, fill=red] (9.3189,13.38) rectangle (14.003,13.392);
\draw[white, very thin, fill=blue] (9.3189,13.392) rectangle (11.075,13.41);
\draw[white, very thin, fill=red] (9.3189,13.41) rectangle (11.075,13.434);
\draw[white, very thin, fill=blue] (9.3189,13.434) rectangle (9.3189,13.452);
\draw[white, very thin, fill=red] (9.3189,13.452) rectangle (17.516,13.468);
\draw[white, very thin, fill=blue] (9.3189,13.468) rectangle (14.588,13.5);
...
\draw[white, very thin, fill=red] (16.888,13.017) rectangle (21.279,13.212);
\draw[white, very thin, fill=blue] (16.888,13.212) rectangle (21.279,13.331);
\draw[white, very thin, fill=red] (16.888,13.331) rectangle (21.279,13.358);
\draw[white, very thin, fill=blue] (16.888,13.358) rectangle (21.279,13.38);
\draw[white, very thin, fill=red] (16.888,13.38) rectangle (21.279,13.392);
