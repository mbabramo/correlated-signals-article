...
\draw[white, very thin] (24.407,8.2477) -- (24.507,8.2477);
\node[anchor=west] at (24.407, 8.2477) {};
...
\draw[white, very thin, fill=blue] (1.75,3.9363) rectangle (2.1891,7.5665);
\draw[white, very thin, fill=red] (1.75,7.5665) rectangle (1.75,8.2477);
\draw[white, very thin, fill=blue] (1.75,8.2477) rectangle (4.8239,8.686);
\draw[white, very thin, fill=blue] (1.75,8.686) rectangle (3.6529,8.7038);
\draw[white, very thin, fill=blue] (1.75,8.7038) rectangle (2.4819,8.897);
\draw[white, very thin, fill=red] (1.75,8.897) rectangle (1.75,10.806);
\draw[white, very thin, fill=blue] (1.75,10.806) rectangle (6.8732,11.233);
\draw[white, very thin, fill=red] (1.75,11.233) rectangle (1.75,12.134);
...
\draw[white, very thin, fill=red] (9.3189,3.9363) rectangle (12.246,4.6175);
\draw[white, very thin, fill=blue] (9.3189,4.6175) rectangle (9.3189,8.2477);
\draw[white, very thin, fill=red] (9.3189,8.2477) rectangle (12.393,8.2895);
\draw[white, very thin, fill=red] (9.3189,8.2895) rectangle (11.222,8.3053);
\draw[white, very thin, fill=red] (9.3189,8.3053) rectangle (10.051,10.157);
\draw[white, very thin, fill=blue] (9.3189,10.157) rectangle (9.4652,10.35);
\draw[white, very thin, fill=blue] (9.3189,10.35) rectangle (9.3189,10.806);
...
\draw[white, very thin, fill=red] (9.3189,12.134) rectangle (14.442,12.561);
\draw[white, very thin, fill=blue] (9.3189,12.561) rectangle (11.515,13.5);
...
\draw[white, very thin, fill=red] (16.888,3.9363) rectangle (17.437,4.6175);
\draw[white, very thin, fill=blue] (16.888,4.6175) rectangle (17.437,8.2477);
\draw[white, very thin, fill=red] (16.888,8.2477) rectangle (17.986,8.3053);
\draw[white, very thin, fill=blue] (16.888,8.3053) rectangle (17.986,8.5162);
...
\draw[white, dotted] (1.5,8.2477) -- (24.457,8.2477);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.092) {D Doesn't Answer};
\node[text=yellow, centered, rotate=90] at (24.777, 9.527) {Settles};
