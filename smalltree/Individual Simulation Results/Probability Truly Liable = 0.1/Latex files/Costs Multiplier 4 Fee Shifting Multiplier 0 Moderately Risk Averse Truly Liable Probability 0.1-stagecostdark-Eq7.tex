...
\draw[white, very thin] (24.407,9.9128) -- (24.507,9.9128);
\node[anchor=west] at (24.407, 9.9128) {};
...
\draw[white, very thin, fill=red] (1.75,2.4775) rectangle (1.75,9.9128);
\draw[white, very thin, fill=blue] (1.75,9.9128) rectangle (3.5065,10.331);
\draw[white, very thin, fill=red] (1.75,10.331) rectangle (1.75,13.437);
\draw[white, very thin, fill=blue] (1.75,13.437) rectangle (5.5558,13.461);
\draw[white, very thin, fill=red] (1.75,13.461) rectangle (1.75,13.475);
\draw[white, very thin, fill=blue] (1.75,13.475) rectangle (6.4341,13.479);
\draw[white, very thin, fill=red] (1.75,13.479) rectangle (1.75,13.495);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,9.1853);
\draw[white, very thin, fill=blue] (9.3189,9.1853) rectangle (9.3189,9.9128);
\draw[white, very thin, fill=red] (9.3189,9.9128) rectangle (12.246,13.019);
\draw[white, very thin, fill=blue] (9.3189,13.019) rectangle (9.3189,13.437);
\draw[white, very thin, fill=red] (9.3189,13.437) rectangle (11.954,13.452);
\draw[white, very thin, fill=blue] (9.3189,13.452) rectangle (9.3189,13.475);
\draw[white, very thin, fill=red] (9.3189,13.475) rectangle (11.075,13.492);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,9.1853);
\draw[white, very thin, fill=blue] (16.888,9.1853) rectangle (16.888,9.9128);
\draw[white, very thin, fill=red] (16.888,9.9128) rectangle (19.083,13.019);
\draw[white, very thin, fill=blue] (16.888,13.019) rectangle (19.083,13.437);
\draw[white, very thin, fill=red] (16.888,13.437) rectangle (21.279,13.452);
\draw[white, very thin, fill=blue] (16.888,13.452) rectangle (21.279,13.475);
\draw[white, very thin, fill=red] (16.888,13.475) rectangle (21.279,13.492);
...
\draw[white, dotted] (1.5,9.9128) -- (24.457,9.9128);
...
\node[text=yellow, centered, rotate=90] at (24.777, 5.8314) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 11.675) {D Doesn't Answer};
