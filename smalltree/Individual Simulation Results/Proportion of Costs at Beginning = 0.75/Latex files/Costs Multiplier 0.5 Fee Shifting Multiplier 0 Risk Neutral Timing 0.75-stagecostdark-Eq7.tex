...
\draw[white, very thin] (24.407,5.7648) -- (24.507,5.7648);
\node[anchor=west] at (24.407, 5.7648) {};
...
\draw[white, very thin, fill=red] (1.75,5.5414) rectangle (1.75,5.7648);
\draw[white, very thin, fill=blue] (1.75,5.7648) rectangle (4.7141,5.7966);
\draw[white, very thin, fill=blue] (1.75,5.7966) rectangle (4.1286,5.7998);
\draw[white, very thin, fill=blue] (1.75,5.7998) rectangle (3.5431,5.8273);
\draw[white, very thin, fill=red] (1.75,5.8273) rectangle (1.75,6.1618);
\draw[white, very thin, fill=blue] (1.75,6.1618) rectangle (5.1167,7.1315);
\draw[white, very thin, fill=red] (1.75,7.1315) rectangle (1.75,9.8309);
\draw[white, very thin, fill=blue] (1.75,9.8309) rectangle (2.1891,12.53);
...
\draw[white, very thin, fill=red] (9.3189,3.5919) rectangle (12.246,3.8153);
\draw[white, very thin, fill=blue] (9.3189,3.8153) rectangle (9.3189,5.7648);
\draw[white, very thin, fill=red] (9.3189,5.7648) rectangle (11.112,5.7924);
\draw[white, very thin, fill=red] (9.3189,5.7924) rectangle (10.526,5.7995);
\draw[white, very thin, fill=red] (9.3189,5.7995) rectangle (9.941,6.0993);
\draw[white, very thin, fill=blue] (9.3189,6.0993) rectangle (9.3189,6.1618);
\draw[white, very thin, fill=red] (9.3189,6.1618) rectangle (9.758,8.8612);
\draw[white, very thin, fill=blue] (9.3189,8.8612) rectangle (9.3189,9.8309);
\draw[white, very thin, fill=red] (9.3189,9.8309) rectangle (12.686,10.801);
\draw[white, very thin, fill=blue] (9.3189,10.801) rectangle (9.758,13.5);
...
\draw[white, very thin, fill=red] (16.888,3.5919) rectangle (17.299,3.8153);
\draw[white, very thin, fill=blue] (16.888,3.8153) rectangle (17.299,5.7648);
\draw[white, very thin, fill=red] (16.888,5.7648) rectangle (17.711,5.7924);
\draw[white, very thin, fill=blue] (16.888,5.7924) rectangle (17.711,5.8199);
...
\draw[white, dotted] (1.5,5.7648) -- (24.457,5.7648);
...
\node[text=yellow, centered, rotate=90] at (24.777, 2.671) {No Suit};
\node[text=yellow, centered, rotate=90] at (24.777, 4.6784) {No Answer};
