...
\draw[white, very thin, fill=blue] (1.75,6.4319) rectangle (2.4087,8.321);
\draw[white, very thin, fill=red] (1.75,8.321) rectangle (1.75,8.5162);
\draw[white, very thin, fill=blue] (1.75,8.5162) rectangle (3.8725,10.27);
\draw[white, very thin, fill=red] (1.75,10.27) rectangle (1.75,11.072);
\draw[white, very thin, fill=blue] (1.75,11.072) rectangle (5.3362,11.453);
\draw[white, very thin, fill=red] (1.75,11.453) rectangle (1.75,12.286);
\draw[white, very thin, fill=blue] (1.75,12.286) rectangle (2.4087,13.265);
\draw[white, very thin, fill=red] (1.75,13.265) rectangle (1.75,13.398);
...
\draw[white, very thin, fill=red] (9.3189,8.5162) rectangle (11.441,9.3183);
\draw[white, very thin, fill=blue] (9.3189,9.3183) rectangle (9.3189,11.072);
\draw[white, very thin, fill=red] (9.3189,11.072) rectangle (9.9776,11.906);
\draw[white, very thin, fill=blue] (9.3189,11.906) rectangle (9.3189,12.286);
\draw[white, very thin, fill=red] (9.3189,12.286) rectangle (12.905,12.42);
\draw[white, very thin, fill=blue] (9.3189,12.42) rectangle (9.9776,13.398);
...
\draw[white, very thin, fill=red] (16.888,6.4319) rectangle (17.711,6.6272);
\draw[white, very thin, fill=blue] (16.888,6.6272) rectangle (17.711,8.5162);
\draw[white, very thin, fill=red] (16.888,8.5162) rectangle (18.534,9.3183);
\draw[white, very thin, fill=blue] (16.888,9.3183) rectangle (18.534,11.072);
\draw[white, very thin, fill=red] (16.888,11.072) rectangle (18.534,11.906);
\draw[white, very thin, fill=blue] (16.888,11.906) rectangle (18.534,12.286);
\draw[white, very thin, fill=red] (16.888,12.286) rectangle (18.534,12.42);
\draw[white, very thin, fill=blue] (16.888,12.42) rectangle (18.534,13.398);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.7942) {Settles};
