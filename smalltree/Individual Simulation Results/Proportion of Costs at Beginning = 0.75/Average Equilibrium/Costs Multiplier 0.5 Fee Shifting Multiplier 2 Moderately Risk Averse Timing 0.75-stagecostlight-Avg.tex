...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2215,2.2866);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2866) rectangle (2.9308,2.3852);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3852) rectangle (2.6402,2.6935);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.6935) rectangle (2.3495,3.045);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.045) rectangle (2.0588,6.6601);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.6601) rectangle (1.75,11.57);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.57) rectangle (3.3668,11.955);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.955) rectangle (1.75,12.796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.796) rectangle (1.9135,13.637);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.3852) rectangle (6.5235,2.6935);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.6935) rectangle (6.2328,2.9747);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.9747) rectangle (5.9422,6.6602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.6602) rectangle (5.6515,10.275);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.275) rectangle (5.6333,11.57);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.57) rectangle (5.7968,12.411);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.411) rectangle (5.6333,12.796);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.796) rectangle (7.2502,13.181);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.181) rectangle (5.7968,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.2247) rectangle (9.9254,2.533);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.533) rectangle (9.9254,2.8412);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.8412) rectangle (9.9254,6.8079);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.8079) rectangle (9.9254,7.4432);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.4432) rectangle (9.9254,7.9552);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.9552) rectangle (9.9254,11.57);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.57) rectangle (9.9254,12.411);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.411) rectangle (9.9254,12.796);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.796) rectangle (9.9254,13.181);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.181) rectangle (9.9254,14.022);
