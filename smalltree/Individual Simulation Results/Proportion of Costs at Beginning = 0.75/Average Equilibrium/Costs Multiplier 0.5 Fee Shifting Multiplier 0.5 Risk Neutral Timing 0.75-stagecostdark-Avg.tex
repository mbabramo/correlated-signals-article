...
\draw[white, very thin] (24.407,5.8369) -- (24.507,5.8369);
\node[anchor=west] at (24.407, 5.8369) {};
...
\draw[white, very thin, fill=blue] (1.75,3.6646) rectangle (2.0793,5.6138);
\draw[white, very thin, fill=red] (1.75,5.6138) rectangle (1.75,5.8369);
\draw[white, very thin, fill=blue] (1.75,5.8369) rectangle (4.7141,5.8448);
...
\draw[white, very thin, fill=blue] (1.75,6.0165) rectangle (5.3362,7.0023);
\draw[white, very thin, fill=red] (1.75,7.0023) rectangle (1.75,9.7986);
\draw[white, very thin, fill=blue] (1.75,9.7986) rectangle (1.9696,12.515);
\draw[white, very thin, fill=red] (1.75,12.515) rectangle (1.75,13.5);
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,3.4631);
\draw[white, very thin, fill=blue] (9.3189,3.4631) rectangle (9.3189,3.6646);
\draw[white, very thin, fill=red] (9.3189,3.6646) rectangle (12.246,3.8877);
\draw[white, very thin, fill=blue] (9.3189,3.8877) rectangle (9.3189,5.8369);
\draw[white, very thin, fill=red] (9.3189,5.8369) rectangle (11.112,5.8419);
\draw[white, very thin, fill=red] (9.3189,5.8419) rectangle (10.819,5.8421);
\draw[white, very thin, fill=red] (9.3189,5.8421) rectangle (10.526,5.8431);
\draw[white, very thin, fill=red] (9.3189,5.8431) rectangle (10.234,5.8442);
\draw[white, very thin, fill=red] (9.3189,5.8442) rectangle (9.941,5.9174);
\draw[white, very thin, fill=blue] (9.3189,5.9174) rectangle (9.3189,5.9312);
...
\draw[white, very thin, fill=red] (9.3189,6.0165) rectangle (9.5384,8.8128);
\draw[white, very thin, fill=blue] (9.3189,8.8128) rectangle (9.3189,9.7986);
\draw[white, very thin, fill=red] (9.3189,9.7986) rectangle (12.905,10.784);
\draw[white, very thin, fill=blue] (9.3189,10.784) rectangle (9.9776,13.5);
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,3.4631);
\draw[white, very thin, fill=blue] (16.888,3.4631) rectangle (16.888,3.6646);
\draw[white, very thin, fill=red] (16.888,3.6646) rectangle (17.299,3.8877);
\draw[white, very thin, fill=blue] (16.888,3.8877) rectangle (17.299,5.8369);
\draw[white, very thin, fill=red] (16.888,5.8369) rectangle (17.711,5.8419);
\draw[white, very thin, fill=blue] (16.888,5.8419) rectangle (17.711,5.8468);
\draw[white, very thin, fill=red] (16.888,5.8468) rectangle (17.711,5.9221);
\draw[white, very thin, fill=blue] (16.888,5.9221) rectangle (17.711,5.9309);
...
\draw[white, dotted] (1.5,5.8369) -- (24.457,5.8369);
...
\node[text=yellow, centered, rotate=90] at (24.777, 4.7507) {No Answer};
