...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.14);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.14) rectangle (1.75,10.15);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.15) rectangle (3.6393,11.113);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.113) rectangle (1.75,12.699);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.699) rectangle (2.186,13.586);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.104);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.104) rectangle (5.6333,10.15);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.15) rectangle (6.0693,11.736);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.736) rectangle (5.6333,12.699);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.699) rectangle (7.5227,12.879);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.879) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.104);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.104) rectangle (10.607,10.15);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.15) rectangle (10.607,11.736);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.736) rectangle (10.607,12.699);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.699) rectangle (10.607,12.879);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.879) rectangle (10.607,13.765);
