...
\draw[white, very thin] (24.407,5.2983) -- (24.507,5.2983);
\node[anchor=west] at (24.407, 5.2983) {};
\draw[white, very thin] (24.407,8.8762) -- (24.507,8.8762);
\node[anchor=west] at (24.407, 8.8762) {};
...
\draw[white, very thin, fill=blue] (1.75,5.2812) rectangle (3.6529,5.2972);
\draw[white, very thin, fill=red] (1.75,5.2972) rectangle (1.75,5.2983);
\draw[white, very thin, fill=blue] (1.75,5.2983) rectangle (5.1167,6.4071);
\draw[white, very thin, fill=red] (1.75,6.4071) rectangle (1.75,8.8762);
\draw[white, very thin, fill=blue] (1.75,8.8762) rectangle (2.1891,11.01);
\draw[white, very thin, fill=red] (1.75,11.01) rectangle (1.75,11.36);
...
\draw[white, very thin, fill=red] (9.3189,5.2812) rectangle (11.222,5.2823);
\draw[white, very thin, fill=blue] (9.3189,5.2823) rectangle (9.3189,5.2983);
\draw[white, very thin, fill=red] (9.3189,5.2983) rectangle (9.758,7.7674);
\draw[white, very thin, fill=blue] (9.3189,7.7674) rectangle (9.3189,8.8762);
\draw[white, very thin, fill=red] (9.3189,8.8762) rectangle (12.686,9.2257);
\draw[white, very thin, fill=blue] (9.3189,9.2257) rectangle (9.758,11.36);
...
\draw[white, very thin, fill=red] (16.888,5.2812) rectangle (17.986,5.2823);
\draw[white, very thin, fill=blue] (16.888,5.2823) rectangle (17.986,5.2983);
\draw[white, very thin, fill=red] (16.888,5.2983) rectangle (17.986,7.7674);
\draw[white, very thin, fill=blue] (16.888,7.7674) rectangle (17.986,8.8762);
\draw[white, very thin, fill=red] (16.888,8.8762) rectangle (17.986,9.2257);
\draw[white, very thin, fill=blue] (16.888,9.2257) rectangle (17.986,11.36);
...
\draw[white, dotted] (1.5,5.2983) -- (24.457,5.2983);
\draw[white, dotted] (1.5,8.8762) -- (24.457,8.8762);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0872) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 10.118) {D Defaults};
