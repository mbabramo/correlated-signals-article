...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.3586);
\draw[white, very thin, fill=red] (1.75,6.3586) rectangle (1.75,11.077);
\draw[white, very thin, fill=blue] (1.75,11.077) rectangle (3.5065,12.293);
\draw[white, very thin, fill=red] (1.75,12.293) rectangle (1.75,13.36);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,6.4683);
\draw[white, very thin, fill=blue] (9.3189,6.4683) rectangle (9.3189,11.077);
\draw[white, very thin, fill=red] (9.3189,11.077) rectangle (12.246,12.145);
\draw[white, very thin, fill=blue] (9.3189,12.145) rectangle (9.3189,13.36);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,6.4683);
\draw[white, very thin, fill=blue] (16.888,6.4683) rectangle (16.888,11.077);
\draw[white, very thin, fill=red] (16.888,11.077) rectangle (19.083,12.145);
\draw[white, very thin, fill=blue] (16.888,12.145) rectangle (19.083,13.36);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.4134) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 12.219) {No Answer};
