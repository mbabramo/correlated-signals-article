...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.4023);
\draw[white, very thin, fill=red] (1.75,6.4023) rectangle (1.75,11.16);
\draw[white, very thin, fill=blue] (1.75,11.16) rectangle (3.5065,12.334);
\draw[white, very thin, fill=red] (1.75,12.334) rectangle (1.75,13.365);
\draw[white, very thin, fill=blue] (1.75,13.365) rectangle (5.5558,13.408);
\draw[white, very thin, fill=red] (1.75,13.408) rectangle (1.75,13.485);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,6.5082);
\draw[white, very thin, fill=blue] (9.3189,6.5082) rectangle (9.3189,11.16);
\draw[white, very thin, fill=red] (9.3189,11.16) rectangle (12.246,12.191);
\draw[white, very thin, fill=blue] (9.3189,12.191) rectangle (9.3189,13.365);
\draw[white, very thin, fill=red] (9.3189,13.365) rectangle (11.954,13.442);
\draw[white, very thin, fill=blue] (9.3189,13.442) rectangle (9.3189,13.485);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,6.5082);
\draw[white, very thin, fill=blue] (16.888,6.5082) rectangle (16.888,11.16);
\draw[white, very thin, fill=red] (16.888,11.16) rectangle (19.083,12.191);
\draw[white, very thin, fill=blue] (16.888,12.191) rectangle (19.083,13.365);
\draw[white, very thin, fill=red] (16.888,13.365) rectangle (21.279,13.442);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.4552) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 12.263) {No Answer};
