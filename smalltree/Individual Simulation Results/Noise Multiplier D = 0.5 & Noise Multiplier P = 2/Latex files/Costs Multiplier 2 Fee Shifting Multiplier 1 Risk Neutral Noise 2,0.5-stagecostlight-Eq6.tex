...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.227);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.227) rectangle (1.75,10.256);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.256) rectangle (3.6393,11.176);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.176) rectangle (1.75,12.753);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.753) rectangle (2.186,13.595);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.595) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.123);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.123) rectangle (5.6333,10.256);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.256) rectangle (6.0693,11.833);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.833) rectangle (5.6333,12.753);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.753) rectangle (7.5227,12.923);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.923) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.123);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.123) rectangle (10.607,10.256);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.256) rectangle (10.607,11.833);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.833) rectangle (10.607,12.753);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.753) rectangle (10.607,12.923);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.923) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.505) {P Abandons};
