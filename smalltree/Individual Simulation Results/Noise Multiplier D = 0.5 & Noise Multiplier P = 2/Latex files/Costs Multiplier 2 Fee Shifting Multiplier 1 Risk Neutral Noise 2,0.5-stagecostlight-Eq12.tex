...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.162);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.162) rectangle (1.75,10.177);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.177) rectangle (3.6393,11.129);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.129) rectangle (1.75,12.713);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.713) rectangle (2.186,13.588);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.588) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.109) rectangle (5.6333,10.177);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.177) rectangle (6.0693,11.761);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.761) rectangle (5.6333,12.713);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.713) rectangle (7.5227,12.89);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.89) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.109) rectangle (10.607,10.177);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.177) rectangle (10.607,11.761);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.761) rectangle (10.607,12.713);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.713) rectangle (10.607,12.89);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.89) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.445) {P Abandons};
