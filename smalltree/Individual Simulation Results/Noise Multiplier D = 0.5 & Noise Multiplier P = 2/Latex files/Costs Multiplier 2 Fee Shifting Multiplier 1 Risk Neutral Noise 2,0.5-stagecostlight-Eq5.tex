...
\draw[black, very thin] (13.35,10.289) -- (13.45,10.289);
\node[anchor=west] at (13.35, 10.289) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.254);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.254) rectangle (1.75,10.289);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.289) rectangle (3.6393,11.195);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.195) rectangle (1.75,12.769);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.769) rectangle (2.186,13.598);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.598) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.129);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.129) rectangle (5.6333,10.289);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.289) rectangle (6.0693,11.863);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.863) rectangle (5.6333,12.769);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.769) rectangle (7.5227,12.936);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.936) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.129);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.129) rectangle (10.607,10.289);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.289) rectangle (10.607,11.863);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.863) rectangle (10.607,12.769);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.769) rectangle (10.607,12.936);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.936) rectangle (10.607,13.765);
...
\draw[black, dotted] (1.5,10.289) -- (13.4,10.289);
...
\node[text=black, centered, rotate=90] at (13.72, 11.529) {P Abandons};
