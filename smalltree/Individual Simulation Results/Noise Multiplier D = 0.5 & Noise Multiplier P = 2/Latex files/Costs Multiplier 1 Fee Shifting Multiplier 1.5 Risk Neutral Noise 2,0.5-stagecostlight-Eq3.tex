...
\draw[black, very thin] (13.35,5.623) -- (13.45,5.623);
\node[anchor=west] at (13.35, 5.623) {};
\draw[black, very thin] (13.35,9.494) -- (13.45,9.494);
\node[anchor=west] at (13.35, 9.494) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.6204);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.6204) rectangle (1.75,5.623);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.623) rectangle (3.4213,6.8155);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8155) rectangle (1.75,9.494);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.494) rectangle (1.968,11.799);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5843) rectangle (5.6333,5.623);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.623) rectangle (5.8513,8.3015);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3015) rectangle (5.6333,9.494);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.494) rectangle (7.3047,9.8726);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8726) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5843) rectangle (10.062,5.623);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.623) rectangle (10.062,8.3015);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3015) rectangle (10.062,9.494);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.494) rectangle (10.062,9.8726);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8726) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.623) -- (13.4,5.623);
\draw[black, dotted] (1.5,9.494) -- (13.4,9.494);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5585) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 10.836) {D Defaults};
