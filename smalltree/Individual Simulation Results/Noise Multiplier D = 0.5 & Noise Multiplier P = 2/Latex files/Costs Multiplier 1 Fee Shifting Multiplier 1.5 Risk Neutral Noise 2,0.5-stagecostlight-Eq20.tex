...
\draw[black, very thin] (13.35,9.4827) -- (13.45,9.4827);
\node[anchor=west] at (13.35, 9.4827) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.5992);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.5992) rectangle (1.75,5.6004);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6004) rectangle (3.4213,6.8035);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8035) rectangle (1.75,9.4827);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4827) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5829) rectangle (5.6333,5.6004);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6004) rectangle (5.8513,8.2796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2796) rectangle (5.6333,9.4827);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4827) rectangle (7.3047,9.862);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5829) rectangle (10.062,5.6004);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6004) rectangle (10.062,8.2796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2796) rectangle (10.062,9.4827);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4827) rectangle (10.062,9.862);
...
\draw[black, dotted] (1.5,9.4827) -- (13.4,9.4827);
