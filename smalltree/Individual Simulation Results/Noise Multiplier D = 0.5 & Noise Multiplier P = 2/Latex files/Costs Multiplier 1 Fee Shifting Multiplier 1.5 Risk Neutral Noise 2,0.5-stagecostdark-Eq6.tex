...
\draw[white, very thin] (24.407,8.8831) -- (24.507,8.8831);
\node[anchor=west] at (24.407, 8.8831) {};
...
\draw[white, very thin, fill=blue] (1.75,5.2812) rectangle (3.6529,5.3102);
\draw[white, very thin, fill=red] (1.75,5.3102) rectangle (1.75,5.3122);
\draw[white, very thin, fill=blue] (1.75,5.3122) rectangle (5.1167,6.4145);
\draw[white, very thin, fill=red] (1.75,6.4145) rectangle (1.75,8.8831);
\draw[white, very thin, fill=blue] (1.75,8.8831) rectangle (2.1891,11.01);
...
\draw[white, very thin, fill=red] (9.3189,5.2812) rectangle (11.222,5.2832);
\draw[white, very thin, fill=blue] (9.3189,5.2832) rectangle (9.3189,5.3122);
\draw[white, very thin, fill=red] (9.3189,5.3122) rectangle (9.758,7.7808);
\draw[white, very thin, fill=blue] (9.3189,7.7808) rectangle (9.3189,8.8831);
\draw[white, very thin, fill=red] (9.3189,8.8831) rectangle (12.686,9.2322);
\draw[white, very thin, fill=blue] (9.3189,9.2322) rectangle (9.758,11.36);
...
\draw[white, very thin, fill=red] (16.888,5.2812) rectangle (17.986,5.2832);
\draw[white, very thin, fill=blue] (16.888,5.2832) rectangle (17.986,5.3122);
\draw[white, very thin, fill=red] (16.888,5.3122) rectangle (17.986,7.7808);
\draw[white, very thin, fill=blue] (16.888,7.7808) rectangle (17.986,8.8831);
\draw[white, very thin, fill=red] (16.888,8.8831) rectangle (17.986,9.2322);
\draw[white, very thin, fill=blue] (16.888,9.2322) rectangle (17.986,11.36);
...
\draw[white, dotted] (1.5,8.8831) -- (24.457,8.8831);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0977) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 10.121) {D Defaults};
