...
\draw[black, very thin] (13.35,5.6119) -- (13.45,5.6119);
\node[anchor=west] at (13.35, 5.6119) {};
\draw[black, very thin] (13.35,9.4885) -- (13.45,9.4885);
\node[anchor=west] at (13.35, 9.4885) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.61);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.61) rectangle (1.75,5.6119);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6119) rectangle (3.4213,6.8096);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8096) rectangle (1.75,9.4885);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4885) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.5836) rectangle (5.6333,5.6119);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6119) rectangle (5.8513,8.2908);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.2908) rectangle (5.6333,9.4885);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4885) rectangle (7.3047,9.8674);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8674) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.5836) rectangle (10.062,5.6119);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6119) rectangle (10.062,8.2908);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.2908) rectangle (10.062,9.4885);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4885) rectangle (10.062,9.8674);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8674) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6119) -- (13.4,5.6119);
\draw[black, dotted] (1.5,9.4885) -- (13.4,9.4885);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5502) {P Abandons};
