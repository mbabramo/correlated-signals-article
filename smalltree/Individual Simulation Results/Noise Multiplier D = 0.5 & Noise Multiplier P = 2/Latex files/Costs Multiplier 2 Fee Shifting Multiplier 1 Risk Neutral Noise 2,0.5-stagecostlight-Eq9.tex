...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.184);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.184) rectangle (1.75,10.204);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.204) rectangle (3.6393,11.145);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.145) rectangle (1.75,12.727);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.727) rectangle (2.186,13.59);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.59) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.114);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.114) rectangle (5.6333,10.204);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.204) rectangle (6.0693,11.786);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.786) rectangle (5.6333,12.727);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.727) rectangle (7.5227,12.901);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.901) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.114);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.114) rectangle (10.607,10.204);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.204) rectangle (10.607,11.786);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.786) rectangle (10.607,12.727);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.727) rectangle (10.607,12.901);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.901) rectangle (10.607,13.765);
...
\node[text=black, centered, rotate=90] at (13.72, 11.465) {P Abandons};
