...
\draw[black, very thin] (13.35,5.6019) -- (13.45,5.6019);
\node[anchor=west] at (13.35, 5.6019) {};
\draw[black, very thin] (13.35,9.4834) -- (13.45,9.4834);
\node[anchor=west] at (13.35, 9.4834) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.5817) rectangle (2.6947,5.6006);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.6006) rectangle (1.75,5.6019);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.6019) rectangle (3.4213,6.8043);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8043) rectangle (1.75,9.4834);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4834) rectangle (1.968,11.798);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.583) rectangle (5.6333,5.6019);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.6019) rectangle (5.8513,8.281);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.281) rectangle (5.6333,9.4834);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4834) rectangle (7.3047,9.8627);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8627) rectangle (5.8513,12.177);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.583) rectangle (10.062,5.6019);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.6019) rectangle (10.062,8.281);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.281) rectangle (10.062,9.4834);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4834) rectangle (10.062,9.8627);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8627) rectangle (10.062,12.177);
...
\draw[black, dotted] (1.5,5.6019) -- (13.4,5.6019);
\draw[black, dotted] (1.5,9.4834) -- (13.4,9.4834);
...
\node[text=black, centered, rotate=90] at (13.72, 7.5426) {P Abandons};
