...
\draw[black, very thin] (13.35,10.193) -- (13.45,10.193);
\node[anchor=west] at (13.35, 10.193) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.094) rectangle (2.9127,10.175);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.175) rectangle (1.75,10.193);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.193) rectangle (3.6393,11.139);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.139) rectangle (1.75,12.721);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.721) rectangle (2.186,13.589);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.589) rectangle (1.75,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.094) rectangle (6.796,10.112);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.112) rectangle (5.6333,10.193);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.193) rectangle (6.0693,11.776);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.776) rectangle (5.6333,12.721);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.721) rectangle (7.5227,12.897);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.897) rectangle (6.0693,13.765);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.094) rectangle (10.607,10.112);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.112) rectangle (10.607,10.193);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.193) rectangle (10.607,11.776);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.776) rectangle (10.607,12.721);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.721) rectangle (10.607,12.897);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.897) rectangle (10.607,13.765);
...
\draw[black, dotted] (1.5,10.193) -- (13.4,10.193);
...
\node[text=black, centered, rotate=90] at (13.72, 11.457) {P Abandons};
