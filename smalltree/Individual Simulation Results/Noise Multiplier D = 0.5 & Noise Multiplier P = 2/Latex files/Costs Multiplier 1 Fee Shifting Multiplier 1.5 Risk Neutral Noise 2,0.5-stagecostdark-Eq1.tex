...
\draw[white, very thin, fill=blue] (1.75,5.2812) rectangle (5.1167,6.398);
\draw[white, very thin, fill=red] (1.75,6.398) rectangle (1.75,8.8676);
\draw[white, very thin, fill=blue] (1.75,8.8676) rectangle (2.1891,11.009);
\draw[white, very thin, fill=red] (1.75,11.009) rectangle (1.75,11.36);
...
\draw[white, very thin, fill=red] (9.3189,5.2812) rectangle (9.758,7.7508);
\draw[white, very thin, fill=blue] (9.3189,7.7508) rectangle (9.3189,8.8676);
\draw[white, very thin, fill=red] (9.3189,8.8676) rectangle (12.686,9.2177);
\draw[white, very thin, fill=blue] (9.3189,9.2177) rectangle (9.758,11.36);
...
\draw[white, very thin, fill=red] (16.888,5.2812) rectangle (17.986,7.7508);
\draw[white, very thin, fill=blue] (16.888,7.7508) rectangle (17.986,8.8676);
\draw[white, very thin, fill=red] (16.888,8.8676) rectangle (17.986,9.2177);
\draw[white, very thin, fill=blue] (16.888,9.2177) rectangle (17.986,11.36);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0744) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 10.114) {D Defaults};
