...
\draw[white, very thin] (24.407,6.7531) -- (24.507,6.7531);
\node[anchor=west] at (24.407, 6.7531) {};
\draw[white, very thin] (24.407,10.005) -- (24.507,10.005);
\node[anchor=west] at (24.407, 10.005) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.658);
\draw[white, very thin, fill=red] (1.75,6.658) rectangle (1.75,6.7531);
\draw[white, very thin, fill=blue] (1.75,6.7531) rectangle (5.1167,7.6427);
\draw[white, very thin, fill=red] (1.75,7.6427) rectangle (1.75,10.005);
\draw[white, very thin, fill=blue] (1.75,10.005) rectangle (2.1891,12.069);
\draw[white, very thin, fill=red] (1.75,12.069) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5733);
\draw[white, very thin, fill=blue] (9.3189,6.5733) rectangle (9.3189,6.7531);
\draw[white, very thin, fill=red] (9.3189,6.7531) rectangle (9.758,9.1156);
\draw[white, very thin, fill=blue] (9.3189,9.1156) rectangle (9.3189,10.005);
\draw[white, very thin, fill=red] (9.3189,10.005) rectangle (12.686,10.64);
\draw[white, very thin, fill=blue] (9.3189,10.64) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5733);
\draw[white, very thin, fill=blue] (16.888,6.5733) rectangle (17.986,6.7531);
\draw[white, very thin, fill=red] (16.888,6.7531) rectangle (17.986,9.1156);
\draw[white, very thin, fill=blue] (16.888,9.1156) rectangle (17.986,10.005);
\draw[white, very thin, fill=red] (16.888,10.005) rectangle (17.986,10.64);
\draw[white, very thin, fill=blue] (16.888,10.64) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.7531) -- (24.457,6.7531);
\draw[white, dotted] (1.5,10.005) -- (24.457,10.005);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3792) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.354) {D Defaults};
