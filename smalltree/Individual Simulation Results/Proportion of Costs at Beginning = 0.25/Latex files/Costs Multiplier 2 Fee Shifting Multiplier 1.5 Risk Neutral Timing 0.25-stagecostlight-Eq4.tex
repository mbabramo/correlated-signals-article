...
\draw[black, very thin] (13.35,7.1789) -- (13.45,7.1789);
\node[anchor=west] at (13.35, 7.1789) {};
\draw[black, very thin] (13.35,10.708) -- (13.45,10.708);
\node[anchor=west] at (13.35, 10.708) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,7.0757);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0757) rectangle (1.75,7.1789);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.1789) rectangle (3.4213,8.1442);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.1442) rectangle (1.75,10.708);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.708) rectangle (1.968,12.947);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.947) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9838);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9838) rectangle (5.6333,7.1789);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.1789) rectangle (5.8513,9.7425);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.7425) rectangle (5.6333,10.708);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.708) rectangle (7.3047,11.396);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.396) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9838);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9838) rectangle (10.062,7.1789);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.1789) rectangle (10.062,9.7425);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.7425) rectangle (10.062,10.708);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.708) rectangle (10.062,11.396);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.396) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.1789) -- (13.4,7.1789);
\draw[black, dotted] (1.5,10.708) -- (13.4,10.708);
...
\node[text=black, centered, rotate=90] at (13.72, 8.9434) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.172) {D Defaults};
