...
\draw[white, very thin] (24.407,6.8784) -- (24.507,6.8784);
\node[anchor=west] at (24.407, 6.8784) {};
\draw[white, very thin] (24.407,9.9688) -- (24.507,9.9688);
\node[anchor=west] at (24.407, 9.9688) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.4987);
\draw[white, very thin, fill=red] (1.75,6.4987) rectangle (1.75,6.8784);
\draw[white, very thin, fill=blue] (1.75,6.8784) rectangle (5.1167,7.6247);
\draw[white, very thin, fill=red] (1.75,7.6247) rectangle (1.75,9.9688);
\draw[white, very thin, fill=blue] (1.75,9.9688) rectangle (2.1891,12.307);
\draw[white, very thin, fill=red] (1.75,12.307) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.4864);
\draw[white, very thin, fill=blue] (9.3189,6.4864) rectangle (9.3189,6.8784);
\draw[white, very thin, fill=red] (9.3189,6.8784) rectangle (9.758,9.2225);
\draw[white, very thin, fill=blue] (9.3189,9.2225) rectangle (9.3189,9.9688);
\draw[white, very thin, fill=red] (9.3189,9.9688) rectangle (12.686,10.721);
\draw[white, very thin, fill=blue] (9.3189,10.721) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.4864);
\draw[white, very thin, fill=blue] (16.888,6.4864) rectangle (17.986,6.8784);
\draw[white, very thin, fill=red] (16.888,6.8784) rectangle (17.986,9.2225);
\draw[white, very thin, fill=blue] (16.888,9.2225) rectangle (17.986,9.9688);
\draw[white, very thin, fill=red] (16.888,9.9688) rectangle (17.986,10.721);
\draw[white, very thin, fill=blue] (16.888,10.721) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,6.8784) -- (24.457,6.8784);
\draw[white, dotted] (1.5,9.9688) -- (24.457,9.9688);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.4236) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.514) {D Defaults};
