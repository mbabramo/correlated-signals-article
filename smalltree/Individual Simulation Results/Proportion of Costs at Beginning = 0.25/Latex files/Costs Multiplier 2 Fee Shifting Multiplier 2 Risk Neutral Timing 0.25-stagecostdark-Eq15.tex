...
\draw[white, very thin] (24.407,6.8028) -- (24.507,6.8028);
\node[anchor=west] at (24.407, 6.8028) {};
\draw[white, very thin] (24.407,9.931) -- (24.507,9.931);
\node[anchor=west] at (24.407, 9.931) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.4619);
\draw[white, very thin, fill=red] (1.75,6.4619) rectangle (1.75,6.8028);
\draw[white, very thin, fill=blue] (1.75,6.8028) rectangle (5.1167,7.5676);
\draw[white, very thin, fill=red] (1.75,7.5676) rectangle (1.75,9.931);
\draw[white, very thin, fill=blue] (1.75,9.931) rectangle (2.1891,12.287);
\draw[white, very thin, fill=red] (1.75,12.287) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.4476);
\draw[white, very thin, fill=blue] (9.3189,6.4476) rectangle (9.3189,6.8028);
\draw[white, very thin, fill=red] (9.3189,6.8028) rectangle (9.758,9.1663);
\draw[white, very thin, fill=blue] (9.3189,9.1663) rectangle (9.3189,9.931);
\draw[white, very thin, fill=red] (9.3189,9.931) rectangle (12.686,10.703);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.4476);
\draw[white, very thin, fill=blue] (16.888,6.4476) rectangle (17.986,6.8028);
\draw[white, very thin, fill=red] (16.888,6.8028) rectangle (17.986,9.1663);
\draw[white, very thin, fill=blue] (16.888,9.1663) rectangle (17.986,9.931);
\draw[white, very thin, fill=red] (16.888,9.931) rectangle (17.986,10.703);
...
\draw[white, dotted] (1.5,6.8028) -- (24.457,6.8028);
\draw[white, dotted] (1.5,9.931) -- (24.457,9.931);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3669) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.495) {D Defaults};
