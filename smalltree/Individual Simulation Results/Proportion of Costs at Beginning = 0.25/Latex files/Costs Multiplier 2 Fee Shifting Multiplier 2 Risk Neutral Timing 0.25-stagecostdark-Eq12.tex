...
\draw[white, very thin] (24.407,6.8462) -- (24.507,6.8462);
\node[anchor=west] at (24.407, 6.8462) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.4854);
\draw[white, very thin, fill=red] (1.75,6.4854) rectangle (1.75,6.8462);
\draw[white, very thin, fill=blue] (1.75,6.8462) rectangle (5.1167,7.5992);
\draw[white, very thin, fill=red] (1.75,7.5992) rectangle (1.75,9.9526);
\draw[white, very thin, fill=blue] (1.75,9.9526) rectangle (2.1891,12.297);
\draw[white, very thin, fill=red] (1.75,12.297) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.4675);
\draw[white, very thin, fill=blue] (9.3189,6.4675) rectangle (9.3189,6.8462);
\draw[white, very thin, fill=red] (9.3189,6.8462) rectangle (9.758,9.1997);
\draw[white, very thin, fill=blue] (9.3189,9.1997) rectangle (9.3189,9.9526);
\draw[white, very thin, fill=red] (9.3189,9.9526) rectangle (12.686,10.715);
\draw[white, very thin, fill=blue] (9.3189,10.715) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.4675);
\draw[white, very thin, fill=blue] (16.888,6.4675) rectangle (17.986,6.8462);
\draw[white, very thin, fill=red] (16.888,6.8462) rectangle (17.986,9.1997);
\draw[white, very thin, fill=blue] (16.888,9.1997) rectangle (17.986,9.9526);
\draw[white, very thin, fill=red] (16.888,9.9526) rectangle (17.986,10.715);
\draw[white, very thin, fill=blue] (16.888,10.715) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,6.8462) -- (24.457,6.8462);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3994) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.506) {D Defaults};
