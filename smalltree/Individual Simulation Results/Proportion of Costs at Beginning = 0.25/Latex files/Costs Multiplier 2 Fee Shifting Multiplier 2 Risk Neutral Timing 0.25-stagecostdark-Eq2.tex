...
\draw[white, very thin] (24.407,8.0334) -- (24.507,8.0334);
\node[anchor=west] at (24.407, 8.0334) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,7.0694);
\draw[white, very thin, fill=red] (1.75,7.0694) rectangle (1.75,8.0334);
\draw[white, very thin, fill=blue] (1.75,8.0334) rectangle (5.1167,8.4944);
\draw[white, very thin, fill=red] (1.75,8.4944) rectangle (1.75,10.546);
\draw[white, very thin, fill=blue] (1.75,10.546) rectangle (2.1891,12.599);
\draw[white, very thin, fill=red] (1.75,12.599) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,7.0707);
\draw[white, very thin, fill=blue] (9.3189,7.0707) rectangle (9.3189,8.0334);
\draw[white, very thin, fill=red] (9.3189,8.0334) rectangle (9.758,10.085);
\draw[white, very thin, fill=blue] (9.3189,10.085) rectangle (9.3189,10.546);
\draw[white, very thin, fill=red] (9.3189,10.546) rectangle (12.686,11.007);
\draw[white, very thin, fill=blue] (9.3189,11.007) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,7.0707);
\draw[white, very thin, fill=blue] (16.888,7.0707) rectangle (17.986,8.0334);
\draw[white, very thin, fill=red] (16.888,8.0334) rectangle (17.986,10.085);
\draw[white, very thin, fill=blue] (16.888,10.085) rectangle (17.986,10.546);
\draw[white, very thin, fill=red] (16.888,10.546) rectangle (17.986,11.007);
\draw[white, very thin, fill=blue] (16.888,11.007) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,8.0334) -- (24.457,8.0334);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0701) {Settles};
\node[text=yellow, centered, rotate=90] at (24.777, 9.2898) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.803) {D Defaults};
