...
\draw[black, very thin] (13.35,7.0131) -- (13.45,7.0131);
\node[anchor=west] at (13.35, 7.0131) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,6.9672);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.9672) rectangle (1.75,7.0131);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0131) rectangle (3.4213,8.0326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0326) rectangle (1.75,10.625);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.625) rectangle (1.968,12.918);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.918) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9264);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9264) rectangle (5.6333,7.0131);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0131) rectangle (5.8513,9.6054);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6054) rectangle (5.6333,10.625);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.625) rectangle (7.3047,11.342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.342) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9264);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9264) rectangle (10.062,7.0131);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0131) rectangle (10.062,9.6054);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6054) rectangle (10.062,10.625);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.625) rectangle (10.062,11.342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.342) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.0131) -- (13.4,7.0131);
...
\node[text=black, centered, rotate=90] at (13.72, 8.819) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.13) {D Defaults};
