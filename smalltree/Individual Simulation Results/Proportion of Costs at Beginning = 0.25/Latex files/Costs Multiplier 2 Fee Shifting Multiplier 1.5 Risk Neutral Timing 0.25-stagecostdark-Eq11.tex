...
\draw[white, very thin] (24.407,6.631) -- (24.507,6.631);
\node[anchor=west] at (24.407, 6.631) {};
\draw[white, very thin] (24.407,9.9442) -- (24.507,9.9442);
\node[anchor=west] at (24.407, 9.9442) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.5767);
\draw[white, very thin, fill=red] (1.75,6.5767) rectangle (1.75,6.631);
\draw[white, very thin, fill=blue] (1.75,6.631) rectangle (5.1167,7.5612);
\draw[white, very thin, fill=red] (1.75,7.5612) rectangle (1.75,9.9442);
\draw[white, very thin, fill=blue] (1.75,9.9442) rectangle (2.1891,12.048);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5324);
\draw[white, very thin, fill=blue] (9.3189,6.5324) rectangle (9.3189,6.631);
\draw[white, very thin, fill=red] (9.3189,6.631) rectangle (9.758,9.014);
\draw[white, very thin, fill=blue] (9.3189,9.014) rectangle (9.3189,9.9442);
\draw[white, very thin, fill=red] (9.3189,9.9442) rectangle (12.686,10.599);
\draw[white, very thin, fill=blue] (9.3189,10.599) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5324);
\draw[white, very thin, fill=blue] (16.888,6.5324) rectangle (17.986,6.631);
\draw[white, very thin, fill=red] (16.888,6.631) rectangle (17.986,9.014);
\draw[white, very thin, fill=blue] (16.888,9.014) rectangle (17.986,9.9442);
\draw[white, very thin, fill=red] (16.888,9.9442) rectangle (17.986,10.599);
\draw[white, very thin, fill=blue] (16.888,10.599) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.631) -- (24.457,6.631);
\draw[white, dotted] (1.5,9.9442) -- (24.457,9.9442);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.2876) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.324) {D Defaults};
