...
\draw[white, very thin] (24.407,6.8183) -- (24.507,6.8183);
\node[anchor=west] at (24.407, 6.8183) {};
\draw[white, very thin] (24.407,9.9387) -- (24.507,9.9387);
\node[anchor=west] at (24.407, 9.9387) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.4623);
\draw[white, very thin, fill=red] (1.75,6.4623) rectangle (1.75,6.8183);
\draw[white, very thin, fill=blue] (1.75,6.8183) rectangle (5.1167,7.5828);
\draw[white, very thin, fill=red] (1.75,7.5828) rectangle (1.75,9.9387);
\draw[white, very thin, fill=blue] (1.75,9.9387) rectangle (2.1891,12.295);
\draw[white, very thin, fill=red] (1.75,12.295) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.4627);
\draw[white, very thin, fill=blue] (9.3189,6.4627) rectangle (9.3189,6.8183);
\draw[white, very thin, fill=red] (9.3189,6.8183) rectangle (9.758,9.1742);
\draw[white, very thin, fill=blue] (9.3189,9.1742) rectangle (9.3189,9.9387);
\draw[white, very thin, fill=red] (9.3189,9.9387) rectangle (12.686,10.703);
\draw[white, very thin, fill=blue] (9.3189,10.703) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.4627);
\draw[white, very thin, fill=blue] (16.888,6.4627) rectangle (17.986,6.8183);
\draw[white, very thin, fill=red] (16.888,6.8183) rectangle (17.986,9.1742);
\draw[white, very thin, fill=blue] (16.888,9.1742) rectangle (17.986,9.9387);
\draw[white, very thin, fill=red] (16.888,9.9387) rectangle (17.986,10.703);
\draw[white, very thin, fill=blue] (16.888,10.703) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,6.8183) -- (24.457,6.8183);
\draw[white, dotted] (1.5,9.9387) -- (24.457,9.9387);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3785) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.499) {D Defaults};
