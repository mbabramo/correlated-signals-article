...
\draw[white, very thin] (24.407,7.0701) -- (24.507,7.0701);
\node[anchor=west] at (24.407, 7.0701) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.588);
\draw[white, very thin, fill=red] (1.75,6.588) rectangle (1.75,7.0701);
\draw[white, very thin, fill=blue] (1.75,7.0701) rectangle (5.1167,7.7717);
\draw[white, very thin, fill=red] (1.75,7.7717) rectangle (1.75,10.065);
\draw[white, very thin, fill=blue] (1.75,10.065) rectangle (2.1891,12.358);
\draw[white, very thin, fill=red] (1.75,12.358) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.5887);
\draw[white, very thin, fill=blue] (9.3189,6.5887) rectangle (9.3189,7.0701);
\draw[white, very thin, fill=red] (9.3189,7.0701) rectangle (9.758,9.3629);
\draw[white, very thin, fill=blue] (9.3189,9.3629) rectangle (9.3189,10.065);
\draw[white, very thin, fill=red] (9.3189,10.065) rectangle (12.686,10.766);
\draw[white, very thin, fill=blue] (9.3189,10.766) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.5887);
\draw[white, very thin, fill=blue] (16.888,6.5887) rectangle (17.986,7.0701);
\draw[white, very thin, fill=red] (16.888,7.0701) rectangle (17.986,9.3629);
\draw[white, very thin, fill=blue] (16.888,9.3629) rectangle (17.986,10.065);
\draw[white, very thin, fill=red] (16.888,10.065) rectangle (17.986,10.766);
\draw[white, very thin, fill=blue] (16.888,10.766) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,7.0701) -- (24.457,7.0701);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.5673) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.562) {D Defaults};
