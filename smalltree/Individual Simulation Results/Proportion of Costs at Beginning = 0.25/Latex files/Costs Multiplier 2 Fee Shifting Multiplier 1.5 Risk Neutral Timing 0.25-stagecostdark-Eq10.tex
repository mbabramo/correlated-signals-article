...
\draw[white, very thin] (24.407,6.6463) -- (24.507,6.6463);
\node[anchor=west] at (24.407, 6.6463) {};
\draw[white, very thin] (24.407,9.9518) -- (24.507,9.9518);
\node[anchor=west] at (24.407, 9.9518) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.5866);
\draw[white, very thin, fill=red] (1.75,6.5866) rectangle (1.75,6.6463);
\draw[white, very thin, fill=blue] (1.75,6.6463) rectangle (5.1167,7.5716);
\draw[white, very thin, fill=red] (1.75,7.5716) rectangle (1.75,9.9518);
\draw[white, very thin, fill=blue] (1.75,9.9518) rectangle (2.1891,12.051);
\draw[white, very thin, fill=red] (1.75,12.051) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5378);
\draw[white, very thin, fill=blue] (9.3189,6.5378) rectangle (9.3189,6.6463);
\draw[white, very thin, fill=red] (9.3189,6.6463) rectangle (9.758,9.0265);
\draw[white, very thin, fill=blue] (9.3189,9.0265) rectangle (9.3189,9.9518);
\draw[white, very thin, fill=red] (9.3189,9.9518) rectangle (12.686,10.604);
\draw[white, very thin, fill=blue] (9.3189,10.604) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5378);
\draw[white, very thin, fill=blue] (16.888,6.5378) rectangle (17.986,6.6463);
\draw[white, very thin, fill=red] (16.888,6.6463) rectangle (17.986,9.0265);
\draw[white, very thin, fill=blue] (16.888,9.0265) rectangle (17.986,9.9518);
\draw[white, very thin, fill=red] (16.888,9.9518) rectangle (17.986,10.604);
\draw[white, very thin, fill=blue] (16.888,10.604) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.6463) -- (24.457,6.6463);
\draw[white, dotted] (1.5,9.9518) -- (24.457,9.9518);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.299) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.328) {D Defaults};
