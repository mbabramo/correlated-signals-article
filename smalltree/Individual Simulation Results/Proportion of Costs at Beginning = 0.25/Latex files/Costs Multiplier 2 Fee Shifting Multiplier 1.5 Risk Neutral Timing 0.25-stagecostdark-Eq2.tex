...
\draw[white, very thin] (24.407,6.7904) -- (24.507,6.7904);
\node[anchor=west] at (24.407, 6.7904) {};
\draw[white, very thin] (24.407,10.024) -- (24.507,10.024);
\node[anchor=west] at (24.407, 10.024) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.6742);
\draw[white, very thin, fill=red] (1.75,6.6742) rectangle (1.75,6.7904);
\draw[white, very thin, fill=blue] (1.75,6.7904) rectangle (5.1167,7.6719);
\draw[white, very thin, fill=red] (1.75,7.6719) rectangle (1.75,10.024);
\draw[white, very thin, fill=blue] (1.75,10.024) rectangle (2.1891,12.079);
\draw[white, very thin, fill=red] (1.75,12.079) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5943);
\draw[white, very thin, fill=blue] (9.3189,6.5943) rectangle (9.3189,6.7904);
\draw[white, very thin, fill=red] (9.3189,6.7904) rectangle (9.758,9.1424);
\draw[white, very thin, fill=blue] (9.3189,9.1424) rectangle (9.3189,10.024);
\draw[white, very thin, fill=red] (9.3189,10.024) rectangle (12.686,10.648);
\draw[white, very thin, fill=blue] (9.3189,10.648) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5943);
\draw[white, very thin, fill=blue] (16.888,6.5943) rectangle (17.986,6.7904);
\draw[white, very thin, fill=red] (16.888,6.7904) rectangle (17.986,9.1424);
\draw[white, very thin, fill=blue] (16.888,9.1424) rectangle (17.986,10.024);
\draw[white, very thin, fill=red] (16.888,10.024) rectangle (17.986,10.648);
\draw[white, very thin, fill=blue] (16.888,10.648) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.7904) -- (24.457,6.7904);
\draw[white, dotted] (1.5,10.024) -- (24.457,10.024);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.4071) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.364) {D Defaults};
