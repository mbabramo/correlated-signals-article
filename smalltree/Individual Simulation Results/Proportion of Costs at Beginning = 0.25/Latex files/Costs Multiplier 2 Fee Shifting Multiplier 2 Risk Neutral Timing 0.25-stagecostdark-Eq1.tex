...
\draw[white, very thin] (24.407,8.0258) -- (24.507,8.0258);
\node[anchor=west] at (24.407, 8.0258) {};
\draw[white, very thin] (24.407,10.542) -- (24.507,10.542);
\node[anchor=west] at (24.407, 10.542) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,7.0663);
\draw[white, very thin, fill=red] (1.75,7.0663) rectangle (1.75,8.0258);
\draw[white, very thin, fill=blue] (1.75,8.0258) rectangle (5.1167,8.4884);
\draw[white, very thin, fill=red] (1.75,8.4884) rectangle (1.75,10.542);
\draw[white, very thin, fill=blue] (1.75,10.542) rectangle (2.1891,12.597);
\draw[white, very thin, fill=red] (1.75,12.597) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,7.0663);
\draw[white, very thin, fill=blue] (9.3189,7.0663) rectangle (9.3189,8.0258);
\draw[white, very thin, fill=red] (9.3189,8.0258) rectangle (9.758,10.08);
\draw[white, very thin, fill=blue] (9.3189,10.08) rectangle (9.3189,10.542);
\draw[white, very thin, fill=red] (9.3189,10.542) rectangle (12.686,11.005);
\draw[white, very thin, fill=blue] (9.3189,11.005) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,7.0663);
\draw[white, very thin, fill=blue] (16.888,7.0663) rectangle (17.986,8.0258);
\draw[white, very thin, fill=red] (16.888,8.0258) rectangle (17.986,10.08);
\draw[white, very thin, fill=blue] (16.888,10.08) rectangle (17.986,10.542);
\draw[white, very thin, fill=red] (16.888,10.542) rectangle (17.986,11.005);
\draw[white, very thin, fill=blue] (16.888,11.005) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,8.0258) -- (24.457,8.0258);
\draw[white, dotted] (1.5,10.542) -- (24.457,10.542);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0663) {Settles};
\node[text=yellow, centered, rotate=90] at (24.777, 9.2841) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.801) {D Defaults};
