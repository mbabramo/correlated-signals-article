...
\draw[black, very thin] (13.35,7.1064) -- (13.45,7.1064);
\node[anchor=west] at (13.35, 7.1064) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,7.0223);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0223) rectangle (1.75,7.1064);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.1064) rectangle (3.4213,8.0984);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0984) rectangle (1.75,10.672);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.672) rectangle (1.968,12.937);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.937) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9646);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9646) rectangle (5.6333,7.1064);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.1064) rectangle (5.8513,9.6796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6796) rectangle (5.6333,10.672);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.672) rectangle (7.3047,11.369);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.369) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9646);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9646) rectangle (10.062,7.1064);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.1064) rectangle (10.062,9.6796);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6796) rectangle (10.062,10.672);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.672) rectangle (10.062,11.369);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.369) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.1064) -- (13.4,7.1064);
...
\node[text=black, centered, rotate=90] at (13.72, 8.889) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.153) {D Defaults};
