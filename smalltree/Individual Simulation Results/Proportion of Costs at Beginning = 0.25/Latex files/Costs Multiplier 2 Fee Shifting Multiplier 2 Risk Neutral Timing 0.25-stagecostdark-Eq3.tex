...
\draw[white, very thin] (24.407,7.3912) -- (24.507,7.3912);
\node[anchor=west] at (24.407, 7.3912) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.7485);
\draw[white, very thin, fill=red] (1.75,6.7485) rectangle (1.75,7.3912);
\draw[white, very thin, fill=blue] (1.75,7.3912) rectangle (5.1167,8.0126);
\draw[white, very thin, fill=red] (1.75,8.0126) rectangle (1.75,10.225);
\draw[white, very thin, fill=blue] (1.75,10.225) rectangle (2.1891,12.438);
\draw[white, very thin, fill=red] (1.75,12.438) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.7494);
\draw[white, very thin, fill=blue] (9.3189,6.7494) rectangle (9.3189,7.3912);
\draw[white, very thin, fill=red] (9.3189,7.3912) rectangle (9.758,9.6037);
\draw[white, very thin, fill=blue] (9.3189,9.6037) rectangle (9.3189,10.225);
\draw[white, very thin, fill=red] (9.3189,10.225) rectangle (12.686,10.846);
\draw[white, very thin, fill=blue] (9.3189,10.846) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.7494);
\draw[white, very thin, fill=blue] (16.888,6.7494) rectangle (17.986,7.3912);
\draw[white, very thin, fill=red] (16.888,7.3912) rectangle (17.986,9.6037);
\draw[white, very thin, fill=blue] (16.888,9.6037) rectangle (17.986,10.225);
\draw[white, very thin, fill=red] (16.888,10.225) rectangle (17.986,10.846);
\draw[white, very thin, fill=blue] (16.888,10.846) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,7.3912) -- (24.457,7.3912);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.7489) {Settles};
\node[text=yellow, centered, rotate=90] at (24.777, 8.8082) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.642) {D Defaults};
