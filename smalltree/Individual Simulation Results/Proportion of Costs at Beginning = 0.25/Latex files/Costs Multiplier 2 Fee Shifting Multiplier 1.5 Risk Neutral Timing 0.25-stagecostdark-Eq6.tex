...
\draw[white, very thin] (24.407,6.6615) -- (24.507,6.6615);
\node[anchor=west] at (24.407, 6.6615) {};
\draw[white, very thin] (24.407,9.9594) -- (24.507,9.9594);
\node[anchor=west] at (24.407, 9.9594) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.598);
\draw[white, very thin, fill=red] (1.75,6.598) rectangle (1.75,6.6615);
\draw[white, very thin, fill=blue] (1.75,6.6615) rectangle (5.1167,7.581);
\draw[white, very thin, fill=red] (1.75,7.581) rectangle (1.75,9.9594);
\draw[white, very thin, fill=blue] (1.75,9.9594) rectangle (2.1891,12.053);
\draw[white, very thin, fill=red] (1.75,12.053) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5415);
\draw[white, very thin, fill=blue] (9.3189,6.5415) rectangle (9.3189,6.6615);
\draw[white, very thin, fill=red] (9.3189,6.6615) rectangle (9.758,9.0398);
\draw[white, very thin, fill=blue] (9.3189,9.0398) rectangle (9.3189,9.9594);
\draw[white, very thin, fill=red] (9.3189,9.9594) rectangle (12.686,10.61);
\draw[white, very thin, fill=blue] (9.3189,10.61) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5415);
\draw[white, very thin, fill=blue] (16.888,6.5415) rectangle (17.986,6.6615);
\draw[white, very thin, fill=red] (16.888,6.6615) rectangle (17.986,9.0398);
\draw[white, very thin, fill=blue] (16.888,9.0398) rectangle (17.986,9.9594);
\draw[white, very thin, fill=red] (16.888,9.9594) rectangle (17.986,10.61);
\draw[white, very thin, fill=blue] (16.888,10.61) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.6615) -- (24.457,6.6615);
\draw[white, dotted] (1.5,9.9594) -- (24.457,9.9594);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3104) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.331) {D Defaults};
