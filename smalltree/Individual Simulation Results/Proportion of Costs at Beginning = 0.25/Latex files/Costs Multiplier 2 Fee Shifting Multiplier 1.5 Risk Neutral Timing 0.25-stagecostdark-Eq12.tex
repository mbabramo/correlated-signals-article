...
\draw[white, very thin] (24.407,6.6183) -- (24.507,6.6183);
\node[anchor=west] at (24.407, 6.6183) {};
\draw[white, very thin] (24.407,9.9378) -- (24.507,9.9378);
\node[anchor=west] at (24.407, 9.9378) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.5685);
\draw[white, very thin, fill=red] (1.75,6.5685) rectangle (1.75,6.6183);
\draw[white, very thin, fill=blue] (1.75,6.6183) rectangle (5.1167,7.5526);
\draw[white, very thin, fill=red] (1.75,7.5526) rectangle (1.75,9.9378);
\draw[white, very thin, fill=blue] (1.75,9.9378) rectangle (2.1891,12.046);
\draw[white, very thin, fill=red] (1.75,12.046) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5279);
\draw[white, very thin, fill=blue] (9.3189,6.5279) rectangle (9.3189,6.6183);
\draw[white, very thin, fill=red] (9.3189,6.6183) rectangle (9.758,9.0035);
\draw[white, very thin, fill=blue] (9.3189,9.0035) rectangle (9.3189,9.9378);
\draw[white, very thin, fill=red] (9.3189,9.9378) rectangle (12.686,10.595);
\draw[white, very thin, fill=blue] (9.3189,10.595) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5279);
\draw[white, very thin, fill=blue] (16.888,6.5279) rectangle (17.986,6.6183);
\draw[white, very thin, fill=red] (16.888,6.6183) rectangle (17.986,9.0035);
\draw[white, very thin, fill=blue] (16.888,9.0035) rectangle (17.986,9.9378);
\draw[white, very thin, fill=red] (16.888,9.9378) rectangle (17.986,10.595);
\draw[white, very thin, fill=blue] (16.888,10.595) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.6183) -- (24.457,6.6183);
\draw[white, dotted] (1.5,9.9378) -- (24.457,9.9378);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.278) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.32) {D Defaults};
