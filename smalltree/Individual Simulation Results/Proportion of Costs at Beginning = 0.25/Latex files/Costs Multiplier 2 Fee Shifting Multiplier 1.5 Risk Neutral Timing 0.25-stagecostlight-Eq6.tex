...
\draw[black, very thin] (13.35,7.0794) -- (13.45,7.0794);
\node[anchor=west] at (13.35, 7.0794) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,7.0106);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0106) rectangle (1.75,7.0794);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0794) rectangle (3.4213,8.0773);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0773) rectangle (1.75,10.658);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.658) rectangle (1.968,12.93);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.93) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9493);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9493) rectangle (5.6333,7.0794);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0794) rectangle (5.8513,9.6602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6602) rectangle (5.6333,10.658);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.658) rectangle (7.3047,11.364);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.364) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9493);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9493) rectangle (10.062,7.0794);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0794) rectangle (10.062,9.6602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6602) rectangle (10.062,10.658);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.658) rectangle (10.062,11.364);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.364) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.0794) -- (13.4,7.0794);
...
\node[text=black, centered, rotate=90] at (13.72, 8.8687) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.147) {D Defaults};
