...
\draw[white, very thin] (24.407,6.7927) -- (24.507,6.7927);
\node[anchor=west] at (24.407, 6.7927) {};
\draw[white, very thin] (24.407,9.9259) -- (24.507,9.9259);
\node[anchor=west] at (24.407, 9.9259) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.4552);
\draw[white, very thin, fill=red] (1.75,6.4552) rectangle (1.75,6.7927);
\draw[white, very thin, fill=blue] (1.75,6.7927) rectangle (5.1167,7.5608);
\draw[white, very thin, fill=red] (1.75,7.5608) rectangle (1.75,9.9259);
\draw[white, very thin, fill=blue] (1.75,9.9259) rectangle (2.1891,12.286);
\draw[white, very thin, fill=red] (1.75,12.286) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.4442);
\draw[white, very thin, fill=blue] (9.3189,6.4442) rectangle (9.3189,6.7927);
\draw[white, very thin, fill=red] (9.3189,6.7927) rectangle (9.758,9.1578);
\draw[white, very thin, fill=blue] (9.3189,9.1578) rectangle (9.3189,9.9259);
\draw[white, very thin, fill=red] (9.3189,9.9259) rectangle (12.686,10.699);
\draw[white, very thin, fill=blue] (9.3189,10.699) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.4442);
\draw[white, very thin, fill=blue] (16.888,6.4442) rectangle (17.986,6.7927);
\draw[white, very thin, fill=red] (16.888,6.7927) rectangle (17.986,9.1578);
\draw[white, very thin, fill=blue] (16.888,9.1578) rectangle (17.986,9.9259);
\draw[white, very thin, fill=red] (16.888,9.9259) rectangle (17.986,10.699);
\draw[white, very thin, fill=blue] (16.888,10.699) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,6.7927) -- (24.457,6.7927);
\draw[white, dotted] (1.5,9.9259) -- (24.457,9.9259);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3593) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.492) {D Defaults};
