...
\draw[black, very thin] (13.35,7.0365) -- (13.45,7.0365);
\node[anchor=west] at (13.35, 7.0365) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,6.9788);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.9788) rectangle (1.75,7.0365);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0365) rectangle (3.4213,8.0502);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0502) rectangle (1.75,10.637);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.637) rectangle (1.968,12.924);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.924) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9381) rectangle (5.6333,7.0365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0365) rectangle (5.8513,9.6229);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6229) rectangle (5.6333,10.637);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.637) rectangle (7.3047,11.348);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.348) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9381) rectangle (10.062,7.0365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0365) rectangle (10.062,9.6229);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6229) rectangle (10.062,10.637);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.637) rectangle (10.062,11.348);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.348) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.0365) -- (13.4,7.0365);
...
\node[text=black, centered, rotate=90] at (13.72, 8.8365) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.136) {D Defaults};
