...
\draw[white, very thin, fill=blue] (1.75,3.9362) rectangle (3.6529,4.8717);
\draw[white, very thin, fill=blue] (1.75,4.8717) rectangle (3.0674,5.4004);
\draw[white, very thin, fill=blue] (1.75,5.4004) rectangle (2.4819,6.7914);
\draw[white, very thin, fill=red] (1.75,6.7914) rectangle (1.75,10.1);
\draw[white, very thin, fill=blue] (1.75,10.1) rectangle (5.1167,10.295);
\draw[white, very thin, fill=red] (1.75,10.295) rectangle (1.75,12.184);
\draw[white, very thin, fill=blue] (1.75,12.184) rectangle (2.1891,13.018);
...
\draw[white, very thin, fill=red] (9.3189,4.1563) rectangle (11.807,4.512);
\draw[white, very thin, fill=red] (9.3189,4.512) rectangle (11.222,7.2445);
\draw[white, very thin, fill=blue] (9.3189,7.2445) rectangle (9.4652,8.6355);
\draw[white, very thin, fill=blue] (9.3189,8.6355) rectangle (9.3189,10.1);
\draw[white, very thin, fill=red] (9.3189,10.1) rectangle (9.758,11.989);
...
\draw[white, very thin, fill=red] (16.888,3.9362) rectangle (17.986,7.2445);
\draw[white, very thin, fill=blue] (16.888,7.2445) rectangle (17.986,10.1);
\draw[white, very thin, fill=red] (16.888,10.1) rectangle (17.986,11.989);
\draw[white, very thin, fill=blue] (16.888,11.989) rectangle (17.986,12.184);
\draw[white, very thin, fill=red] (16.888,12.184) rectangle (17.986,12.565);
\draw[white, very thin, fill=blue] (16.888,12.565) rectangle (17.986,13.398);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0179) {Settles};
