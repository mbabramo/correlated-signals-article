...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.689) rectangle (2.9127,11.794);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.794) rectangle (1.75,11.868);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.868) rectangle (3.6393,12.375);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.375) rectangle (1.75,13.325);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.325) rectangle (2.186,13.926);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.926) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.689) rectangle (6.796,11.763);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.763) rectangle (5.6333,11.868);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.868) rectangle (6.0693,12.818);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.818) rectangle (5.6333,13.325);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.325) rectangle (7.5227,13.603);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.603) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.689) rectangle (10.607,11.763);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.763) rectangle (10.607,11.868);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.868) rectangle (10.607,12.818);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.818) rectangle (10.607,13.325);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.325) rectangle (10.607,13.603);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.603) rectangle (10.607,14.204);
