...
\draw[white, very thin] (24.407,6.7965) -- (24.507,6.7965);
\node[anchor=west] at (24.407, 6.7965) {};
\draw[white, very thin] (24.407,9.9278) -- (24.507,9.9278);
\node[anchor=west] at (24.407, 9.9278) {};
...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (3.6529,6.4666);
\draw[white, very thin, fill=red] (1.75,6.4666) rectangle (1.75,6.7965);
\draw[white, very thin, fill=blue] (1.75,6.7965) rectangle (5.1167,7.5589);
\draw[white, very thin, fill=red] (1.75,7.5589) rectangle (1.75,9.9278);
\draw[white, very thin, fill=blue] (1.75,9.9278) rectangle (2.1891,12.282);
\draw[white, very thin, fill=red] (1.75,12.282) rectangle (1.75,13.059);
...
\draw[white, very thin, fill=red] (9.3189,6.1067) rectangle (11.222,6.4367);
\draw[white, very thin, fill=blue] (9.3189,6.4367) rectangle (9.3189,6.7965);
\draw[white, very thin, fill=red] (9.3189,6.7965) rectangle (9.758,9.1655);
\draw[white, very thin, fill=blue] (9.3189,9.1655) rectangle (9.3189,9.9278);
\draw[white, very thin, fill=red] (9.3189,9.9278) rectangle (12.686,10.705);
\draw[white, very thin, fill=blue] (9.3189,10.705) rectangle (9.758,13.059);
...
\draw[white, very thin, fill=red] (16.888,6.1067) rectangle (17.986,6.4367);
\draw[white, very thin, fill=blue] (16.888,6.4367) rectangle (17.986,6.7965);
\draw[white, very thin, fill=red] (16.888,6.7965) rectangle (17.986,9.1655);
\draw[white, very thin, fill=blue] (16.888,9.1655) rectangle (17.986,9.9278);
\draw[white, very thin, fill=red] (16.888,9.9278) rectangle (17.986,10.705);
\draw[white, very thin, fill=blue] (16.888,10.705) rectangle (17.986,13.059);
...
\draw[white, dotted] (1.5,6.7965) -- (24.457,6.7965);
\draw[white, dotted] (1.5,9.9278) -- (24.457,9.9278);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3622) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.493) {D Defaults};
