...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,9.4957);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4957) rectangle (10.062,10.559);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.559) rectangle (10.062,11.299);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.299) rectangle (10.062,13.635);
...
\node[text=black, centered, rotate=90] at (13.72, 8.7195) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.097) {D Defaults};
