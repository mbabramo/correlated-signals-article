...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.689) rectangle (2.9127,11.815);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.815) rectangle (1.75,11.904);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.904) rectangle (3.6393,12.401);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.401) rectangle (1.75,13.343);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.343) rectangle (2.186,13.933);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.933) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.689) rectangle (6.796,11.778);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.778) rectangle (5.6333,11.904);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.904) rectangle (6.0693,12.847);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.847) rectangle (5.6333,13.343);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.343) rectangle (7.5227,13.614);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.614) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.689) rectangle (10.607,11.778);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.778) rectangle (10.607,11.904);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.904) rectangle (10.607,12.847);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.847) rectangle (10.607,13.343);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.343) rectangle (10.607,13.614);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.614) rectangle (10.607,14.204);
