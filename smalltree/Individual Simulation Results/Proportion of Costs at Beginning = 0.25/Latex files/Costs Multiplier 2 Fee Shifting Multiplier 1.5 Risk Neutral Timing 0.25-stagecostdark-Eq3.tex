...
\draw[white, very thin] (24.407,6.6863) -- (24.507,6.6863);
\node[anchor=west] at (24.407, 6.6863) {};
\draw[white, very thin] (24.407,9.9718) -- (24.507,9.9718);
\node[anchor=west] at (24.407, 9.9718) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.6088);
\draw[white, very thin, fill=red] (1.75,6.6088) rectangle (1.75,6.6863);
\draw[white, very thin, fill=blue] (1.75,6.6863) rectangle (5.1167,7.6004);
\draw[white, very thin, fill=red] (1.75,7.6004) rectangle (1.75,9.9718);
\draw[white, very thin, fill=blue] (1.75,9.9718) rectangle (2.1891,12.06);
\draw[white, very thin, fill=red] (1.75,12.06) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5556);
\draw[white, very thin, fill=blue] (9.3189,6.5556) rectangle (9.3189,6.6863);
\draw[white, very thin, fill=red] (9.3189,6.6863) rectangle (9.758,9.0577);
\draw[white, very thin, fill=blue] (9.3189,9.0577) rectangle (9.3189,9.9718);
\draw[white, very thin, fill=red] (9.3189,9.9718) rectangle (12.686,10.615);
\draw[white, very thin, fill=blue] (9.3189,10.615) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5556);
\draw[white, very thin, fill=blue] (16.888,6.5556) rectangle (17.986,6.6863);
\draw[white, very thin, fill=red] (16.888,6.6863) rectangle (17.986,9.0577);
\draw[white, very thin, fill=blue] (16.888,9.0577) rectangle (17.986,9.9718);
\draw[white, very thin, fill=red] (16.888,9.9718) rectangle (17.986,10.615);
\draw[white, very thin, fill=blue] (16.888,10.615) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.6863) -- (24.457,6.6863);
\draw[white, dotted] (1.5,9.9718) -- (24.457,9.9718);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.3291) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.338) {D Defaults};
