...
\draw[white, very thin] (24.407,6.6003) -- (24.507,6.6003);
\node[anchor=west] at (24.407, 6.6003) {};
\draw[white, very thin] (24.407,9.9288) -- (24.507,9.9288);
\node[anchor=west] at (24.407, 9.9288) {};
...
\draw[white, very thin, fill=blue] (1.75,6.4781) rectangle (3.6529,6.558);
\draw[white, very thin, fill=red] (1.75,6.558) rectangle (1.75,6.6003);
\draw[white, very thin, fill=blue] (1.75,6.6003) rectangle (5.1167,7.5399);
\draw[white, very thin, fill=red] (1.75,7.5399) rectangle (1.75,9.9288);
\draw[white, very thin, fill=blue] (1.75,9.9288) rectangle (2.1891,12.042);
\draw[white, very thin, fill=red] (1.75,12.042) rectangle (1.75,12.703);
...
\draw[white, very thin, fill=red] (9.3189,6.4781) rectangle (11.222,6.5204);
\draw[white, very thin, fill=blue] (9.3189,6.5204) rectangle (9.3189,6.6003);
\draw[white, very thin, fill=red] (9.3189,6.6003) rectangle (9.758,8.9893);
\draw[white, very thin, fill=blue] (9.3189,8.9893) rectangle (9.3189,9.9288);
\draw[white, very thin, fill=red] (9.3189,9.9288) rectangle (12.686,10.59);
\draw[white, very thin, fill=blue] (9.3189,10.59) rectangle (9.758,12.703);
...
\draw[white, very thin, fill=red] (16.888,6.4781) rectangle (17.986,6.5204);
\draw[white, very thin, fill=blue] (16.888,6.5204) rectangle (17.986,6.6003);
\draw[white, very thin, fill=red] (16.888,6.6003) rectangle (17.986,8.9893);
\draw[white, very thin, fill=blue] (16.888,8.9893) rectangle (17.986,9.9288);
\draw[white, very thin, fill=red] (16.888,9.9288) rectangle (17.986,10.59);
\draw[white, very thin, fill=blue] (16.888,10.59) rectangle (17.986,12.703);
...
\draw[white, dotted] (1.5,6.6003) -- (24.457,6.6003);
\draw[white, dotted] (1.5,9.9288) -- (24.457,9.9288);
...
\node[text=yellow, centered, rotate=90] at (24.777, 8.2646) {P Abandons};
\node[text=yellow, centered, rotate=90] at (24.777, 11.316) {D Defaults};
