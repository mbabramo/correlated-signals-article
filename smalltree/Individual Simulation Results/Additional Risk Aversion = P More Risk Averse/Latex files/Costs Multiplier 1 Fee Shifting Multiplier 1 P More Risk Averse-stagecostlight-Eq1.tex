...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.1224) rectangle (3.276,4.6077);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.6077) rectangle (2.9853,6.0419);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.0419) rectangle (2.6947,7.9587);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.9587) rectangle (1.75,11.76);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.76) rectangle (3.4213,11.926);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1224) rectangle (6.578,4.5457);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.5457) rectangle (6.2873,5.7112);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.7112) rectangle (5.9967,7.9235);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.9235) rectangle (5.6333,11.76);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.76) rectangle (5.8513,11.961);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1224) rectangle (10.062,4.5457);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,4.5457) rectangle (10.062,6.4624);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.4624) rectangle (10.062,8.6748);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.6748) rectangle (10.062,9.1601);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1601) rectangle (10.062,10.326);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.326) rectangle (10.062,11.76);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.76) rectangle (10.062,11.961);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.961) rectangle (10.062,12.128);
...
\node[text=black, centered, rotate=90] at (13.72, 7.9411) {Settles};
