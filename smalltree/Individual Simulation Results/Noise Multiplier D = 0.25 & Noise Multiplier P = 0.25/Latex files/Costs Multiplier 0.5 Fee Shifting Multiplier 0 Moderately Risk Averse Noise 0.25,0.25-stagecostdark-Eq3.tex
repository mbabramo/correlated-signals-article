...
\draw[white, very thin, fill=blue] (1.75,2.2185) rectangle (4.3116,2.2284);
\draw[white, very thin, fill=blue] (1.75,2.2284) rectangle (4.0188,2.5373);
\draw[white, very thin, fill=blue] (1.75,2.5373) rectangle (3.7261,2.5472);
\draw[white, very thin, fill=blue] (1.75,2.5472) rectangle (3.4333,2.8467);
\draw[white, very thin, fill=blue] (1.75,2.8467) rectangle (3.1406,2.8675);
\draw[white, very thin, fill=blue] (1.75,2.8675) rectangle (2.8478,3.1874);
\draw[white, very thin, fill=blue] (1.75,3.1874) rectangle (2.5551,3.2082);
...
\draw[white, very thin, fill=red] (9.3189,2.2185) rectangle (11.88,2.2284);
\draw[white, very thin, fill=red] (9.3189,2.2284) rectangle (11.588,2.5373);
\draw[white, very thin, fill=red] (9.3189,2.5373) rectangle (11.295,2.5472);
\draw[white, very thin, fill=red] (9.3189,2.5472) rectangle (11.002,2.8466);
\draw[white, very thin, fill=red] (9.3189,2.8466) rectangle (10.709,2.8675);
\draw[white, very thin, fill=red] (9.3189,2.8675) rectangle (10.417,3.1873);
\draw[white, very thin, fill=red] (9.3189,3.1873) rectangle (10.124,3.2082);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (17.437,2.1116);
\draw[white, very thin, fill=blue] (16.888,2.1116) rectangle (17.437,2.4403);
\draw[white, very thin, fill=red] (16.888,2.4403) rectangle (17.437,7.0636);
\draw[white, very thin, fill=blue] (16.888,7.0636) rectangle (17.437,7.8316);
\draw[white, very thin, fill=red] (16.888,7.8316) rectangle (17.437,8.6288);
\draw[white, very thin, fill=blue] (16.888,8.6288) rectangle (17.437,13.314);
