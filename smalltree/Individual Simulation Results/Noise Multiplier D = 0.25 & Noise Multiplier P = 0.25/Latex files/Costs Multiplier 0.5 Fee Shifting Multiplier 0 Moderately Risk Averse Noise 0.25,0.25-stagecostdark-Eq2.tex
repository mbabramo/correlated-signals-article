...
\draw[white, very thin, fill=blue] (1.75,2.2185) rectangle (4.3116,2.2334);
\draw[white, very thin, fill=blue] (1.75,2.2334) rectangle (4.0188,2.6818);
\draw[white, very thin, fill=blue] (1.75,2.6818) rectangle (3.7261,2.6967);
\draw[white, very thin, fill=blue] (1.75,2.6967) rectangle (3.4333,2.6972);
\draw[white, very thin, fill=blue] (1.75,2.6972) rectangle (3.1406,2.7285);
\draw[white, very thin, fill=blue] (1.75,2.7285) rectangle (2.8478,3.1769);
\draw[white, very thin, fill=blue] (1.75,3.1769) rectangle (2.5551,3.2082);
...
\draw[white, very thin, fill=red] (9.3189,2.2185) rectangle (11.88,2.2334);
\draw[white, very thin, fill=red] (9.3189,2.2334) rectangle (11.588,2.6818);
\draw[white, very thin, fill=red] (9.3189,2.6818) rectangle (11.295,2.6967);
\draw[white, very thin, fill=red] (9.3189,2.6967) rectangle (11.002,2.6972);
\draw[white, very thin, fill=red] (9.3189,2.6972) rectangle (10.709,2.7285);
\draw[white, very thin, fill=red] (9.3189,2.7285) rectangle (10.417,3.1769);
\draw[white, very thin, fill=red] (9.3189,3.1769) rectangle (10.124,3.2082);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (17.437,2.261);
\draw[white, very thin, fill=blue] (16.888,2.261) rectangle (17.437,2.7392);
\draw[white, very thin, fill=red] (16.888,2.7392) rectangle (17.437,7.0636);
\draw[white, very thin, fill=blue] (16.888,7.0636) rectangle (17.437,7.5326);
\draw[white, very thin, fill=red] (16.888,7.5326) rectangle (17.437,8.4793);
\draw[white, very thin, fill=blue] (16.888,8.4793) rectangle (17.437,13.314);
