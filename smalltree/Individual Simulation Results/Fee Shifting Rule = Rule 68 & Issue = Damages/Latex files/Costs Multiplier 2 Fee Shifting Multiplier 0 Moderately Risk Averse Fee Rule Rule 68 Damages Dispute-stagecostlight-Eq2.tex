...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8489) rectangle (2.186,9.3484);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.3484) rectangle (1.8227,11.322);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.322) rectangle (1.75,11.322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.322) rectangle (1.75,11.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.63) rectangle (2.9127,11.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.63) rectangle (2.622,11.678);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.678) rectangle (2.5493,11.801);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.801) rectangle (2.2587,12.171);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.171) rectangle (2.186,12.96);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.96) rectangle (1.8953,13.836);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8493) rectangle (6.36,7.157);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.157) rectangle (5.9967,9.1301);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.1301) rectangle (5.6333,11.63);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.63) rectangle (7.0867,11.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.63) rectangle (7.0867,11.63);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.63) rectangle (6.796,11.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.63) rectangle (6.796,11.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.63) rectangle (6.7233,11.753);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.753) rectangle (6.4327,11.876);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.876) rectangle (6.36,12.752);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.752) rectangle (6.0693,13.54);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.54) rectangle (5.9967,13.911);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.911) rectangle (5.706,14.033);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.033) rectangle (5.6333,14.082);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.8489) rectangle (10.062,11.63);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.63) rectangle (10.607,11.63);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.63) rectangle (10.607,14.082);
...
\node[text=black, centered, rotate=90] at (13.72, 9.2393) {D Doesn't Answer};
\node[text=black, centered, rotate=90] at (13.72, 12.856) {Settles};
