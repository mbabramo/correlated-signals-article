...
\draw[white, very thin] (24.407,4.4252) -- (24.507,4.4252);
\node[anchor=west] at (24.407, 4.4252) {};
...
\draw[white, very thin, fill=blue] (1.75,1.9385) rectangle (2.4819,2.9797);
\draw[white, very thin, fill=red] (1.75,2.9797) rectangle (1.75,2.9797);
\draw[white, very thin, fill=blue] (1.75,2.9797) rectangle (1.75,4.4252);
\draw[white, very thin, fill=blue] (1.75,4.4252) rectangle (3.5065,6.7749);
\draw[white, very thin, fill=blue] (1.75,6.7749) rectangle (2.7746,9.1);
\draw[white, very thin, fill=blue] (1.75,9.1) rectangle (2.0428,11.02);
\draw[white, very thin, fill=red] (1.75,11.02) rectangle (1.75,11.02);
\draw[white, very thin, fill=blue] (1.75,11.02) rectangle (1.75,12.952);
\draw[white, very thin, fill=blue] (1.75,12.952) rectangle (6.1413,12.952);
\draw[white, very thin, fill=blue] (1.75,12.952) rectangle (5.5558,12.952);
\draw[white, very thin, fill=blue] (1.75,12.952) rectangle (5.4094,12.955);
\draw[white, very thin, fill=blue] (1.75,12.955) rectangle (4.8239,12.955);
\draw[white, very thin, fill=blue] (1.75,12.955) rectangle (4.6775,13.139);
\draw[white, very thin, fill=blue] (1.75,13.139) rectangle (4.092,13.142);
\draw[white, very thin, fill=blue] (1.75,13.142) rectangle (3.9457,13.294);
\draw[white, very thin, fill=blue] (1.75,13.294) rectangle (3.3602,13.356);
\draw[white, very thin, fill=blue] (1.75,13.356) rectangle (3.2138,13.358);
\draw[white, very thin, fill=blue] (1.75,13.358) rectangle (2.6283,13.411);
...
\draw[white, very thin, fill=blue] (1.75,13.443) rectangle (2.0428,13.462);
...
\draw[white, very thin, fill=blue] (9.3189,1.75) rectangle (9.3189,4.4252);
\draw[white, very thin, fill=red] (9.3189,4.4252) rectangle (12.246,4.4252);
\draw[white, very thin, fill=blue] (9.3189,4.4252) rectangle (12.246,5.2751);
\draw[white, very thin, fill=blue] (9.3189,5.2751) rectangle (11.515,6.3568);
\draw[white, very thin, fill=blue] (9.3189,6.3568) rectangle (10.783,8.2772);
\draw[white, very thin, fill=blue] (9.3189,8.2772) rectangle (10.051,10.602);
\draw[white, very thin, fill=blue] (9.3189,10.602) rectangle (9.3189,12.952);
\draw[white, very thin, fill=red] (9.3189,12.952) rectangle (11.954,12.952);
\draw[white, very thin, fill=blue] (9.3189,12.952) rectangle (11.954,13.004);
\draw[white, very thin, fill=red] (9.3189,13.004) rectangle (11.368,13.004);
\draw[white, very thin, fill=blue] (9.3189,13.004) rectangle (11.368,13.006);
\draw[white, very thin, fill=blue] (9.3189,13.006) rectangle (11.222,13.068);
\draw[white, very thin, fill=blue] (9.3189,13.068) rectangle (10.636,13.22);
\draw[white, very thin, fill=blue] (9.3189,13.22) rectangle (10.49,13.224);
\draw[white, very thin, fill=blue] (9.3189,13.224) rectangle (9.9044,13.407);
\draw[white, very thin, fill=blue] (9.3189,13.407) rectangle (9.758,13.407);
\draw[white, very thin, fill=blue] (9.3189,13.407) rectangle (9.3189,13.411);
...
\draw[white, very thin, fill=blue] (9.3189,13.427) rectangle (12.539,13.445);
\draw[white, very thin, fill=blue] (9.3189,13.445) rectangle (11.807,13.464);
...
\draw[white, very thin, fill=blue] (16.888,1.75) rectangle (16.888,4.4252);
\draw[white, very thin, fill=red] (16.888,4.4252) rectangle (19.083,4.4252);
\draw[white, very thin, fill=blue] (16.888,4.4252) rectangle (19.083,12.952);
\draw[white, very thin, fill=red] (16.888,12.952) rectangle (21.279,12.952);
\draw[white, very thin, fill=blue] (16.888,12.952) rectangle (21.279,13.411);
...
\draw[white, dotted] (1.5,4.4252) -- (24.457,4.4252);
...
\node[text=yellow, centered, rotate=90] at (24.777, 3.0876) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 8.6886) {D Doesn't Answer};
