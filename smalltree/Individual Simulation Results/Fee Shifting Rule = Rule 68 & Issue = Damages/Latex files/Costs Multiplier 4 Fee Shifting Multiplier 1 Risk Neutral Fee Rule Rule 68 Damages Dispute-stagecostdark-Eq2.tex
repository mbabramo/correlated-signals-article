...
\draw[white, very thin, fill=blue] (1.75,8.7984) rectangle (2.7746,11.094);
\draw[white, very thin, fill=blue] (1.75,11.094) rectangle (2.0428,12.584);
\draw[white, very thin, fill=red] (1.75,12.584) rectangle (1.75,12.584);
\draw[white, very thin, fill=blue] (1.75,12.584) rectangle (1.75,12.636);
\draw[white, very thin, fill=blue] (1.75,12.636) rectangle (5.5558,12.636);
\draw[white, very thin, fill=blue] (1.75,12.636) rectangle (4.8239,12.665);
\draw[white, very thin, fill=blue] (1.75,12.665) rectangle (4.092,13.118);
\draw[white, very thin, fill=blue] (1.75,13.118) rectangle (3.3602,13.438);
\draw[white, very thin, fill=blue] (1.75,13.438) rectangle (2.6283,13.442);
\draw[white, very thin, fill=red] (1.75,13.442) rectangle (1.75,13.442);
\draw[white, very thin, fill=blue] (1.75,13.442) rectangle (3.5065,13.443);
\draw[white, very thin, fill=blue] (1.75,13.443) rectangle (2.7746,13.462);
\draw[white, very thin, fill=blue] (1.75,13.462) rectangle (2.0428,13.475);
...
\draw[white, very thin, fill=blue] (1.75,13.475) rectangle (11.704,13.475);
\draw[white, very thin, fill=blue] (1.75,13.475) rectangle (10.972,13.475);
\draw[white, very thin, fill=blue] (1.75,13.475) rectangle (10.24,13.476);
\draw[white, very thin, fill=blue] (1.75,13.476) rectangle (9.508,13.481);
\draw[white, very thin, fill=blue] (1.75,13.481) rectangle (8.7761,13.482);
\draw[white, very thin, fill=blue] (1.75,13.482) rectangle (8.0442,13.482);
...
\draw[white, very thin, fill=blue] (9.3189,6.4489) rectangle (11.515,6.5007);
\draw[white, very thin, fill=blue] (9.3189,6.5007) rectangle (10.783,7.9902);
\draw[white, very thin, fill=blue] (9.3189,7.9902) rectangle (10.051,10.286);
\draw[white, very thin, fill=blue] (9.3189,10.286) rectangle (9.3189,12.636);
\draw[white, very thin, fill=red] (9.3189,12.636) rectangle (11.954,12.636);
\draw[white, very thin, fill=blue] (9.3189,12.636) rectangle (11.954,12.639);
\draw[white, very thin, fill=blue] (9.3189,12.639) rectangle (11.222,12.96);
\draw[white, very thin, fill=blue] (9.3189,12.96) rectangle (10.49,13.413);
\draw[white, very thin, fill=blue] (9.3189,13.413) rectangle (9.758,13.442);
...
\draw[white, very thin, fill=blue] (9.3189,13.442) rectangle (13.271,13.442);
\draw[white, very thin, fill=blue] (9.3189,13.442) rectangle (12.539,13.455);
\draw[white, very thin, fill=blue] (9.3189,13.455) rectangle (11.807,13.475);
...
\draw[white, very thin, fill=red] (9.3189,13.494) rectangle (10.051,13.494);
\draw[white, very thin, fill=blue] (9.3189,13.494) rectangle (10.051,13.494);
...
\draw[white, very thin, fill=blue] (16.888,6.4489) rectangle (19.083,12.636);
\draw[white, very thin, fill=red] (16.888,12.636) rectangle (21.279,12.636);
\draw[white, very thin, fill=blue] (16.888,12.636) rectangle (21.279,13.442);
\draw[white, very thin, fill=red] (16.888,13.442) rectangle (21.279,13.442);
\draw[white, very thin, fill=blue] (16.888,13.442) rectangle (21.279,13.475);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.5423) {D Doesn't Answer};
