...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.211) rectangle (10.607,12.607);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.607) rectangle (10.607,12.912);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.912) rectangle (10.607,13.412);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.412) rectangle (10.607,13.786);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.786) rectangle (10.607,13.886);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.886) rectangle (10.607,14.05);
