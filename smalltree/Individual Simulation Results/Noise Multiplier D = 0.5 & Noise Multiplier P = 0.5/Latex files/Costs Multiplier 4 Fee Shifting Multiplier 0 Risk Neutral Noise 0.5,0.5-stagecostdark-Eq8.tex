...
\draw[white, very thin] (24.407,6.567) -- (24.507,6.567);
\node[anchor=west] at (24.407, 6.567) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,2.3274);
\draw[white, very thin, fill=red] (1.75,2.3274) rectangle (1.75,6.567);
\draw[white, very thin, fill=blue] (1.75,6.567) rectangle (3.5065,11.687);
\draw[white, very thin, fill=red] (1.75,11.687) rectangle (1.75,12.941);
\draw[white, very thin, fill=blue] (1.75,12.941) rectangle (6.1413,13.075);
\draw[white, very thin, fill=blue] (1.75,13.075) rectangle (5.5558,13.088);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,5.9895);
\draw[white, very thin, fill=blue] (9.3189,5.9895) rectangle (9.3189,6.567);
\draw[white, very thin, fill=red] (9.3189,6.567) rectangle (12.246,7.8208);
\draw[white, very thin, fill=blue] (9.3189,7.8208) rectangle (9.3189,12.941);
\draw[white, very thin, fill=red] (9.3189,12.941) rectangle (11.954,12.982);
\draw[white, very thin, fill=red] (9.3189,12.982) rectangle (11.368,13.286);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,5.9895);
\draw[white, very thin, fill=blue] (16.888,5.9895) rectangle (16.888,6.567);
\draw[white, very thin, fill=red] (16.888,6.567) rectangle (19.083,7.8208);
\draw[white, very thin, fill=blue] (16.888,7.8208) rectangle (19.083,12.941);
\draw[white, very thin, fill=red] (16.888,12.941) rectangle (21.279,13.286);
...
\draw[white, dotted] (1.5,6.567) -- (24.457,6.567);
...
\node[text=yellow, centered, rotate=90] at (24.777, 4.1585) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 9.7538) {D Doesn't Answer};
