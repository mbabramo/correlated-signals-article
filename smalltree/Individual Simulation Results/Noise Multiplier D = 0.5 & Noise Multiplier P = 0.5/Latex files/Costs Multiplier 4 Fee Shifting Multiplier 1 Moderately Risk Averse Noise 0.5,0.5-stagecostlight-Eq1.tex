...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.01) rectangle (2.622,12.543);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.543) rectangle (1.75,13.867);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.867) rectangle (3.6393,14.06);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.06) rectangle (1.75,14.425);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.425) rectangle (4.0753,14.436);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.01) rectangle (7.0867,8.3342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.3342) rectangle (5.6333,13.867);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.867) rectangle (6.9413,14.232);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.232) rectangle (5.6333,14.425);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.425) rectangle (6.5053,14.48);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.01) rectangle (10.607,8.3342);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.3342) rectangle (10.607,13.867);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.867) rectangle (11.697,14.232);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.232) rectangle (11.697,14.425);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.425) rectangle (11.697,14.48);
...
\node[text=black, centered, rotate=90] at (13.72, 10.439) {D Doesn't Answer};
