...
\draw[white, very thin, fill=blue] (1.75,6.5975) rectangle (3.5065,11.853);
\draw[white, very thin, fill=red] (1.75,11.853) rectangle (1.75,13.363);
\draw[white, very thin, fill=blue] (1.75,13.363) rectangle (6.1413,13.377);
\draw[white, very thin, fill=blue] (1.75,13.377) rectangle (5.8486,13.386);
\draw[white, very thin, fill=blue] (1.75,13.386) rectangle (5.5558,13.392);
\draw[white, very thin, fill=red] (1.75,13.392) rectangle (1.75,13.473);
\draw[white, very thin, fill=blue] (1.75,13.473) rectangle (6.4341,13.476);
\draw[white, very thin, fill=red] (1.75,13.476) rectangle (1.75,13.49);
...
\draw[white, very thin, fill=red] (9.3189,6.5975) rectangle (12.246,8.1078);
\draw[white, very thin, fill=blue] (9.3189,8.1078) rectangle (9.3189,13.363);
\draw[white, very thin, fill=red] (9.3189,13.363) rectangle (11.954,13.374);
\draw[white, very thin, fill=red] (9.3189,13.374) rectangle (11.661,13.394);
\draw[white, very thin, fill=red] (9.3189,13.394) rectangle (11.368,13.444);
\draw[white, very thin, fill=blue] (9.3189,13.444) rectangle (9.3189,13.473);
...
\draw[white, very thin, fill=red] (16.888,6.5975) rectangle (19.083,8.1078);
\draw[white, very thin, fill=blue] (16.888,8.1078) rectangle (19.083,13.363);
\draw[white, very thin, fill=red] (16.888,13.363) rectangle (21.279,13.444);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.9803) {D Doesn't Answer};
