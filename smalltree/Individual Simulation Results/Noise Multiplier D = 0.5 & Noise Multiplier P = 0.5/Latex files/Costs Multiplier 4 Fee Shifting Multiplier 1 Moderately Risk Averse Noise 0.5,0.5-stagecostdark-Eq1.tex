...
\draw[white, very thin, fill=blue] (1.75,6.5975) rectangle (3.5065,11.697);
\draw[white, very thin, fill=red] (1.75,11.697) rectangle (1.75,12.917);
\draw[white, very thin, fill=blue] (1.75,12.917) rectangle (5.5558,13.095);
\draw[white, very thin, fill=red] (1.75,13.095) rectangle (1.75,13.43);
\draw[white, very thin, fill=blue] (1.75,13.43) rectangle (6.4341,13.441);
\draw[white, very thin, fill=red] (1.75,13.441) rectangle (1.75,13.492);
...
\draw[white, very thin, fill=red] (9.3189,6.5975) rectangle (12.246,7.8178);
\draw[white, very thin, fill=blue] (9.3189,7.8178) rectangle (9.3189,12.917);
\draw[white, very thin, fill=red] (9.3189,12.917) rectangle (11.954,13.253);
\draw[white, very thin, fill=blue] (9.3189,13.253) rectangle (9.3189,13.43);
\draw[white, very thin, fill=red] (9.3189,13.43) rectangle (11.075,13.481);
\draw[white, very thin, fill=blue] (9.3189,13.481) rectangle (9.3189,13.492);
...
\draw[white, very thin, fill=red] (16.888,6.5975) rectangle (19.083,7.8178);
\draw[white, very thin, fill=blue] (16.888,7.8178) rectangle (19.083,12.917);
\draw[white, very thin, fill=red] (16.888,12.917) rectangle (21.279,13.253);
\draw[white, very thin, fill=blue] (16.888,13.253) rectangle (21.279,13.43);
\draw[white, very thin, fill=red] (16.888,13.43) rectangle (21.279,13.481);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.7572) {D Doesn't Answer};
