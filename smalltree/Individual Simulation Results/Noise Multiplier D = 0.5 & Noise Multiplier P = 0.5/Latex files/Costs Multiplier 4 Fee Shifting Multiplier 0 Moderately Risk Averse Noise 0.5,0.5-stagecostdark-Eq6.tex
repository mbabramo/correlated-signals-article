...
\draw[white, very thin, fill=blue] (1.75,7.2825) rectangle (3.5065,12.183);
\draw[white, very thin, fill=red] (1.75,12.183) rectangle (1.75,13.368);
\draw[white, very thin, fill=blue] (1.75,13.368) rectangle (6.1413,13.389);
\draw[white, very thin, fill=blue] (1.75,13.389) rectangle (5.8486,13.403);
\draw[white, very thin, fill=blue] (1.75,13.403) rectangle (5.5558,13.408);
\draw[white, very thin, fill=red] (1.75,13.408) rectangle (1.75,13.476);
...
\draw[white, very thin, fill=red] (9.3189,7.2825) rectangle (12.246,8.4677);
\draw[white, very thin, fill=blue] (9.3189,8.4677) rectangle (9.3189,13.368);
\draw[white, very thin, fill=red] (9.3189,13.368) rectangle (11.954,13.376);
\draw[white, very thin, fill=red] (9.3189,13.376) rectangle (11.661,13.393);
\draw[white, very thin, fill=red] (9.3189,13.393) rectangle (11.368,13.436);
\draw[white, very thin, fill=blue] (9.3189,13.436) rectangle (9.3189,13.476);
...
\draw[white, very thin, fill=red] (16.888,7.2825) rectangle (19.083,8.4677);
\draw[white, very thin, fill=blue] (16.888,8.4677) rectangle (19.083,13.368);
\draw[white, very thin, fill=red] (16.888,13.368) rectangle (21.279,13.436);
\draw[white, very thin, fill=blue] (16.888,13.436) rectangle (21.279,13.476);
...
\node[text=yellow, centered, rotate=90] at (24.777, 10.325) {D Doesn't Answer};
