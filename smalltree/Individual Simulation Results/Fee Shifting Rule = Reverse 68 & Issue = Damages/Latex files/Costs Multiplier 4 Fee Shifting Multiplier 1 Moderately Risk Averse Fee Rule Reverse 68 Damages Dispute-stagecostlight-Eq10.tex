...
\draw[black, very thin] (13.35,2.2599) -- (13.45,2.2599);
\node[anchor=west] at (13.35, 2.2599) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7503) rectangle (2.4767,1.7908);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7908) rectangle (2.1133,2.0053);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.0053) rectangle (1.75,2.0053);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.0053) rectangle (1.75,2.2599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2599) rectangle (2.622,4.8098);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.8098) rectangle (2.2587,7.3591);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.3591) rectangle (1.8953,9.8347);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.8347) rectangle (1.75,9.8347);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.8347) rectangle (1.75,14.431);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.431) rectangle (3.2033,14.449);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.449) rectangle (3.1307,14.449);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.449) rectangle (3.058,14.452);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.452) rectangle (2.9853,14.452);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.452) rectangle (2.9127,14.454);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.454) rectangle (2.84,14.477);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.477) rectangle (2.7673,14.478);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.478) rectangle (2.6947,14.48);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.48) rectangle (2.622,14.481);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.481) rectangle (2.5493,14.483);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.483) rectangle (2.4767,14.484);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.484) rectangle (2.404,14.484);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.484) rectangle (2.3313,14.484);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.484) rectangle (2.2587,14.484);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.484) rectangle (3.3487,14.491);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.75) rectangle (5.6333,2.2599);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2599) rectangle (7.0867,2.2599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.2599) rectangle (7.0867,4.5549);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.5549) rectangle (6.7233,6.8563);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8563) rectangle (6.36,9.3319);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.3319) rectangle (5.9967,11.881);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.432) rectangle (6.578,14.434);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.434) rectangle (6.5053,14.435);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.435) rectangle (6.4327,14.437);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.437) rectangle (6.36,14.438);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.438) rectangle (6.2873,14.461);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.461) rectangle (6.2147,14.463);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.463) rectangle (6.142,14.463);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.463) rectangle (6.0693,14.466);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.466) rectangle (5.9967,14.466);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.466) rectangle (5.924,14.484);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.484) rectangle (6.142,14.489);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.75) rectangle (9.5167,2.2599);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.2599) rectangle (10.607,2.2599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.2599) rectangle (10.607,14.431);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.432) rectangle (11.697,14.484);
...
\draw[black, dotted] (1.5,2.2599) -- (13.4,2.2599);
...
\node[text=black, centered, rotate=90] at (13.72, 8.3455) {D Doesn't Answer};
