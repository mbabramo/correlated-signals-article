...
\draw[white, very thin, fill=blue] (1.75,12.633) rectangle (6.1413,12.696);
\draw[white, very thin, fill=red] (1.75,12.696) rectangle (1.75,13.324);
\draw[white, very thin, fill=blue] (1.75,13.324) rectangle (6.4341,13.363);
\draw[white, very thin, fill=red] (1.75,13.363) rectangle (1.75,13.429);
\draw[white, very thin, fill=blue] (1.75,13.429) rectangle (3.5065,13.449);
\draw[white, very thin, fill=red] (1.75,13.449) rectangle (1.75,13.456);
\draw[white, very thin, fill=blue] (1.75,13.456) rectangle (9.9471,13.461);
\draw[white, very thin, fill=red] (1.75,13.461) rectangle (1.75,13.467);
\draw[white, very thin, fill=blue] (1.75,13.467) rectangle (3.5065,13.498);
...
\draw[white, very thin, fill=red] (9.3189,12.633) rectangle (11.368,13.261);
\draw[white, very thin, fill=blue] (9.3189,13.261) rectangle (9.3189,13.324);
\draw[white, very thin, fill=red] (9.3189,13.324) rectangle (11.075,13.391);
\draw[white, very thin, fill=blue] (9.3189,13.391) rectangle (9.3189,13.429);
\draw[white, very thin, fill=red] (9.3189,13.429) rectangle (14.003,13.437);
\draw[white, very thin, fill=blue] (9.3189,13.437) rectangle (11.075,13.456);
\draw[white, very thin, fill=red] (9.3189,13.456) rectangle (11.075,13.462);
\draw[white, very thin, fill=blue] (9.3189,13.462) rectangle (9.3189,13.467);
\draw[white, very thin, fill=red] (9.3189,13.467) rectangle (17.516,13.469);
\draw[white, very thin, fill=blue] (9.3189,13.469) rectangle (14.588,13.5);
...
\draw[white, very thin, fill=red] (16.888,12.633) rectangle (21.279,13.261);
\draw[white, very thin, fill=blue] (16.888,13.261) rectangle (21.279,13.324);
\draw[white, very thin, fill=red] (16.888,13.324) rectangle (21.279,13.391);
\draw[white, very thin, fill=blue] (16.888,13.391) rectangle (21.279,13.429);
