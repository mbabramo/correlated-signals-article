...
\draw[white, very thin, fill=blue] (1.75,9.5881) rectangle (4.8239,9.6438);
\draw[white, very thin, fill=red] (1.75,9.6438) rectangle (1.75,11.703);
\draw[white, very thin, fill=blue] (1.75,11.703) rectangle (5.1167,11.819);
\draw[white, very thin, fill=red] (1.75,11.819) rectangle (1.75,12.489);
\draw[white, very thin, fill=blue] (1.75,12.489) rectangle (2.1891,13.159);
\draw[white, very thin, fill=red] (1.75,13.159) rectangle (1.75,13.275);
\draw[white, very thin, fill=blue] (1.75,13.275) rectangle (7.3123,13.293);
...
\draw[white, very thin, fill=red] (9.3189,9.5881) rectangle (10.051,11.647);
\draw[white, very thin, fill=blue] (9.3189,11.647) rectangle (9.3189,11.703);
\draw[white, very thin, fill=red] (9.3189,11.703) rectangle (9.758,12.373);
\draw[white, very thin, fill=blue] (9.3189,12.373) rectangle (9.3189,12.489);
\draw[white, very thin, fill=red] (9.3189,12.489) rectangle (12.686,12.605);
\draw[white, very thin, fill=blue] (9.3189,12.605) rectangle (9.758,13.275);
...
\draw[white, very thin, fill=red] (9.3189,13.388) rectangle (14.881,13.406);
\draw[white, very thin, fill=blue] (9.3189,13.406) rectangle (11.954,13.5);
...
\draw[white, very thin, fill=red] (16.888,9.5881) rectangle (17.986,11.647);
\draw[white, very thin, fill=blue] (16.888,11.647) rectangle (17.986,11.703);
\draw[white, very thin, fill=red] (16.888,11.703) rectangle (17.986,12.373);
\draw[white, very thin, fill=blue] (16.888,12.373) rectangle (17.986,12.489);
\draw[white, very thin, fill=red] (16.888,12.489) rectangle (17.986,12.605);
\draw[white, very thin, fill=blue] (16.888,12.605) rectangle (17.986,13.275);
...
\node[text=yellow, centered, rotate=90] at (24.777, 10.645) {Settles};
