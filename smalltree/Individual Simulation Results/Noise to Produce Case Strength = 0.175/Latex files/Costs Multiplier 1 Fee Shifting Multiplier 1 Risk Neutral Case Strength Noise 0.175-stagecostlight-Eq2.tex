...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.55) rectangle (1.968,13.355);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.355) rectangle (1.75,13.559);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.559) rectangle (4.0753,13.593);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.55) rectangle (7.3047,12.754);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.754) rectangle (5.8513,13.559);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.279) rectangle (7.9587,14.363);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.363) rectangle (6.5053,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.55) rectangle (10.062,12.754);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.754) rectangle (10.062,13.559);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.559) rectangle (10.607,14.246);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.246) rectangle (10.607,14.279);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.279) rectangle (10.607,14.363);
