...
\draw[white, very thin, fill=blue] (1.75,6.8388) rectangle (2.6283,12.354);
\draw[white, very thin, fill=red] (1.75,12.354) rectangle (1.75,12.6);
\draw[white, very thin, fill=blue] (1.75,12.6) rectangle (4.092,12.72);
\draw[white, very thin, fill=red] (1.75,12.72) rectangle (1.75,13.075);
\draw[white, very thin, fill=blue] (1.75,13.075) rectangle (5.5558,13.087);
\draw[white, very thin, fill=red] (1.75,13.087) rectangle (1.75,13.441);
\draw[white, very thin, fill=blue] (1.75,13.441) rectangle (2.6283,13.489);
...
\draw[white, very thin, fill=red] (9.3189,6.8388) rectangle (12.246,7.0856);
\draw[white, very thin, fill=blue] (9.3189,7.0856) rectangle (9.3189,12.6);
\draw[white, very thin, fill=red] (9.3189,12.6) rectangle (11.661,12.956);
\draw[white, very thin, fill=blue] (9.3189,12.956) rectangle (9.3189,13.075);
\draw[white, very thin, fill=red] (9.3189,13.075) rectangle (10.197,13.428);
\draw[white, very thin, fill=blue] (9.3189,13.428) rectangle (9.3189,13.441);
\draw[white, very thin, fill=red] (9.3189,13.441) rectangle (13.125,13.446);
\draw[white, very thin, fill=blue] (9.3189,13.446) rectangle (10.197,13.494);
...
\draw[white, very thin, fill=red] (16.888,6.8388) rectangle (17.986,7.0856);
\draw[white, very thin, fill=blue] (16.888,7.0856) rectangle (17.986,12.6);
\draw[white, very thin, fill=red] (16.888,12.6) rectangle (19.083,12.956);
\draw[white, very thin, fill=blue] (16.888,12.956) rectangle (19.083,13.075);
\draw[white, very thin, fill=red] (16.888,13.075) rectangle (19.083,13.428);
\draw[white, very thin, fill=blue] (16.888,13.428) rectangle (19.083,13.441);
\draw[white, very thin, fill=red] (16.888,13.441) rectangle (19.083,13.446);
\draw[white, very thin, fill=blue] (16.888,13.446) rectangle (19.083,13.494);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.7196) {D Doesn't Answer};
