...
\draw[white, very thin, fill=blue] (1.75,12.633) rectangle (6.1413,12.677);
\draw[white, very thin, fill=red] (1.75,12.677) rectangle (1.75,13.266);
\draw[white, very thin, fill=blue] (1.75,13.266) rectangle (6.4341,13.319);
\draw[white, very thin, fill=red] (1.75,13.319) rectangle (1.75,13.418);
\draw[white, very thin, fill=blue] (1.75,13.418) rectangle (3.5065,13.447);
\draw[white, very thin, fill=red] (1.75,13.447) rectangle (1.75,13.461);
\draw[white, very thin, fill=blue] (1.75,13.461) rectangle (11.704,13.465);
\draw[white, very thin, fill=red] (1.75,13.465) rectangle (1.75,13.471);
...
\draw[white, very thin, fill=red] (9.3189,12.633) rectangle (11.368,13.223);
\draw[white, very thin, fill=blue] (9.3189,13.223) rectangle (9.3189,13.266);
\draw[white, very thin, fill=red] (9.3189,13.266) rectangle (11.075,13.365);
\draw[white, very thin, fill=blue] (9.3189,13.365) rectangle (9.3189,13.418);
\draw[white, very thin, fill=red] (9.3189,13.418) rectangle (14.003,13.432);
\draw[white, very thin, fill=blue] (9.3189,13.432) rectangle (11.075,13.461);
\draw[white, very thin, fill=red] (9.3189,13.461) rectangle (9.3189,13.467);
\draw[white, very thin, fill=blue] (9.3189,13.467) rectangle (9.3189,13.471);
\draw[white, very thin, fill=red] (9.3189,13.471) rectangle (19.273,13.473);
\draw[white, very thin, fill=blue] (9.3189,13.473) rectangle (16.345,13.5);
...
\draw[white, very thin, fill=red] (16.888,12.633) rectangle (21.279,13.223);
\draw[white, very thin, fill=blue] (16.888,13.223) rectangle (21.279,13.266);
\draw[white, very thin, fill=red] (16.888,13.266) rectangle (21.279,13.365);
\draw[white, very thin, fill=blue] (16.888,13.365) rectangle (21.279,13.418);
\draw[white, very thin, fill=red] (16.888,13.418) rectangle (21.279,13.432);
\draw[white, very thin, fill=blue] (16.888,13.432) rectangle (21.279,13.461);
\draw[white, very thin, fill=red] (16.888,13.461) rectangle (25.67,13.467);
\draw[white, very thin, fill=blue] (16.888,13.467) rectangle (25.67,13.471);
\draw[white, very thin, fill=red] (16.888,13.471) rectangle (25.67,13.473);
