...
\draw[white, very thin, fill=blue] (1.75,6.8388) rectangle (2.6283,11.849);
\draw[white, very thin, fill=red] (1.75,11.849) rectangle (1.75,11.967);
\draw[white, very thin, fill=blue] (1.75,11.967) rectangle (4.092,12.414);
\draw[white, very thin, fill=red] (1.75,12.414) rectangle (1.75,12.894);
\draw[white, very thin, fill=blue] (1.75,12.894) rectangle (5.5558,12.906);
\draw[white, very thin, fill=red] (1.75,12.906) rectangle (1.75,13.26);
\draw[white, very thin, fill=blue] (1.75,13.26) rectangle (2.6283,13.485);
...
\draw[white, very thin, fill=red] (9.3189,6.8388) rectangle (12.246,6.9574);
\draw[white, very thin, fill=blue] (9.3189,6.9574) rectangle (9.3189,11.967);
\draw[white, very thin, fill=red] (9.3189,11.967) rectangle (11.661,12.448);
\draw[white, very thin, fill=blue] (9.3189,12.448) rectangle (9.3189,12.894);
\draw[white, very thin, fill=red] (9.3189,12.894) rectangle (10.197,13.247);
\draw[white, very thin, fill=blue] (9.3189,13.247) rectangle (9.3189,13.26);
\draw[white, very thin, fill=red] (9.3189,13.26) rectangle (13.125,13.268);
\draw[white, very thin, fill=blue] (9.3189,13.268) rectangle (10.197,13.494);
...
\draw[white, very thin, fill=red] (16.888,6.8388) rectangle (17.986,6.9574);
\draw[white, very thin, fill=blue] (16.888,6.9574) rectangle (17.986,11.967);
\draw[white, very thin, fill=red] (16.888,11.967) rectangle (19.083,12.448);
\draw[white, very thin, fill=blue] (16.888,12.448) rectangle (19.083,12.894);
\draw[white, very thin, fill=red] (16.888,12.894) rectangle (19.083,13.247);
\draw[white, very thin, fill=blue] (16.888,13.247) rectangle (19.083,13.26);
\draw[white, very thin, fill=red] (16.888,13.26) rectangle (19.083,13.268);
\draw[white, very thin, fill=blue] (16.888,13.268) rectangle (19.083,13.494);
...
\node[text=yellow, centered, rotate=90] at (24.777, 9.4031) {D Doesn't Answer};
