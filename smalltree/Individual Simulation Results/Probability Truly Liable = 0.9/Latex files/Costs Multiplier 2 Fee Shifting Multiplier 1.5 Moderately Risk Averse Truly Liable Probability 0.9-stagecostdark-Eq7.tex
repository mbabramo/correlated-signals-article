...
\draw[white, very thin, fill=blue] (1.75,1.865) rectangle (2.6283,11.917);
\draw[white, very thin, fill=red] (1.75,11.917) rectangle (1.75,12.945);
\draw[white, very thin, fill=blue] (1.75,12.945) rectangle (4.092,13.281);
\draw[white, very thin, fill=red] (1.75,13.281) rectangle (1.75,13.339);
\draw[white, very thin, fill=blue] (1.75,13.339) rectangle (5.5558,13.38);
\draw[white, very thin, fill=red] (1.75,13.38) rectangle (1.75,13.41);
\draw[white, very thin, fill=blue] (1.75,13.41) rectangle (2.6283,13.495);
...
\draw[white, very thin, fill=red] (9.3189,1.865) rectangle (12.246,2.8933);
\draw[white, very thin, fill=blue] (9.3189,2.8933) rectangle (9.3189,12.945);
\draw[white, very thin, fill=red] (9.3189,12.945) rectangle (11.661,13.004);
\draw[white, very thin, fill=blue] (9.3189,13.004) rectangle (9.3189,13.339);
\draw[white, very thin, fill=red] (9.3189,13.339) rectangle (10.197,13.369);
\draw[white, very thin, fill=blue] (9.3189,13.369) rectangle (9.3189,13.41);
\draw[white, very thin, fill=red] (9.3189,13.41) rectangle (13.125,13.412);
\draw[white, very thin, fill=blue] (9.3189,13.412) rectangle (10.197,13.498);
...
\draw[white, very thin, fill=red] (16.888,1.865) rectangle (17.986,2.8933);
\draw[white, very thin, fill=blue] (16.888,2.8933) rectangle (17.986,12.945);
\draw[white, very thin, fill=red] (16.888,12.945) rectangle (19.083,13.004);
\draw[white, very thin, fill=blue] (16.888,13.004) rectangle (19.083,13.339);
\draw[white, very thin, fill=red] (16.888,13.339) rectangle (19.083,13.369);
\draw[white, very thin, fill=blue] (16.888,13.369) rectangle (19.083,13.41);
\draw[white, very thin, fill=red] (16.888,13.41) rectangle (19.083,13.412);
\draw[white, very thin, fill=blue] (16.888,13.412) rectangle (19.083,13.498);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.4052) {D Doesn't Answer};
