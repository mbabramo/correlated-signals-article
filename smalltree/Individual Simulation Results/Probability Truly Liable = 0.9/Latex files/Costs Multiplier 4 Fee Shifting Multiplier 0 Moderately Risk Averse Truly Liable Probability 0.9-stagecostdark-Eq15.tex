...
\draw[white, very thin] (24.407,1.8984) -- (24.507,1.8984);
\node[anchor=west] at (24.407, 1.8984) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,1.8467);
\draw[white, very thin, fill=red] (1.75,1.8467) rectangle (1.75,1.8984);
\draw[white, very thin, fill=blue] (1.75,1.8984) rectangle (3.5065,12.354);
\draw[white, very thin, fill=red] (1.75,12.354) rectangle (1.75,13.471);
\draw[white, very thin, fill=blue] (1.75,13.471) rectangle (6.1413,13.488);
...
\draw[white, very thin, fill=red] (1.75,13.5) rectangle (1.75,13.5);
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,1.8017);
\draw[white, very thin, fill=blue] (9.3189,1.8017) rectangle (9.3189,1.8984);
\draw[white, very thin, fill=red] (9.3189,1.8984) rectangle (12.246,3.0152);
\draw[white, very thin, fill=blue] (9.3189,3.0152) rectangle (9.3189,13.471);
\draw[white, very thin, fill=red] (9.3189,13.471) rectangle (11.368,13.477);
\draw[white, very thin, fill=blue] (9.3189,13.477) rectangle (9.3189,13.494);
\draw[white, very thin, fill=red] (9.3189,13.494) rectangle (11.075,13.494);
\draw[white, very thin, fill=blue] (9.3189,13.494) rectangle (9.3189,13.498);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,1.8017);
\draw[white, very thin, fill=blue] (16.888,1.8017) rectangle (16.888,1.8984);
\draw[white, very thin, fill=red] (16.888,1.8984) rectangle (19.083,3.0152);
\draw[white, very thin, fill=blue] (16.888,3.0152) rectangle (19.083,13.471);
\draw[white, very thin, fill=red] (16.888,13.471) rectangle (21.279,13.477);
\draw[white, very thin, fill=blue] (16.888,13.477) rectangle (21.279,13.494);
...
\draw[white, dotted] (1.5,1.8984) -- (24.457,1.8984);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.6847) {D Doesn't Answer};
