...
\draw[black, very thin] (13.35,2.095) -- (13.45,2.095);
\node[anchor=west] at (13.35, 2.095) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,1.9749);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.9749) rectangle (1.75,2.095);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.095) rectangle (2.622,13.293);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.293) rectangle (1.75,14.433);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.433) rectangle (3.93,14.472);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.472) rectangle (1.75,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (4.0753,14.493);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,1.8702);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.8702) rectangle (5.6333,2.095);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.095) rectangle (7.0867,3.2349);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.2349) rectangle (5.6333,14.433);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.433) rectangle (6.6507,14.446);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.446) rectangle (5.6333,14.486);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.486) rectangle (6.5053,14.487);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.487) rectangle (5.6333,14.495);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,1.8702);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.8702) rectangle (9.5167,2.095);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.095) rectangle (10.607,3.2349);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.2349) rectangle (10.607,14.433);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.433) rectangle (11.697,14.446);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.446) rectangle (11.697,14.486);
...
\draw[black, dotted] (1.5,2.095) -- (13.4,2.095);
...
\node[text=black, centered, rotate=90] at (13.72, 8.2638) {D Doesn't Answer};
