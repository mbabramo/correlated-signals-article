...
\draw[white, very thin] (24.407,1.8512) -- (24.507,1.8512);
\node[anchor=west] at (24.407, 1.8512) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,1.8159);
\draw[white, very thin, fill=red] (1.75,1.8159) rectangle (1.75,1.8512);
\draw[white, very thin, fill=blue] (1.75,1.8512) rectangle (3.5065,12.345);
\draw[white, very thin, fill=red] (1.75,12.345) rectangle (1.75,13.48);
\draw[white, very thin, fill=blue] (1.75,13.48) rectangle (6.1413,13.492);
...
\draw[white, very thin, fill=red] (1.75,13.5) rectangle (1.75,13.5);
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,1.7852);
\draw[white, very thin, fill=blue] (9.3189,1.7852) rectangle (9.3189,1.8512);
\draw[white, very thin, fill=red] (9.3189,1.8512) rectangle (12.246,2.9865);
\draw[white, very thin, fill=blue] (9.3189,2.9865) rectangle (9.3189,13.48);
\draw[white, very thin, fill=red] (9.3189,13.48) rectangle (11.368,13.484);
\draw[white, very thin, fill=blue] (9.3189,13.484) rectangle (9.3189,13.496);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,1.7852);
\draw[white, very thin, fill=blue] (16.888,1.7852) rectangle (16.888,1.8512);
\draw[white, very thin, fill=red] (16.888,1.8512) rectangle (19.083,2.9865);
\draw[white, very thin, fill=blue] (16.888,2.9865) rectangle (19.083,13.48);
...
\draw[white, very thin, fill=red] (16.888,13.5) rectangle (25.67,13.5);
\draw[white, very thin, fill=blue] (16.888,13.5) rectangle (25.67,13.5);
\draw[white, dotted] (1.5,1.8512) -- (24.457,1.8512);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.6657) {D Doesn't Answer};
