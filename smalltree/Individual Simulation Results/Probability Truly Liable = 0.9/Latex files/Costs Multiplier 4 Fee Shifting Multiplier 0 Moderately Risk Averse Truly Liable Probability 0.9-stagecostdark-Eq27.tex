...
\draw[white, very thin] (24.407,1.8324) -- (24.507,1.8324);
\node[anchor=west] at (24.407, 1.8324) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,1.8037);
\draw[white, very thin, fill=red] (1.75,1.8037) rectangle (1.75,1.8324);
\draw[white, very thin, fill=blue] (1.75,1.8324) rectangle (3.5065,12.341);
\draw[white, very thin, fill=red] (1.75,12.341) rectangle (1.75,13.484);
\draw[white, very thin, fill=blue] (1.75,13.484) rectangle (6.1413,13.493);
...
\draw[white, very thin, fill=red] (1.75,13.5) rectangle (1.75,13.5);
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,1.7787);
\draw[white, very thin, fill=blue] (9.3189,1.7787) rectangle (9.3189,1.8324);
\draw[white, very thin, fill=red] (9.3189,1.8324) rectangle (12.246,2.9751);
\draw[white, very thin, fill=blue] (9.3189,2.9751) rectangle (9.3189,13.484);
\draw[white, very thin, fill=red] (9.3189,13.484) rectangle (11.368,13.487);
\draw[white, very thin, fill=blue] (9.3189,13.487) rectangle (9.3189,13.497);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,1.7787);
\draw[white, very thin, fill=blue] (16.888,1.7787) rectangle (16.888,1.8324);
\draw[white, very thin, fill=red] (16.888,1.8324) rectangle (19.083,2.9751);
\draw[white, very thin, fill=blue] (16.888,2.9751) rectangle (19.083,13.484);
...
\draw[white, very thin, fill=red] (16.888,13.5) rectangle (25.67,13.5);
\draw[white, very thin, fill=blue] (16.888,13.5) rectangle (25.67,13.5);
\draw[white, dotted] (1.5,1.8324) -- (24.457,1.8324);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.6582) {D Doesn't Answer};
