...
\draw[white, very thin] (24.407,1.8218) -- (24.507,1.8218);
\node[anchor=west] at (24.407, 1.8218) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,1.7968);
\draw[white, very thin, fill=red] (1.75,1.7968) rectangle (1.75,1.8218);
\draw[white, very thin, fill=blue] (1.75,1.8218) rectangle (3.5065,12.339);
\draw[white, very thin, fill=red] (1.75,12.339) rectangle (1.75,13.486);
\draw[white, very thin, fill=blue] (1.75,13.486) rectangle (6.1413,13.494);
\draw[white, very thin, fill=red] (1.75,13.494) rectangle (1.75,13.497);
\draw[white, very thin, fill=blue] (1.75,13.497) rectangle (6.4341,13.499);
...
\draw[white, very thin, fill=red] (1.75,13.5) rectangle (1.75,13.5);
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,1.775);
\draw[white, very thin, fill=blue] (9.3189,1.775) rectangle (9.3189,1.8218);
\draw[white, very thin, fill=red] (9.3189,1.8218) rectangle (12.246,2.9687);
\draw[white, very thin, fill=blue] (9.3189,2.9687) rectangle (9.3189,13.486);
\draw[white, very thin, fill=red] (9.3189,13.486) rectangle (11.368,13.489);
\draw[white, very thin, fill=blue] (9.3189,13.489) rectangle (9.3189,13.497);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,1.775);
\draw[white, very thin, fill=blue] (16.888,1.775) rectangle (16.888,1.8218);
\draw[white, very thin, fill=red] (16.888,1.8218) rectangle (19.083,2.9687);
\draw[white, very thin, fill=blue] (16.888,2.9687) rectangle (19.083,13.486);
\draw[white, very thin, fill=red] (16.888,13.486) rectangle (21.279,13.489);
\draw[white, very thin, fill=blue] (16.888,13.489) rectangle (21.279,13.497);
...
\draw[white, very thin, fill=red] (16.888,13.5) rectangle (25.67,13.5);
\draw[white, very thin, fill=blue] (16.888,13.5) rectangle (25.67,13.5);
\draw[white, dotted] (1.5,1.8218) -- (24.457,1.8218);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.6539) {D Doesn't Answer};
