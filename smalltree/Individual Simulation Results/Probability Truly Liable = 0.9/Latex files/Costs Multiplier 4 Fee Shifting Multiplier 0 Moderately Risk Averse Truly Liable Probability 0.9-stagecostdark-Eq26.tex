...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,1.8058);
\draw[white, very thin, fill=red] (1.75,1.8058) rectangle (1.75,1.8356);
\draw[white, very thin, fill=blue] (1.75,1.8356) rectangle (3.5065,12.342);
\draw[white, very thin, fill=red] (1.75,12.342) rectangle (1.75,13.483);
\draw[white, very thin, fill=blue] (1.75,13.483) rectangle (6.1413,13.493);
...
\draw[white, very thin, fill=red] (1.75,13.5) rectangle (1.75,13.5);
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,1.7798);
\draw[white, very thin, fill=blue] (9.3189,1.7798) rectangle (9.3189,1.8356);
\draw[white, very thin, fill=red] (9.3189,1.8356) rectangle (12.246,2.9771);
\draw[white, very thin, fill=blue] (9.3189,2.9771) rectangle (9.3189,13.483);
\draw[white, very thin, fill=red] (9.3189,13.483) rectangle (11.368,13.487);
\draw[white, very thin, fill=blue] (9.3189,13.487) rectangle (9.3189,13.496);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,1.7798);
\draw[white, very thin, fill=blue] (16.888,1.7798) rectangle (16.888,1.8356);
\draw[white, very thin, fill=red] (16.888,1.8356) rectangle (19.083,2.9771);
\draw[white, very thin, fill=blue] (16.888,2.9771) rectangle (19.083,13.483);
\draw[white, very thin, fill=red] (16.888,13.483) rectangle (21.279,13.487);
\draw[white, very thin, fill=blue] (16.888,13.487) rectangle (21.279,13.496);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.6594) {D Doesn't Answer};
