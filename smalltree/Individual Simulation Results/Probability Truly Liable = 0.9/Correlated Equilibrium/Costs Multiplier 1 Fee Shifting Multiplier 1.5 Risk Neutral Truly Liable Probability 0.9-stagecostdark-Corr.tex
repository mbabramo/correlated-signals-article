...
\draw[white, very thin] (24.407,10.219) -- (24.507,10.219);
\node[anchor=west] at (24.407, 10.219) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (2.1891,9.9243);
\draw[white, very thin, fill=red] (1.75,9.9243) rectangle (1.75,10.219);
\draw[white, very thin, fill=blue] (1.75,10.219) rectangle (4.8239,10.603);
...
\draw[white, very thin, fill=blue] (1.75,12.521) rectangle (6.8732,12.889);
...
\draw[white, very thin, fill=blue] (9.3189,2.0442) rectangle (9.3189,10.219);
\draw[white, very thin, fill=red] (9.3189,10.219) rectangle (10.051,10.619);
...
\draw[white, very thin, fill=red] (9.3189,13.022) rectangle (14.442,13.063);
\draw[white, very thin, fill=blue] (9.3189,13.063) rectangle (11.515,13.5);
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (17.437,2.0442);
\draw[white, very thin, fill=blue] (16.888,2.0442) rectangle (17.437,10.219);
\draw[white, very thin, fill=red] (16.888,10.219) rectangle (17.986,10.619);
...
\draw[white, dotted] (1.5,10.219) -- (24.457,10.219);
...
\node[text=yellow, centered, rotate=90] at (24.777, 5.9843) {D Doesn't Answer};
