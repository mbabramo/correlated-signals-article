...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.2496);
\draw[white, very thin, fill=red] (1.75,6.2496) rectangle (1.75,11.764);
\draw[white, very thin, fill=blue] (1.75,11.764) rectangle (3.5065,13.05);
\draw[white, very thin, fill=red] (1.75,13.05) rectangle (1.75,13.308);
\draw[white, very thin, fill=blue] (1.75,13.308) rectangle (6.1413,13.356);
\draw[white, very thin, fill=blue] (1.75,13.356) rectangle (5.5558,13.367);
\draw[white, very thin, fill=red] (1.75,13.367) rectangle (1.75,13.454);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,7.2641);
\draw[white, very thin, fill=blue] (9.3189,7.2641) rectangle (9.3189,11.764);
\draw[white, very thin, fill=red] (9.3189,11.764) rectangle (12.246,12.022);
\draw[white, very thin, fill=blue] (9.3189,12.022) rectangle (9.3189,13.308);
\draw[white, very thin, fill=red] (9.3189,13.308) rectangle (11.954,13.343);
\draw[white, very thin, fill=red] (9.3189,13.343) rectangle (11.368,13.395);
\draw[white, very thin, fill=blue] (9.3189,13.395) rectangle (9.3189,13.454);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,7.2641);
\draw[white, very thin, fill=blue] (16.888,7.2641) rectangle (16.888,11.764);
\draw[white, very thin, fill=red] (16.888,11.764) rectangle (19.083,12.022);
\draw[white, very thin, fill=blue] (16.888,12.022) rectangle (19.083,13.308);
\draw[white, very thin, fill=red] (16.888,13.308) rectangle (21.279,13.395);
\draw[white, very thin, fill=blue] (16.888,13.395) rectangle (21.279,13.454);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.7569) {P Doesn't File};
