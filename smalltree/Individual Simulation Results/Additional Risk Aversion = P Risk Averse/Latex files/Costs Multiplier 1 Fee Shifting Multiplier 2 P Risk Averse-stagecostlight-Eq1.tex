...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4198) rectangle (2.9853,10.929);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.929) rectangle (1.75,11.168);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.168) rectangle (3.4213,11.742);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.742) rectangle (1.75,12.128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.128) rectangle (1.968,13.882);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4198) rectangle (6.2873,9.6586);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6586) rectangle (5.6333,11.168);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.168) rectangle (5.8513,11.554);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.554) rectangle (5.6333,12.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.128) rectangle (7.3047,12.278);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.278) rectangle (5.8513,14.032);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4198) rectangle (10.062,9.6586);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6586) rectangle (10.062,11.168);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.168) rectangle (10.062,11.554);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.554) rectangle (10.062,12.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.128) rectangle (10.062,12.278);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.278) rectangle (10.062,14.032);
...
\node[text=black, centered, rotate=90] at (13.72, 13.08) {D Defaults};
