...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.2138);
\draw[white, very thin, fill=red] (1.75,6.2138) rectangle (1.75,11.688);
\draw[white, very thin, fill=blue] (1.75,11.688) rectangle (3.5065,13.013);
\draw[white, very thin, fill=red] (1.75,13.013) rectangle (1.75,13.301);
\draw[white, very thin, fill=blue] (1.75,13.301) rectangle (6.1413,13.344);
\draw[white, very thin, fill=blue] (1.75,13.344) rectangle (5.5558,13.36);
\draw[white, very thin, fill=red] (1.75,13.36) rectangle (1.75,13.456);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,7.2246);
\draw[white, very thin, fill=blue] (9.3189,7.2246) rectangle (9.3189,11.688);
\draw[white, very thin, fill=red] (9.3189,11.688) rectangle (12.246,11.977);
\draw[white, very thin, fill=blue] (9.3189,11.977) rectangle (9.3189,13.301);
\draw[white, very thin, fill=red] (9.3189,13.301) rectangle (11.954,13.352);
\draw[white, very thin, fill=red] (9.3189,13.352) rectangle (11.368,13.398);
\draw[white, very thin, fill=blue] (9.3189,13.398) rectangle (9.3189,13.456);
...
\draw[white, very thin, fill=red] (9.3189,13.467) rectangle (14.003,13.473);
\draw[white, very thin, fill=blue] (9.3189,13.473) rectangle (11.075,13.488);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,7.2246);
\draw[white, very thin, fill=blue] (16.888,7.2246) rectangle (16.888,11.688);
\draw[white, very thin, fill=red] (16.888,11.688) rectangle (19.083,11.977);
\draw[white, very thin, fill=blue] (16.888,11.977) rectangle (19.083,13.301);
\draw[white, very thin, fill=red] (16.888,13.301) rectangle (21.279,13.398);
\draw[white, very thin, fill=blue] (16.888,13.398) rectangle (21.279,13.456);
\draw[white, very thin, fill=red] (16.888,13.456) rectangle (21.279,13.461);
\draw[white, very thin, fill=blue] (16.888,13.461) rectangle (21.279,13.467);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.7192) {P Doesn't File};
