...
\draw[white, very thin] (24.407,4.3432) -- (24.507,4.3432);
\node[anchor=west] at (24.407, 4.3432) {};
...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,2.8999);
\draw[white, very thin, fill=red] (1.75,2.8999) rectangle (1.75,4.3432);
\draw[white, very thin, fill=blue] (1.75,4.3432) rectangle (3.5065,8.9621);
\draw[white, very thin, fill=red] (1.75,8.9621) rectangle (1.75,13.28);
\draw[white, very thin, fill=blue] (1.75,13.28) rectangle (6.1413,13.322);
\draw[white, very thin, fill=blue] (1.75,13.322) rectangle (5.8486,13.347);
\draw[white, very thin, fill=blue] (1.75,13.347) rectangle (5.5558,13.363);
\draw[white, very thin, fill=red] (1.75,13.363) rectangle (1.75,13.455);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,3.1933);
\draw[white, very thin, fill=blue] (9.3189,3.1933) rectangle (9.3189,4.3432);
\draw[white, very thin, fill=red] (9.3189,4.3432) rectangle (12.246,8.6613);
\draw[white, very thin, fill=blue] (9.3189,8.6613) rectangle (9.3189,13.28);
\draw[white, very thin, fill=red] (9.3189,13.28) rectangle (11.954,13.296);
\draw[white, very thin, fill=red] (9.3189,13.296) rectangle (11.661,13.328);
\draw[white, very thin, fill=red] (9.3189,13.328) rectangle (11.368,13.373);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,3.1933);
\draw[white, very thin, fill=blue] (16.888,3.1933) rectangle (16.888,4.3432);
\draw[white, very thin, fill=red] (16.888,4.3432) rectangle (19.083,8.6613);
\draw[white, very thin, fill=blue] (16.888,8.6613) rectangle (19.083,13.28);
\draw[white, very thin, fill=red] (16.888,13.28) rectangle (21.279,13.373);
...
\draw[white, dotted] (1.5,4.3432) -- (24.457,4.3432);
...
\node[text=yellow, centered, rotate=90] at (24.777, 3.0466) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 8.8117) {D Doesn't Answer};
