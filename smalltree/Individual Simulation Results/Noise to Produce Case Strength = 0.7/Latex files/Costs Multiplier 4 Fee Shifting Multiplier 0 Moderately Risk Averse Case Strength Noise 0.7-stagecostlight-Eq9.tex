...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,3.3212);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,3.3212) rectangle (1.75,5.2934);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,5.2934) rectangle (2.622,9.952);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.952) rectangle (1.75,14.2);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.2) rectangle (3.93,14.257);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.257) rectangle (3.7847,14.291);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.291) rectangle (3.6393,14.313);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.313) rectangle (1.75,14.439);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.439) rectangle (4.0753,14.456);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,3.7222);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.7222) rectangle (5.6333,5.2934);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.2934) rectangle (7.0867,9.541);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.541) rectangle (5.6333,14.2);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.2) rectangle (6.9413,14.222);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.222) rectangle (6.796,14.264);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.264) rectangle (6.6507,14.326);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.326) rectangle (5.6333,14.439);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.439) rectangle (6.5053,14.457);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,3.7222);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.7222) rectangle (9.5167,5.2934);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,5.2934) rectangle (10.607,9.541);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.541) rectangle (10.607,14.2);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.2) rectangle (11.697,14.326);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.326) rectangle (11.697,14.439);
...
\node[text=black, centered, rotate=90] at (13.72, 9.7465) {D Doesn't Answer};
