...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (2.6283,7.6128);
\draw[white, very thin, fill=red] (1.75,7.6128) rectangle (1.75,13.388);
\draw[white, very thin, fill=blue] (1.75,13.388) rectangle (5.2631,13.397);
\draw[white, very thin, fill=red] (1.75,13.397) rectangle (1.75,13.49);
\draw[white, very thin, fill=blue] (1.75,13.49) rectangle (5.5558,13.49);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (12.246,7.5252);
\draw[white, very thin, fill=blue] (9.3189,7.5252) rectangle (9.3189,13.388);
\draw[white, very thin, fill=red] (9.3189,13.388) rectangle (11.368,13.48);
\draw[white, very thin, fill=blue] (9.3189,13.48) rectangle (9.3189,13.49);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (17.986,7.5252);
\draw[white, very thin, fill=blue] (16.888,7.5252) rectangle (17.986,13.388);
\draw[white, very thin, fill=red] (16.888,13.388) rectangle (20.181,13.48);
\draw[white, very thin, fill=blue] (16.888,13.48) rectangle (20.181,13.49);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.569) {D Doesn't Answer};
