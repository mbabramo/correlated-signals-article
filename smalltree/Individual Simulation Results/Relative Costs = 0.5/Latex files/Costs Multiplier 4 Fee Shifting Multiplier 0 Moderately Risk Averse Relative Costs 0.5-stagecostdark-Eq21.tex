...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (2.6283,7.6134);
\draw[white, very thin, fill=red] (1.75,7.6134) rectangle (1.75,13.393);
\draw[white, very thin, fill=blue] (1.75,13.393) rectangle (5.2631,13.402);
\draw[white, very thin, fill=red] (1.75,13.402) rectangle (1.75,13.49);
\draw[white, very thin, fill=blue] (1.75,13.49) rectangle (5.5558,13.491);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (12.246,7.5299);
\draw[white, very thin, fill=blue] (9.3189,7.5299) rectangle (9.3189,13.393);
\draw[white, very thin, fill=red] (9.3189,13.393) rectangle (11.368,13.481);
\draw[white, very thin, fill=blue] (9.3189,13.481) rectangle (9.3189,13.49);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (17.986,7.5299);
\draw[white, very thin, fill=blue] (16.888,7.5299) rectangle (17.986,13.393);
\draw[white, very thin, fill=red] (16.888,13.393) rectangle (20.181,13.481);
\draw[white, very thin, fill=blue] (16.888,13.481) rectangle (20.181,13.49);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.5716) {D Doesn't Answer};
