...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (3.276,9.8831);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.8831) rectangle (1.75,12.451);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.451) rectangle (1.968,12.528);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.528) rectangle (1.75,12.562);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.562) rectangle (4.0753,12.866);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.866) rectangle (1.75,13.41);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.41) rectangle (1.968,14.195);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (6.2147,11.66);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.66) rectangle (5.6333,12.451);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.451) rectangle (7.5227,12.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.486) rectangle (6.0693,12.562);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.562) rectangle (6.0693,13.105);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.105) rectangle (5.6333,13.41);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.41) rectangle (8.1767,13.714);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.714) rectangle (6.7233,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.0921) rectangle (10.334,11.66);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.66) rectangle (10.334,12.451);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.451) rectangle (10.334,12.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.486) rectangle (10.334,12.562);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.562) rectangle (11.152,13.105);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.105) rectangle (11.152,13.41);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.41) rectangle (11.152,13.714);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.714) rectangle (11.152,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 10.772) {Settles};
