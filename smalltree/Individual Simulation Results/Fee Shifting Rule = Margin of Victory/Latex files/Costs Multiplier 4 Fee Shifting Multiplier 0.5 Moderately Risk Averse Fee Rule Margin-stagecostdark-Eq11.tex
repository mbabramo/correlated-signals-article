...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.9202);
\draw[white, very thin, fill=red] (1.75,6.9202) rectangle (1.75,12.649);
\draw[white, very thin, fill=blue] (1.75,12.649) rectangle (3.5065,13.317);
\draw[white, very thin, fill=red] (1.75,13.317) rectangle (1.75,13.426);
...
\draw[white, very thin, fill=blue] (1.75,13.477) rectangle (6.4341,13.483);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,7.4785);
\draw[white, very thin, fill=blue] (9.3189,7.4785) rectangle (9.3189,12.649);
\draw[white, very thin, fill=red] (9.3189,12.649) rectangle (12.246,12.758);
\draw[white, very thin, fill=blue] (9.3189,12.758) rectangle (9.3189,13.426);
\draw[white, very thin, fill=red] (9.3189,13.426) rectangle (11.954,13.45);
\draw[white, very thin, fill=blue] (9.3189,13.45) rectangle (9.3189,13.477);
\draw[white, very thin, fill=red] (9.3189,13.477) rectangle (11.075,13.489);
\draw[white, very thin, fill=blue] (9.3189,13.489) rectangle (9.3189,13.495);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,7.4785);
\draw[white, very thin, fill=blue] (16.888,7.4785) rectangle (16.888,12.649);
\draw[white, very thin, fill=red] (16.888,12.649) rectangle (19.083,12.758);
\draw[white, very thin, fill=blue] (16.888,12.758) rectangle (19.083,13.426);
\draw[white, very thin, fill=red] (16.888,13.426) rectangle (21.279,13.45);
\draw[white, very thin, fill=blue] (16.888,13.45) rectangle (21.279,13.477);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.1994) {P Doesn't File};
