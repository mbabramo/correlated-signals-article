...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.4981);
\draw[white, very thin, fill=red] (1.75,6.4981) rectangle (1.75,11.537);
\draw[white, very thin, fill=blue] (1.75,11.537) rectangle (3.5065,12.626);
\draw[white, very thin, fill=red] (1.75,12.626) rectangle (1.75,13.288);
\draw[white, very thin, fill=blue] (1.75,13.288) rectangle (5.5558,13.321);
\draw[white, very thin, fill=red] (1.75,13.321) rectangle (1.75,13.483);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,6.789);
\draw[white, very thin, fill=blue] (9.3189,6.789) rectangle (9.3189,11.537);
\draw[white, very thin, fill=red] (9.3189,11.537) rectangle (12.246,12.199);
\draw[white, very thin, fill=blue] (9.3189,12.199) rectangle (9.3189,13.288);
\draw[white, very thin, fill=red] (9.3189,13.288) rectangle (11.954,13.451);
\draw[white, very thin, fill=blue] (9.3189,13.451) rectangle (9.3189,13.483);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,6.789);
\draw[white, very thin, fill=blue] (16.888,6.789) rectangle (16.888,11.537);
\draw[white, very thin, fill=red] (16.888,11.537) rectangle (19.083,12.199);
\draw[white, very thin, fill=blue] (16.888,12.199) rectangle (19.083,13.288);
\draw[white, very thin, fill=red] (16.888,13.288) rectangle (21.279,13.451);
\draw[white, very thin, fill=blue] (16.888,13.451) rectangle (21.279,13.483);
...
\node[text=yellow, centered, rotate=90] at (24.777, 6.6435) {P Doesn't File};
