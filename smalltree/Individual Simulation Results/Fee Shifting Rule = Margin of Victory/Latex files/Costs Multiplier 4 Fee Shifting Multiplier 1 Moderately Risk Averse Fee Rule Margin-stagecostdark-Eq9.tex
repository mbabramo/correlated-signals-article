...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,5.7379);
\draw[white, very thin, fill=red] (1.75,5.7379) rectangle (1.75,10.157);
\draw[white, very thin, fill=blue] (1.75,10.157) rectangle (3.5065,11.987);
\draw[white, very thin, fill=red] (1.75,11.987) rectangle (1.75,13.186);
\draw[white, very thin, fill=blue] (1.75,13.186) rectangle (5.5558,13.235);
\draw[white, very thin, fill=red] (1.75,13.235) rectangle (1.75,13.476);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,6.1688);
\draw[white, very thin, fill=blue] (9.3189,6.1688) rectangle (9.3189,10.157);
\draw[white, very thin, fill=red] (9.3189,10.157) rectangle (12.246,11.355);
\draw[white, very thin, fill=blue] (9.3189,11.355) rectangle (9.3189,13.186);
\draw[white, very thin, fill=red] (9.3189,13.186) rectangle (11.954,13.427);
\draw[white, very thin, fill=blue] (9.3189,13.427) rectangle (9.3189,13.476);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,6.1688);
\draw[white, very thin, fill=blue] (16.888,6.1688) rectangle (16.888,10.157);
\draw[white, very thin, fill=red] (16.888,10.157) rectangle (19.083,11.355);
\draw[white, very thin, fill=blue] (16.888,11.355) rectangle (19.083,13.186);
\draw[white, very thin, fill=red] (16.888,13.186) rectangle (21.279,13.427);
\draw[white, very thin, fill=blue] (16.888,13.427) rectangle (21.279,13.476);
...
\node[text=yellow, centered, rotate=90] at (24.777, 5.9534) {P Doesn't File};
\node[text=yellow, centered, rotate=90] at (24.777, 11.671) {No Answer};
