...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,6.8086);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8086) rectangle (1.75,12.168);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.168) rectangle (2.622,13.445);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.445) rectangle (1.75,14.281);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,7.1092);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.1092) rectangle (5.6333,12.168);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.168) rectangle (7.0867,13.004);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.004) rectangle (5.6333,14.281);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,7.1092);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.1092) rectangle (9.5167,12.168);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.168) rectangle (10.607,13.004);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.004) rectangle (10.607,14.281);
...
\node[text=black, centered, rotate=90] at (13.72, 6.9589) {P Doesn't File};
\node[text=black, centered, rotate=90] at (13.72, 13.224) {No Answer};
