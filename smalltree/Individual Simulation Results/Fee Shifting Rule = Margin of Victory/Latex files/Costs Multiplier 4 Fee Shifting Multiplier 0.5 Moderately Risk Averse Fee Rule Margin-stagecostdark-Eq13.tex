...
\draw[white, very thin, fill=blue] (1.75,1.75) rectangle (4.6775,6.7305);
\draw[white, very thin, fill=red] (1.75,6.7305) rectangle (1.75,12.42);
\draw[white, very thin, fill=blue] (1.75,12.42) rectangle (3.5065,13.267);
\draw[white, very thin, fill=red] (1.75,13.267) rectangle (1.75,13.406);
\draw[white, very thin, fill=blue] (1.75,13.406) rectangle (5.5558,13.441);
\draw[white, very thin, fill=red] (1.75,13.441) rectangle (1.75,13.471);
\draw[white, very thin, fill=blue] (1.75,13.471) rectangle (6.4341,13.479);
\draw[white, very thin, fill=red] (1.75,13.479) rectangle (1.75,13.494);
...
\draw[white, very thin, fill=red] (9.3189,1.75) rectangle (9.3189,7.4391);
\draw[white, very thin, fill=blue] (9.3189,7.4391) rectangle (9.3189,12.42);
\draw[white, very thin, fill=red] (9.3189,12.42) rectangle (12.246,12.558);
\draw[white, very thin, fill=blue] (9.3189,12.558) rectangle (9.3189,13.406);
\draw[white, very thin, fill=red] (9.3189,13.406) rectangle (11.954,13.436);
\draw[white, very thin, fill=blue] (9.3189,13.436) rectangle (9.3189,13.471);
\draw[white, very thin, fill=red] (9.3189,13.471) rectangle (11.075,13.486);
\draw[white, very thin, fill=blue] (9.3189,13.486) rectangle (9.3189,13.494);
...
\draw[white, very thin, fill=red] (16.888,1.75) rectangle (16.888,7.4391);
\draw[white, very thin, fill=blue] (16.888,7.4391) rectangle (16.888,12.42);
\draw[white, very thin, fill=red] (16.888,12.42) rectangle (19.083,12.558);
\draw[white, very thin, fill=blue] (16.888,12.558) rectangle (19.083,13.406);
\draw[white, very thin, fill=red] (16.888,13.406) rectangle (21.279,13.436);
\draw[white, very thin, fill=blue] (16.888,13.436) rectangle (21.279,13.471);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.0848) {P Doesn't File};
