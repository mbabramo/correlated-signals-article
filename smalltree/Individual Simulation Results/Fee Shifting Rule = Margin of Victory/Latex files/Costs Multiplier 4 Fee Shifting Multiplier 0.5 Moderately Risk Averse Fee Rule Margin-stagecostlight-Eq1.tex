...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.057) rectangle (3.6393,14.223);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4198) rectangle (10.607,10.071);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.071) rectangle (10.607,14.057);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.057) rectangle (11.697,14.2);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.2) rectangle (11.697,14.365);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.365) rectangle (11.697,14.436);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.479) rectangle (11.697,14.495);
...
\node[text=black, centered, rotate=90] at (13.72, 11.739) {D Doesn't Answer};
