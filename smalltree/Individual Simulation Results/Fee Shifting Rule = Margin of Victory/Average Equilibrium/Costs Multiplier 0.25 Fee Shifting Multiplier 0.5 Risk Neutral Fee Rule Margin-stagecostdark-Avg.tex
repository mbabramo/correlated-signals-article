...
\draw[white, very thin, fill=blue] (1.75,6.1067) rectangle (5.0069,6.3443);
...
\draw[white, very thin, fill=blue] (1.75,11.175) rectangle (1.8598,12.52);
...
\draw[white, very thin, fill=red] (9.3189,7.4779) rectangle (9.4287,8.8235);
\draw[white, very thin, fill=blue] (9.3189,8.8235) rectangle (9.3189,9.8034);
\draw[white, very thin, fill=red] (9.3189,9.8034) rectangle (12.576,10.041);
\draw[white, very thin, fill=red] (9.3189,10.041) rectangle (12.466,10.783);
\draw[white, very thin, fill=blue] (9.3189,10.783) rectangle (9.6482,12.129);
