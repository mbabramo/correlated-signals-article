...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.267) rectangle (3.3668,11.239);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.239) rectangle (1.75,12.383);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.383) rectangle (1.8045,13.528);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.267) rectangle (5.6878,11.411);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.411) rectangle (5.6333,12.383);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.383) rectangle (7.2502,13.355);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.355) rectangle (5.7968,14.5);
