...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2696) rectangle (3.4213,9.9933);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.9933) rectangle (1.75,12.605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.605) rectangle (1.75,13.322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.322) rectangle (1.75,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.2696) rectangle (5.6333,11.881);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.881) rectangle (5.6333,12.605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.605) rectangle (7.3047,13.322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.322) rectangle (5.8513,14.5);
