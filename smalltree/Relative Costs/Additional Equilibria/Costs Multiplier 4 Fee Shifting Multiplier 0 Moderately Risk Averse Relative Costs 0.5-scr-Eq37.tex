...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.186,8.1107);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.1107) rectangle (1.75,14.369);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.369) rectangle (3.494,14.38);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.38) rectangle (1.75,14.488);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.0867,8.0079);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.0079) rectangle (5.6333,14.369);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.369) rectangle (6.6507,14.477);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (10.062,8.0079);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.0079) rectangle (10.062,14.369);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.369) rectangle (11.152,14.477);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.477) rectangle (11.152,14.488);
...
\node[text=black, centered, rotate=90] at (13.72, 8.0593) {D Doesn't Answer};
