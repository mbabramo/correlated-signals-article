...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.186,8.1111);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.1111) rectangle (1.75,14.372);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.372) rectangle (3.494,14.383);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.383) rectangle (1.75,14.488);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.493) rectangle (2.186,14.494);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.0867,8.0109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.0109) rectangle (5.6333,14.372);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.372) rectangle (6.6507,14.478);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.478) rectangle (5.6333,14.488);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (10.062,8.0109);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.0109) rectangle (10.062,14.372);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.372) rectangle (11.152,14.478);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.478) rectangle (11.152,14.488);
...
\node[text=black, centered, rotate=90] at (13.72, 8.061) {D Doesn't Answer};
