...
\draw[black, very thin] (13.35,7.051) -- (13.45,7.051);
\node[anchor=west] at (13.35, 7.051) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,6.992);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.992) rectangle (1.75,7.051);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.051) rectangle (3.4213,8.0581);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0581) rectangle (1.75,10.644);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.644) rectangle (1.968,12.925);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9395);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9395) rectangle (5.6333,7.051);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.051) rectangle (5.8513,9.6367);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6367) rectangle (5.6333,10.644);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.644) rectangle (7.3047,11.354);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.354) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9395);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9395) rectangle (10.062,7.051);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.051) rectangle (10.062,9.6367);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6367) rectangle (10.062,10.644);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.644) rectangle (10.062,11.354);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.354) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.051) -- (13.4,7.051);
...
\node[text=black, centered, rotate=90] at (13.72, 8.8474) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.14) {D Defaults};
