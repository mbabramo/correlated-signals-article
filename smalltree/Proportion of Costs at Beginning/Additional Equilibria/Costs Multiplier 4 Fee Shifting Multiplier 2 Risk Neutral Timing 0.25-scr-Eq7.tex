...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.689) rectangle (2.9127,11.779);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.779) rectangle (1.75,11.843);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.843) rectangle (3.6393,12.357);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.357) rectangle (1.75,13.312);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.312) rectangle (2.186,13.921);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.921) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.689) rectangle (6.796,11.752);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.752) rectangle (5.6333,11.843);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.843) rectangle (6.0693,12.798);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.798) rectangle (5.6333,13.312);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.312) rectangle (7.5227,13.596);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.596) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.689) rectangle (10.607,11.752);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.752) rectangle (10.607,11.843);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.843) rectangle (10.607,12.798);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.798) rectangle (10.607,13.312);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.312) rectangle (10.607,13.596);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.596) rectangle (10.607,14.204);
