...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.689) rectangle (2.9127,11.899);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.899) rectangle (1.75,12.048);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.048) rectangle (3.6393,12.502);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.502) rectangle (1.75,13.415);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.415) rectangle (2.186,13.963);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.963) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.689) rectangle (6.796,11.837);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.837) rectangle (5.6333,12.048);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.048) rectangle (6.0693,12.961);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.961) rectangle (5.6333,13.415);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.415) rectangle (7.5227,13.656);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.656) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.689) rectangle (10.607,11.837);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.837) rectangle (10.607,12.048);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.048) rectangle (10.607,12.961);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.961) rectangle (10.607,13.415);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.415) rectangle (10.607,13.656);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.656) rectangle (10.607,14.204);
