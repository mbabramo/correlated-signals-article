...
\draw[black, very thin] (13.35,3.6864) -- (13.45,3.6864);
\node[anchor=west] at (13.35, 3.6864) {};
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.9537) rectangle (1.75,3.6864);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.6864) rectangle (1.9135,5.8021);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,5.8021) rectangle (1.75,6.0446);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.0446) rectangle (3.2215,6.0849);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.0849) rectangle (2.9308,6.0889);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5473) rectangle (3.4213,7.5976);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.5976) rectangle (1.75,10.524);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.524) rectangle (1.968,13.45);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.45) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,3.4827);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.4827) rectangle (5.6333,3.6864);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.6864) rectangle (7.0867,3.929);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,3.929) rectangle (5.6333,6.0446);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5473) rectangle (5.8513,9.4733);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4733) rectangle (5.6333,10.524);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.524) rectangle (7.3047,11.574);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.574) rectangle (5.8513,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,3.4827);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.4827) rectangle (9.5167,3.6864);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,3.6864) rectangle (9.721,3.929);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,3.929) rectangle (9.721,6.0446);
...
\draw[black, dotted] (1.5,3.6864) -- (13.4,3.6864);
...
\node[text=black, centered, rotate=90] at (13.72, 4.8655) {No Answer};
