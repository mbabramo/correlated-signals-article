...
\draw[black, very thin] (13.35,7.063) -- (13.45,7.063);
\node[anchor=west] at (13.35, 7.063) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,6.9982);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.9982) rectangle (1.75,7.063);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.063) rectangle (3.4213,8.067);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.067) rectangle (1.75,10.65);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.65) rectangle (1.968,12.928);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.928) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9453);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9453) rectangle (5.6333,7.063);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.063) rectangle (5.8513,9.6458);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6458) rectangle (5.6333,10.65);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.65) rectangle (7.3047,11.357);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.357) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9453);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9453) rectangle (10.062,7.063);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.063) rectangle (10.062,9.6458);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6458) rectangle (10.062,10.65);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.65) rectangle (10.062,11.357);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.357) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.063) -- (13.4,7.063);
...
\node[text=black, centered, rotate=90] at (13.72, 8.8564) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.143) {D Defaults};
