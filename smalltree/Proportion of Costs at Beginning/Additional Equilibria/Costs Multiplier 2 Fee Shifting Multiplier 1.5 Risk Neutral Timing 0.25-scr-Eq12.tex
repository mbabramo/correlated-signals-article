...
\draw[black, very thin] (13.35,7.0326) -- (13.45,7.0326);
\node[anchor=west] at (13.35, 7.0326) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,6.9786);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.9786) rectangle (1.75,7.0326);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0326) rectangle (3.4213,8.0464);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0464) rectangle (1.75,10.635);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.635) rectangle (1.968,12.922);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9345);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9345) rectangle (5.6333,7.0326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0326) rectangle (5.8513,9.6208);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6208) rectangle (5.6333,10.635);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.635) rectangle (7.3047,11.348);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9345);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9345) rectangle (10.062,7.0326);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0326) rectangle (10.062,9.6208);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6208) rectangle (10.062,10.635);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.635) rectangle (10.062,11.348);
...
\draw[black, dotted] (1.5,7.0326) -- (13.4,7.0326);
...
\node[text=black, centered, rotate=90] at (13.72, 8.8336) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.135) {D Defaults};
