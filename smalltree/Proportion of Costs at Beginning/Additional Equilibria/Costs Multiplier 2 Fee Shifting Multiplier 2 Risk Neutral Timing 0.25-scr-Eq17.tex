...
\draw[black, very thin] (13.35,7.2656) -- (13.45,7.2656);
\node[anchor=west] at (13.35, 7.2656) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.4775) rectangle (2.6947,6.8779);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.8779) rectangle (1.75,7.2656);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.2656) rectangle (3.4213,8.088);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.088) rectangle (1.75,10.644);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.644) rectangle (1.968,13.193);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.4775) rectangle (6.578,6.8653);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8653) rectangle (5.6333,7.2656);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.2656) rectangle (5.8513,9.8213);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.8213) rectangle (5.6333,10.644);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.644) rectangle (7.3047,11.472);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.4775) rectangle (10.062,6.8653);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.8653) rectangle (10.062,7.2656);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.2656) rectangle (10.062,9.8213);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8213) rectangle (10.062,10.644);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.644) rectangle (10.062,11.472);
...
\draw[black, dotted] (1.5,7.2656) -- (13.4,7.2656);
...
\node[text=black, centered, rotate=90] at (13.72, 8.9546) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.333) {D Defaults};
