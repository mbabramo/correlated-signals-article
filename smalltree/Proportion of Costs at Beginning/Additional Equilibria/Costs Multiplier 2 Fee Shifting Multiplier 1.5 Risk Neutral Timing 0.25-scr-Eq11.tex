...
\draw[black, very thin] (13.35,7.0464) -- (13.45,7.0464);
\node[anchor=west] at (13.35, 7.0464) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,6.9875);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.9875) rectangle (1.75,7.0464);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.0464) rectangle (3.4213,8.0558);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.0558) rectangle (1.75,10.642);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.642) rectangle (1.968,12.925);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.925) rectangle (1.75,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9394);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9394) rectangle (5.6333,7.0464);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.0464) rectangle (5.8513,9.6322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6322) rectangle (5.6333,10.642);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.642) rectangle (7.3047,11.352);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.352) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9394);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9394) rectangle (10.062,7.0464);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.0464) rectangle (10.062,9.6322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6322) rectangle (10.062,10.642);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.642) rectangle (10.062,11.352);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.352) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.0464) -- (13.4,7.0464);
...
\node[text=black, centered, rotate=90] at (13.72, 8.844) {P Abandons};
