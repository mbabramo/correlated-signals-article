...
\draw[black, very thin] (13.35,7.1192) -- (13.45,7.1192);
\node[anchor=west] at (13.35, 7.1192) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8805) rectangle (2.6947,7.0366);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.0366) rectangle (1.75,7.1192);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.1192) rectangle (3.4213,8.104);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,8.104) rectangle (1.75,10.678);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.678) rectangle (1.968,12.937);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8805) rectangle (6.578,6.9631);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.9631) rectangle (5.6333,7.1192);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.1192) rectangle (5.8513,9.6931);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.6931) rectangle (5.6333,10.678);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.678) rectangle (7.3047,11.377);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.377) rectangle (5.8513,13.635);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8805) rectangle (10.062,6.9631);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,6.9631) rectangle (10.062,7.1192);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.1192) rectangle (10.062,9.6931);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6931) rectangle (10.062,10.678);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.678) rectangle (10.062,11.377);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.377) rectangle (10.062,13.635);
...
\draw[black, dotted] (1.5,7.1192) -- (13.4,7.1192);
...
\node[text=black, centered, rotate=90] at (13.72, 8.8986) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.157) {D Defaults};
