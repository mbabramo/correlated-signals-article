...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.806) rectangle (2.9127,12.212);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.212) rectangle (1.75,12.537);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.537) rectangle (3.6393,12.874);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.874) rectangle (1.75,13.683);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.683) rectangle (2.186,14.078);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.806) rectangle (6.796,12.13);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.13) rectangle (5.6333,12.537);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.537) rectangle (6.0693,13.346);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.346) rectangle (5.6333,13.683);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.683) rectangle (7.5227,13.809);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.809) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.806) rectangle (10.607,12.13);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.13) rectangle (10.607,12.537);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.537) rectangle (10.607,13.346);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.346) rectangle (10.607,13.683);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.683) rectangle (10.607,13.809);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.809) rectangle (10.607,14.204);
