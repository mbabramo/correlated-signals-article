...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.689) rectangle (2.9127,11.791);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.791) rectangle (1.75,11.873);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.873) rectangle (3.6393,12.382);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.382) rectangle (1.75,13.328);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.328) rectangle (2.186,13.93);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.93) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.689) rectangle (6.796,11.771);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.771) rectangle (5.6333,11.873);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.873) rectangle (6.0693,12.819);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.819) rectangle (5.6333,13.328);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.328) rectangle (7.5227,13.602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.602) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.689) rectangle (10.607,11.771);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.771) rectangle (10.607,11.873);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.873) rectangle (10.607,12.819);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.819) rectangle (10.607,13.328);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.328) rectangle (10.607,13.602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.602) rectangle (10.607,14.204);
