...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.058,2.3298);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3298) rectangle (2.4767,2.3772);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.3772) rectangle (1.8953,4.4525);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,4.4525) rectangle (1.75,8.0576);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.0576) rectangle (3.2033,8.9864);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.351) rectangle (4.5113,13.531);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.531) rectangle (1.75,13.763);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.763) rectangle (2.186,14.318);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.318) rectangle (1.75,14.5);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (6.9413,1.9734);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9734) rectangle (6.36,1.9996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.9996) rectangle (5.7787,5.3551);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.838) rectangle (7.0867,11.343);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.343) rectangle (5.6333,13.351);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.351) rectangle (6.0693,13.583);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.583) rectangle (5.6333,13.763);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.763) rectangle (8.3947,13.945);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.945) rectangle (6.9413,14.5);
...
\node[text=black, centered, rotate=90] at (13.72, 9.4478) {P Abandons};
\node[text=black, centered, rotate=90] at (13.72, 12.094) {D Defaults};
