...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,2.555);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.555) rectangle (1.75,6.5294);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.5294) rectangle (2.186,10.941);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.941) rectangle (1.75,11.846);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.846) rectangle (3.494,11.885);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.885) rectangle (1.75,12.08);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.08) rectangle (4.0753,12.462);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.5294) rectangle (7.0867,7.4349);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.4349) rectangle (5.6333,11.846);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.846) rectangle (6.2147,12.041);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.381) rectangle (7.9587,13.762);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.762) rectangle (6.5053,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.5294) rectangle (10.062,7.4349);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.4349) rectangle (10.062,11.846);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.846) rectangle (10.607,12.041);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.041) rectangle (10.607,12.08);
...
\node[text=black, centered, rotate=90] at (13.72, 4.1397) {P Doesn't File};
\node[text=black, centered, rotate=90] at (13.72, 9.1878) {D Doesn't Answer};
