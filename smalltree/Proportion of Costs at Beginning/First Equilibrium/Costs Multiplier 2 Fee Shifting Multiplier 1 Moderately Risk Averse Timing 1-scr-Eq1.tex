...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,2.8116);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,2.8116) rectangle (1.75,7.2046);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.2046) rectangle (2.622,12.217);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.217) rectangle (1.75,13.572);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.572) rectangle (3.93,13.625);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.625) rectangle (3.7847,13.718);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,7.2046) rectangle (7.0867,8.5599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,8.5599) rectangle (5.6333,13.572);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.572) rectangle (6.9413,13.653);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.653) rectangle (6.796,13.856);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.856) rectangle (6.6507,14.109);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,7.2046) rectangle (10.607,8.5599);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,8.5599) rectangle (10.607,13.572);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.572) rectangle (11.697,14.109);
...
\node[text=black, centered, rotate=90] at (13.72, 4.4773) {P Doesn't File};
