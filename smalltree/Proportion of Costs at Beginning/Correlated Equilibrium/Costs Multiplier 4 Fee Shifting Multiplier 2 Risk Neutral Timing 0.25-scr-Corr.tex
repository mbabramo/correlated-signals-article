...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.689) rectangle (2.9127,11.804);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.804) rectangle (1.75,11.896);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.896) rectangle (3.6393,12.398);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.398) rectangle (1.75,13.339);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.339) rectangle (2.186,13.935);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.935) rectangle (1.75,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.689) rectangle (6.796,11.781);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.781) rectangle (5.6333,11.896);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.896) rectangle (6.0693,12.837);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.837) rectangle (5.6333,13.339);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.339) rectangle (7.5227,13.608);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.608) rectangle (6.0693,14.204);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.689) rectangle (10.607,11.781);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.781) rectangle (10.607,11.896);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.896) rectangle (10.607,12.837);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.837) rectangle (10.607,13.339);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.339) rectangle (10.607,13.608);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.608) rectangle (10.607,14.204);
