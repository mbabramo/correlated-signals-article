...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,6.8304) rectangle (2.186,10.421);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.421) rectangle (1.75,11.153);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.153) rectangle (3.494,11.277);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.277) rectangle (2.622,12.701);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.701) rectangle (1.75,13.547);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.547) rectangle (3.6393,13.67);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,6.8304) rectangle (7.0867,7.5627);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.5627) rectangle (5.6333,11.153);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.153) rectangle (7.0867,11.648);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.648) rectangle (6.2147,11.999);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.999) rectangle (5.6333,13.547);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.547) rectangle (6.0693,13.898);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,6.8304) rectangle (10.062,7.5627);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.5627) rectangle (10.062,11.153);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.153) rectangle (10.607,11.648);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.648) rectangle (10.607,13.072);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.072) rectangle (10.607,13.424);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.424) rectangle (10.607,13.547);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.547) rectangle (10.607,13.898);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.898) rectangle (10.607,14.022);
...
\node[text=black, centered, rotate=90] at (13.72, 8.9918) {D Doesn't Answer};
\node[text=black, centered, rotate=90] at (13.72, 12.35) {Settles};
