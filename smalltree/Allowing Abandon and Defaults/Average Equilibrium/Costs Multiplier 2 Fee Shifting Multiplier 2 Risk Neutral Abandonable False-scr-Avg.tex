...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.0921) rectangle (10.607,9.8447);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.8447) rectangle (10.607,10.375);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.375) rectangle (10.607,12.587);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.587) rectangle (10.607,13.072);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.072) rectangle (10.607,13.319);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.319) rectangle (10.607,14.022);
