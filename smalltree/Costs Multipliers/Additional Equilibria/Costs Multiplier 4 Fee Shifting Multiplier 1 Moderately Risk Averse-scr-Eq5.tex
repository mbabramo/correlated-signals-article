...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.3) rectangle (2.622,9.3999);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.3999) rectangle (1.75,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.3) rectangle (7.0867,9.4001);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.4001) rectangle (5.6333,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.3) rectangle (10.607,9.4001);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.4001) rectangle (10.607,14.5);
