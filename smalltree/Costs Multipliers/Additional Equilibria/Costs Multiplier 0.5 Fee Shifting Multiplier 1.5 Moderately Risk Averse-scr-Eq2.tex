...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.777) rectangle (3.3123,12.11);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.11) rectangle (1.75,12.9);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.9) rectangle (1.859,13.689);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.777) rectangle (5.7423,12.567);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.567) rectangle (5.6333,12.9);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.9) rectangle (7.1957,13.232);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.232) rectangle (5.7423,14.022);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.777) rectangle (9.7892,12.567);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.567) rectangle (9.7892,12.9);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.9) rectangle (9.7892,13.232);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.232) rectangle (9.7892,14.022);
