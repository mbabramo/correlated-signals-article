...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.3612) rectangle (2.9853,4.7473);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.7473) rectangle (2.6947,7.7122);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.7122) rectangle (1.75,10.81);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.81) rectangle (3.4213,11.223);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.223) rectangle (1.75,12.128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.128) rectangle (1.968,14.178);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.1224) rectangle (6.578,5.1375);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.1375) rectangle (6.2873,5.7112);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,5.7112) rectangle (5.9967,7.2206);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.2206) rectangle (5.6333,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.81) rectangle (5.8513,11.715);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.715) rectangle (5.6333,12.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.128) rectangle (7.3047,12.34);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.34) rectangle (5.8513,14.389);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.1224) rectangle (10.062,5.1375);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.1375) rectangle (10.062,8.1025);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.1025) rectangle (10.062,9.6119);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,9.6119) rectangle (10.062,9.8507);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.8507) rectangle (10.062,10.424);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.424) rectangle (10.062,10.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.81) rectangle (10.062,11.715);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.715) rectangle (10.062,12.128);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.128) rectangle (10.062,12.34);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.34) rectangle (10.062,14.389);
...
\node[text=black, centered, rotate=90] at (13.72, 7.4664) {Settles};
