...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,1.9384) -- (3.26,1.9904) -- (4.9,2.0388) -- (6.54,2.0296) -- (8.18,2.0849);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,1.9326) -- (3.26,1.9695) -- (4.9,1.9653) -- (6.54,2.01) -- (8.18,2.0712);
