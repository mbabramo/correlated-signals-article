...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,3.8234) -- (3.26,2.2278) -- (4.9,2.2411) -- (6.54,1.6963) -- (8.18,1.4116);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,4.1185) -- (3.26,2.5024) -- (4.9,1.7599) -- (6.54,1.4445) -- (8.18,1.3268);
