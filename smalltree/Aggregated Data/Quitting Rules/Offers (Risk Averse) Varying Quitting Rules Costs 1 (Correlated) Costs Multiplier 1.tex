...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,2.7564) -- (3.26,2.5555) -- (4.9,2.4957) -- (6.54,2.4045) -- (8.18,2.4994);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,2.9459) -- (3.26,3.0444) -- (4.9,3.184) -- (6.54,3.1955) -- (8.18,3.1006);
