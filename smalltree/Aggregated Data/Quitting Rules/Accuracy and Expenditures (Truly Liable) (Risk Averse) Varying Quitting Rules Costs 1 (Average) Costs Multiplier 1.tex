...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,2.7844) -- (3.26,2.8095) -- (4.9,2.7601) -- (6.54,2.8832) -- (8.18,2.9618);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,1.2967) -- (3.26,1.3443) -- (4.9,1.3779) -- (6.54,1.3291) -- (8.18,1.4873);
\draw[green, opacity=0.70, line width=1mm, solid] (1.62,2.3229) -- (3.26,2.2903) -- (4.9,2.278) -- (6.54,2.2275) -- (8.18,2.2749);
