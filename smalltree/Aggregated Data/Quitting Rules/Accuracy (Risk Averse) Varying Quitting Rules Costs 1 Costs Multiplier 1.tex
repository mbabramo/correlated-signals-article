...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,2.0399) -- (3.26,2.0734) -- (4.9,2.0747) -- (6.54,2.007) -- (8.18,2.0099);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.62,2.0275) -- (3.26,2.0652) -- (4.9,2.0638) -- (6.54,2.1343) -- (8.18,2.1351);
