...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,3.2921) -- (3.26,3.2921) -- (4.9,3.2921) -- (6.54,3.2923) -- (8.18,3.3684);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,3.3986) -- (3.26,3.8895) -- (4.9,3.8549) -- (6.54,3.3864) -- (8.18,2.7638);
