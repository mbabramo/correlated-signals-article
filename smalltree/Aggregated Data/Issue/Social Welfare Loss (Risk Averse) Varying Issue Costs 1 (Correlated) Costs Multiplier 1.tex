...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,3.3017) -- (3.26,3.095) -- (4.9,3.096) -- (6.54,3.2236) -- (8.18,3.1304);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.62,2.9318) -- (3.26,3.5721) -- (4.9,3.5495) -- (6.54,3.0472) -- (8.18,2.651);
