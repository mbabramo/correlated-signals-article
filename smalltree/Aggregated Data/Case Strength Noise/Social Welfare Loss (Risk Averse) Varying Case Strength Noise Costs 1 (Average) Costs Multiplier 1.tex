...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.315,2.655) -- (2.345,2.4521) -- (3.375,2.4095) -- (4.405,2.3502) -- (5.435,2.9609);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.315,4.0001) -- (2.345,3.489) -- (3.375,3.5516) -- (4.405,3.4801) -- (5.435,3.4044);
