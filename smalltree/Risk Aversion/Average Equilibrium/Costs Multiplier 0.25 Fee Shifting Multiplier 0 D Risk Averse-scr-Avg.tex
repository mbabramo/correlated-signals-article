...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2696) rectangle (3.3123,9.9933);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.9933) rectangle (1.75,12.605);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.605) rectangle (1.859,13.783);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.2696) rectangle (5.7423,11.881);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.881) rectangle (5.6333,12.605);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.605) rectangle (7.1957,13.322);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.322) rectangle (5.7423,14.5);
