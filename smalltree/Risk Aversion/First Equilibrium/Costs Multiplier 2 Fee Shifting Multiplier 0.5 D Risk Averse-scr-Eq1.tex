...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.186,7.2504);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.2504) rectangle (1.75,9.4196);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.4196) rectangle (3.2033,9.8084);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.8084) rectangle (1.75,13.072);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.072) rectangle (2.186,13.458);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.4196) rectangle (6.5053,12.683);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.683) rectangle (5.6333,13.072);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.072) rectangle (7.5227,13.646);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.646) rectangle (6.0693,14.032);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.4196) rectangle (10.607,12.683);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.683) rectangle (10.607,13.072);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.072) rectangle (10.607,13.646);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.646) rectangle (10.607,14.032);
