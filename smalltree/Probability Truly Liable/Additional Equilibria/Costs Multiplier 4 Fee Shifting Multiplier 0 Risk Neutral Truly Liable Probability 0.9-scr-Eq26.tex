...
\draw[black, very thin] (13.35,1.7996) -- (13.45,1.7996);
\node[anchor=west] at (13.35, 1.7996) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,1.7755);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.7755) rectangle (1.75,1.7996);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7996) rectangle (2.622,13.121);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.121) rectangle (1.75,14.285);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.285) rectangle (3.93,14.366);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,1.7741);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.7741) rectangle (5.6333,1.7996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.7996) rectangle (7.0867,2.9635);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.9635) rectangle (5.6333,14.285);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.285) rectangle (6.6507,14.361);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.361) rectangle (5.6333,14.442);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.442) rectangle (6.5053,14.449);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.449) rectangle (5.6333,14.464);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,1.7741);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.7741) rectangle (9.5167,1.7996);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.7996) rectangle (10.607,2.9635);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.9635) rectangle (10.607,14.285);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.285) rectangle (11.697,14.361);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.361) rectangle (11.697,14.442);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.442) rectangle (11.697,14.449);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.449) rectangle (11.697,14.464);
...
\draw[black, dotted] (1.5,1.7996) -- (13.4,1.7996);
...
\node[text=black, centered, rotate=90] at (13.72, 8.0425) {D Doesn't Answer};
