...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.0921) rectangle (3.6393,9.2367);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.2367) rectangle (3.4213,9.8379);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.8379) rectangle (1.75,11.043);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.043) rectangle (1.968,12.356);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.0921) rectangle (5.8513,9.8063);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.043) rectangle (7.5227,11.257);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.257) rectangle (7.3047,11.795);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,11.795) rectangle (6.0693,13.186);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.186) rectangle (5.8513,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.043) rectangle (10.062,11.257);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,11.257) rectangle (10.062,12.648);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.648) rectangle (10.062,13.186);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.186) rectangle (10.062,14.5);
