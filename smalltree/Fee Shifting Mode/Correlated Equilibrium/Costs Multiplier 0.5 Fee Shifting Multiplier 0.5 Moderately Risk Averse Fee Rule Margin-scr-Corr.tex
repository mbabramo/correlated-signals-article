...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.876) rectangle (3.4213,12.2);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,12.2) rectangle (1.75,13.139);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.139) rectangle (1.968,13.664);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.664) rectangle (1.859,14.078);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.777) rectangle (5.8513,12.303);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.303) rectangle (5.7423,12.717);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.237) rectangle (7.3047,13.561);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.561) rectangle (5.9603,13.974);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.974) rectangle (5.8513,14.5);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.139) rectangle (10.062,13.237);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.237) rectangle (10.062,13.651);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.651) rectangle (10.062,13.974);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.974) rectangle (10.062,14.5);
