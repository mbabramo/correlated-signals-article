...
\draw[black, very thin] (13.35,2.2135) -- (13.45,2.2135);
\node[anchor=west] at (13.35, 2.2135) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (2.84,1.7503);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7503) rectangle (2.4767,1.7871);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.7871) rectangle (2.1133,1.9821);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,1.9821) rectangle (1.75,1.9821);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.9821) rectangle (1.75,2.2135);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.2135) rectangle (2.622,4.7635);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.7635) rectangle (2.2587,7.3128);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,7.3128) rectangle (1.8953,9.7952);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.7952) rectangle (1.75,9.7952);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.7952) rectangle (1.75,14.437);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.437) rectangle (3.2033,14.454);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.454) rectangle (3.1307,14.454);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.454) rectangle (3.058,14.456);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.456) rectangle (2.9853,14.456);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.456) rectangle (2.9127,14.459);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.459) rectangle (2.84,14.479);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.479) rectangle (2.7673,14.48);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.48) rectangle (2.6947,14.482);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.482) rectangle (2.622,14.483);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.483) rectangle (2.5493,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.485) rectangle (2.4767,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.485) rectangle (2.404,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.485) rectangle (2.3313,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.485) rectangle (2.2587,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.485) rectangle (2.186,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (2.0407,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (1.8953,14.486);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.486) rectangle (1.75,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (4.0753,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (3.712,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.486) rectangle (3.3487,14.492);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.492) rectangle (2.9853,14.497);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,1.75) rectangle (5.6333,2.2135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.2135) rectangle (7.0867,2.2135);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,2.2135) rectangle (7.0867,4.5317);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,4.5317) rectangle (6.7233,6.8558);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.8558) rectangle (6.36,9.3381);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.3381) rectangle (5.9967,11.887);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.437) rectangle (6.8687,14.438);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.438) rectangle (6.796,14.438);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.438) rectangle (6.796,14.438);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.438) rectangle (6.7233,14.438);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.438) rectangle (6.6507,14.438);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.438) rectangle (6.6507,14.438);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.438) rectangle (6.578,14.44);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.44) rectangle (6.5053,14.441);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.441) rectangle (6.4327,14.443);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.443) rectangle (6.36,14.444);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.444) rectangle (6.2873,14.464);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.464) rectangle (6.2147,14.467);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.467) rectangle (6.142,14.467);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.467) rectangle (6.0693,14.469);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.469) rectangle (5.9967,14.469);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.469) rectangle (5.924,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.485) rectangle (5.8513,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.485) rectangle (5.7787,14.485);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.485) rectangle (5.706,14.485);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.486) rectangle (6.142,14.49);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,1.75) rectangle (9.5167,2.2135);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.2135) rectangle (10.607,2.2135);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.2135) rectangle (10.607,14.437);
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.438) rectangle (11.697,14.486);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.486) rectangle (11.697,14.486);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.486) rectangle (11.697,14.497);
...
\draw[black, dotted] (1.5,2.2135) -- (13.4,2.2135);
...
\node[text=black, centered, rotate=90] at (13.72, 8.3255) {D Doesn't Answer};
