...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,6.9022);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.9022) rectangle (1.75,12.37);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.37) rectangle (2.622,13.551);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.551) rectangle (1.75,14.27);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.27) rectangle (3.6393,14.306);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.306) rectangle (1.75,14.482);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,7.2178);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.2178) rectangle (5.6333,12.37);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.37) rectangle (7.0867,13.088);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.088) rectangle (5.6333,14.27);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.27) rectangle (6.9413,14.446);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.446) rectangle (5.6333,14.482);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.482) rectangle (6.5053,14.491);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,7.2178);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.2178) rectangle (9.5167,12.37);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.37) rectangle (10.607,13.088);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.088) rectangle (10.607,14.27);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.27) rectangle (11.697,14.446);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.446) rectangle (11.697,14.482);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.482) rectangle (11.697,14.491);
...
\node[text=black, centered, rotate=90] at (13.72, 7.06) {P Doesn't File};
\node[text=black, centered, rotate=90] at (13.72, 13.32) {No Answer};
