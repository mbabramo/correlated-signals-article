...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.2033,6.7683);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.7683) rectangle (1.75,12.501);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,12.501) rectangle (2.622,13.81);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,13.81) rectangle (1.75,14.405);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.405) rectangle (3.6393,14.441);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,14.441) rectangle (1.75,14.471);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,14.471) rectangle (4.0753,14.479);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (5.6333,7.4823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,7.4823) rectangle (5.6333,12.501);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,12.501) rectangle (7.0867,13.096);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.096) rectangle (5.6333,14.405);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.405) rectangle (6.9413,14.436);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,14.436) rectangle (5.6333,14.471);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,14.471) rectangle (6.5053,14.486);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (9.5167,7.4823);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,7.4823) rectangle (9.5167,12.501);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,12.501) rectangle (10.607,13.096);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.096) rectangle (10.607,14.405);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,14.405) rectangle (11.697,14.436);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,14.436) rectangle (11.697,14.471);
...
\node[text=black, centered, rotate=90] at (13.72, 13.453) {No Answer};
