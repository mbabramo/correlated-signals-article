# CS004ME: multiple-equilibrium robustness

This directory replaces the previous `Robustness checks` material with the completed clean production output at numerical commit `31d0f17836435a2b1a7cc3fc52a6dfcec0db3565`.
...
There are 32 retained profiles and 32 action-value reports. The 216 PDF/TeX pairs comprise six diagram families for those profiles and the additional Avg/Corr diagnostics. The main CS004 output is in `../../Results/CS004`.
...
The unchanged original suite manifest and diagram inventory, and the source-to-repository hash mapping, are in `../../Results/Provenance`.
