...
|---|---:|---:|---:|---:|---|
| forward (selected) | 0.000000 | 0.063566 | 1 | 2.50004E-11 | Coordinate search converged within improvement tolerance |

Selected profile's unrestricted best-response gains: P **2.5000446E-11**, D **0** (reported utility units). Acceptance limit: 1E-10. This checks Nash deviations at the root, not an equilibrium refinement.
