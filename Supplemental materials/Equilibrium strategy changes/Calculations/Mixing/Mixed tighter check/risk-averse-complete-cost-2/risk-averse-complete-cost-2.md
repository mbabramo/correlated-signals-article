# risk-averse-complete-cost-2: equilibrium-preserving mixing

Source specification: `Specification-ModerateRiskAversion__Cost-2__Fee-British__ExitFees-AllUnilateralExits`. Original saved equilibrium retained unchanged.
...
|---|---:|---:|---:|---:|---|
| forward (selected) | 0.013203 | 0.013203 | 0 | 2.27374E-13 | Coordinate search converged within improvement tolerance |

Selected profile's unrestricted best-response gains: P **0**, D **2.2737368E-13** (reported utility units). Acceptance limit: 1E-10. This checks Nash deviations at the root, not an equilibrium refinement.
...
|---|---:|---:|---:|---:|---:|
| original | 60.260303 | 0.000000 | 37.018420 | 0.432525 | 2.288752 |
| forward | 60.260303 | 0.000000 | 37.018420 | 0.432525 | 2.288752 |
## Strategy changes
