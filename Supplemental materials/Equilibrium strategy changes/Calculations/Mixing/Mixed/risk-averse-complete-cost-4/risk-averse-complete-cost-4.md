# risk-averse-complete-cost-4: equilibrium-preserving mixing

Source specification: `Specification-ModerateRiskAversion__Cost-4__Fee-British__ExitFees-AllUnilateralExits`. Original saved equilibrium retained unchanged.
...
|---|---:|---:|---:|---:|---|
| forward (selected) | 0.000000 | 0.000000 | 0 | 0 | Coordinate search converged within improvement tolerance |
| reverse | 0.000000 | 0.000000 | 0 | 0 | Coordinate search converged within improvement tolerance |

Selected profile's unrestricted best-response gains: P **0**, D **0** (reported utility units). Acceptance limit: 1E-09. This checks Nash deviations at the root, not an equilibrium refinement.
...
|---|---:|---:|---:|---:|---:|
| original | 100.000000 | 0.000000 | 0.000000 | 0.000000 | 0.000000 |
| forward | 100.000000 | 0.000000 | 0.000000 | 0.000000 | 0.000000 |
| reverse | 100.000000 | 0.000000 | 0.000000 | 0.000000 | 0.000000 |
## Strategy changes
