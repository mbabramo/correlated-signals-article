# risk-averse-american-cost-0.5: equilibrium-preserving mixing

Source specification: `Specification-ModerateRiskAversion__Cost-0.5__Fee-American`. Original saved equilibrium retained unchanged.
...
|---|---:|---:|---:|---:|---|
| forward (selected) | 0.020885 | 0.020885 | 0 | 0 | Coordinate search converged within improvement tolerance |
| reverse | 0.020885 | 0.020885 | 0 | 0 | Coordinate search converged within improvement tolerance |

Selected profile's unrestricted best-response gains: P **0**, D **-1.1368684E-13** (reported utility units). Acceptance limit: 1E-09. This checks Nash deviations at the root, not an equilibrium refinement.
...
|---|---:|---:|---:|---:|---:|
| original | 0.000000 | 0.000000 | 70.553532 | 21.979512 | 7.466955 |
| forward | 0.000000 | 0.000000 | 70.553532 | 21.979512 | 7.466955 |
| reverse | 0.000000 | 0.000000 | 70.553532 | 21.979512 | 7.466955 |
## Strategy changes
