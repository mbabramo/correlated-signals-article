# risk-averse-trial-cost-0.25: equilibrium-preserving mixing

Source specification: `Specification-ModerateRiskAversion__Cost-0.25__Fee-British`. Original saved equilibrium retained unchanged.
...
|---|---:|---:|---:|---:|---|
| forward | 0.026802 | 0.026806 | 11 | 2.49997E-10 | Sweep limit reached |
| reverse (selected) | 0.026802 | 0.026806 | 12 | 2.50111E-10 | Sweep limit reached |

Selected profile's unrestricted best-response gains: P **2.5011104E-10**, D **-1.1368684E-13** (reported utility units). Acceptance limit: 1E-09. This checks Nash deviations at the root, not an equilibrium refinement.
...
|---|---:|---:|---:|---:|---:|
| original | 0.000000 | 0.000000 | 69.446627 | 22.852211 | 7.701162 |
| forward | 0.000000 | 0.000000 | 69.446631 | 22.852211 | 7.701158 |
| reverse | 0.000000 | 0.000000 | 69.446612 | 22.852211 | 7.701177 |
## Strategy changes
...
|---|---|---:|---|---|---|---:|
| D | D Defaults | 0.65 |  | Yes: 16.126%; No: 83.874% | Yes: 16.128%; No: 83.872% | 1.555 -> 1.555 |
| D | D Offer | 0.65 | exit | 0.45: 100% | 0.45: 99.992%; 0.95: 0.008% | 1.000 -> 1.001 |
