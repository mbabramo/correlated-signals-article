...
changed-action sections retain its intersection across these three comparisons: 39 information
...
tested mixed representations, retaining their intersection. Eight information
sets qualify: none for fee shifting under risk neutrality, three for fee
shifting under moderate risk aversion, three for the preference change under
the American rule, and two for the preference change under the British rule.
The tables consequently contain 47 information sets in 34 displayed rows,
including the unchanged-action sections. Displayed endpoints and contributions
