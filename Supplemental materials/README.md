...
The multiple-start results preserve the risk-neutral welfare/disposition comparison across recovered profiles, but show substantial variation under risk aversion. See [the six-case findings](<Multiple equilibria/Findings.md>) for the needed qualifications and the distinction between recovered profiles and all possible equilibria.
