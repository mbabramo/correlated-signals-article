...
\draw[black, very thin] (13.35,8.9051) -- (13.45,8.9051);
\node[anchor=west] at (13.35, 8.9051) {};
...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,4.0212) rectangle (1.968,7.7167);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,7.7167) rectangle (1.75,8.9051);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,8.9051) rectangle (3.3487,9.5361);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,9.5361) rectangle (1.75,11.233);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,4.0212) rectangle (7.0867,5.2096);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,5.2096) rectangle (5.6333,8.9051);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,8.9051) rectangle (5.924,10.602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.602) rectangle (5.6333,11.233);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,4.0212) rectangle (9.7892,5.2096);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.2096) rectangle (9.7892,8.9051);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,8.9051) rectangle (10.062,10.602);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.602) rectangle (10.062,11.233);
...
\draw[black, dotted] (1.5,8.9051) -- (13.4,8.9051);
...
\node[text=black, centered, rotate=90] at (13.72, 6.4631) {\contour{white}{D Doesn't Answer}};
\node[text=black, centered, rotate=90] at (13.72, 10.069) {\contour{white}{Settles}};
