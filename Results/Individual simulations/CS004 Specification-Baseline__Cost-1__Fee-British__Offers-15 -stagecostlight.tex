...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,10.11) rectangle (3.3729,10.451);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.451) rectangle (1.75,11.233);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,10.11) rectangle (5.8998,10.892);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.892) rectangle (5.6333,11.233);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,10.11) rectangle (10.062,10.892);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.892) rectangle (10.062,11.233);
