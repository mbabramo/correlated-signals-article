...
\begin{document}
\begin{tikzpicture}
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (1.5,2.5) rectangle (13.5,2.6125);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (1.5,2.6125) rectangle (13.5,2.725);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (1.5,2.725) rectangle (13.5,2.95);
