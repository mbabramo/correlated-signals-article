...
\begin{document}
\begin{tikzpicture}
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (7.5,2.5) rectangle (10.704,3.4);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (10.704,2.5) rectangle (12.288,3.4);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (10.704,3.4) rectangle (12.288,4.3);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.288,2.5) rectangle (13.5,3.4);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (12.288,3.4) rectangle (13.5,4.3);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (12.288,4.3) rectangle (13.5,6.1);
