...
\draw[fill=blue!30,draw=white,very thin] (1.5,2.5) rectangle (19.103,2.9125);
\draw[fill=blue!60,draw=white,very thin] (1.5,2.9125) rectangle (19.103,3.325);
\draw[fill=blue!30,draw=white,very thin] (19.103,2.5) rectangle (25.167,2.9125);
\draw[fill=blue!60,draw=white,very thin] (19.103,2.9125) rectangle (25.167,3.325);
\draw[fill=red!75,draw=white,very thin] (19.103,3.325) rectangle (25.167,4.15);
