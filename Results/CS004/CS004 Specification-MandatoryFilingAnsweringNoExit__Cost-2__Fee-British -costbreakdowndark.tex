...
\draw[fill=blue!30,draw=white,very thin] (1.5,2.5) rectangle (20.901,3.325);
\draw[fill=blue!60,draw=white,very thin] (1.5,3.325) rectangle (20.901,4.15);
\draw[fill=blue!30,draw=white,very thin] (20.901,2.5) rectangle (25.167,3.325);
\draw[fill=blue!60,draw=white,very thin] (20.901,3.325) rectangle (25.167,4.15);
\draw[fill=red!75,draw=white,very thin] (20.901,4.15) rectangle (25.167,5.8);
