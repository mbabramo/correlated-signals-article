...
\draw[black, opacity=0.70, line width=0.5mm, double] (2.85,2.8394) -- (6.95,2.6224);
\draw[black, opacity=0.70, line width=1mm, dashed] (2.85,1.1729) -- (6.95,1.2139);
\draw[black, opacity=0.70, line width=1mm, solid] (2.85,2.2411) -- (6.95,1.8126);
