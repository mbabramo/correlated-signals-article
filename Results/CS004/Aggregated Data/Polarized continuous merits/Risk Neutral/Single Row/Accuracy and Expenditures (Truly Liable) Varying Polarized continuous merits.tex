...
\draw[black, opacity=0.70, line width=0.5mm, double] (2.85,2.3291) -- (6.95,2.2194);
\draw[black, opacity=0.70, line width=1mm, dashed] (2.85,1.229) -- (6.95,1.2568);
\draw[black, opacity=0.70, line width=1mm, solid] (2.85,1.8776) -- (6.95,1.7791);
