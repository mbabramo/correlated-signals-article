...
\draw[black, opacity=0.70, line width=0.5mm, double] (2.85,2.9607) -- (6.95,2.6559);
\draw[black, opacity=0.70, line width=1mm, dashed] (2.85,1.6167) -- (6.95,1.692);
\draw[black, opacity=0.70, line width=1mm, solid] (2.85,2.7232) -- (6.95,2.4137);
