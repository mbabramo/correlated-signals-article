...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,1.75) rectangle (3.3487,2.7484);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,2.7484) rectangle (2.6947,3.0098);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,3.0098) rectangle (2.0407,6.4916);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,6.4916) rectangle (1.75,11.233);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,1.75) rectangle (7.232,2.7484);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,2.7484) rectangle (6.578,3.0098);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,3.0098) rectangle (5.924,6.4918);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,6.4918) rectangle (5.7787,9.9735);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,9.9735) rectangle (5.6333,11.233);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,1.75) rectangle (10.062,2.0114);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,2.0114) rectangle (10.062,2.2728);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,2.2728) rectangle (10.062,5.7548);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,5.7548) rectangle (10.062,6.7532);
...
\node[text=black, centered, rotate=90] at (13.72, 6.4917) {\contour{white}{Settles}};
