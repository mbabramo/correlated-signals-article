...
\draw[white, very thin, fill=blue] (1.75,5.0906) rectangle (2.6283,9.0492);
\draw[white, very thin, fill=red] (1.75,9.0492) rectangle (1.75,10.49);
\draw[white, very thin, fill=blue] (1.75,10.49) rectangle (5.4094,10.992);
\draw[white, very thin, fill=red] (1.75,10.992) rectangle (1.75,12.105);
\draw[white, very thin, fill=blue] (1.75,12.105) rectangle (6.4341,12.383);
\draw[white, very thin, fill=red] (1.75,12.383) rectangle (1.75,12.802);
\draw[white, very thin, fill=blue] (1.75,12.802) rectangle (3.5065,13.222);
...
\draw[white, very thin, fill=red] (9.3189,5.0906) rectangle (12.246,6.5312);
\draw[white, very thin, fill=blue] (9.3189,6.5312) rectangle (9.3189,10.49);
\draw[white, very thin, fill=red] (9.3189,10.49) rectangle (10.344,11.602);
\draw[white, very thin, fill=blue] (9.3189,11.602) rectangle (9.3189,12.105);
\draw[white, very thin, fill=red] (9.3189,12.105) rectangle (11.075,12.524);
\draw[white, very thin, fill=blue] (9.3189,12.524) rectangle (9.3189,12.802);
\draw[white, very thin, fill=red] (9.3189,12.802) rectangle (14.003,13.08);
\draw[white, very thin, fill=blue] (9.3189,13.08) rectangle (11.075,13.5);
...
\draw[white, very thin, fill=red] (16.888,5.0906) rectangle (17.986,6.5312);
\draw[white, very thin, fill=blue] (16.888,6.5312) rectangle (17.986,10.49);
\draw[white, very thin, fill=red] (16.888,10.49) rectangle (19.083,11.602);
\draw[white, very thin, fill=blue] (16.888,11.602) rectangle (19.083,12.105);
...
\node[text=yellow, centered, rotate=90] at (24.777, 7.7902) {\contour{white}{D Doesn't Answer}};
\node[text=yellow, centered, rotate=90] at (24.777, 11.297) {\contour{white}{Settles}};
