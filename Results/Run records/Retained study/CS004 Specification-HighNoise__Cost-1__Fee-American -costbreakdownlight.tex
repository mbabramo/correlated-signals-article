...
\begin{document}
\begin{tikzpicture}
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (1.5,2.5) rectangle (13.5,2.95);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (1.5,2.95) rectangle (13.5,3.4);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (1.5,3.4) rectangle (13.5,4.3);
