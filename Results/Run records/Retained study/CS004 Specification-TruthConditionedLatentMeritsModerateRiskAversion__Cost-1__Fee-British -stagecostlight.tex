...
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,9.1605) rectangle (2.622,10.236);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,10.236) rectangle (1.75,11.105);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,11.105) rectangle (3.4213,11.567);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (1.75,11.567) rectangle (1.75,13.058);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (1.75,13.058) rectangle (1.968,14.049);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,9.1605) rectangle (6.6507,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,10.03) rectangle (5.6333,11.105);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,11.105) rectangle (5.8513,12.597);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,12.597) rectangle (5.6333,13.058);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (5.6333,13.058) rectangle (7.3047,13.266);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (5.6333,13.266) rectangle (5.8513,14.256);
...
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,9.1605) rectangle (10.062,10.03);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,10.03) rectangle (10.062,11.105);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,11.105) rectangle (10.062,12.597);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,12.597) rectangle (10.062,13.058);
\draw[black, very thin, pattern color=orange, pattern=north west lines] (9.5167,13.058) rectangle (10.062,13.266);
\draw[black, very thin, pattern color=blue, pattern=north east lines] (9.5167,13.266) rectangle (10.062,14.256);
...
\node[text=black, centered, rotate=90] at (13.72, 7.3362) {\contour{white}{D Doesn't Answer}};
\node[text=black, centered, rotate=90] at (13.72, 10.133) {\contour{white}{Settles}};
